...
cfg = {
    ...
    "output_csv_filename": "csv-files-output/p4-out-app-iden-27x27x7-q12_12.csv",
    "input_switches": [
        {
            "name": "s1",
            "iface": "s1-eth1",
...
def main(cfg):
    ...
    ann_outputs = pd.DataFrame(columns=["s126_id", "s126_data_1", "s126_data_2", "s126_data_3", "s126_data_4", "s126_data_5", "s126_data_6", "s126_data_7", "s101_id", "s101_data_1", "s101_data_2", "s101_data_3", "s101_data_4", "s101_data_5", "s101_data_6", "s101_data_7"])
    for tc_id, tc in input_dataset.iterrows():
        ...
        for switch in cfg["input_switches"]:
            ...
            input_pkts.append((
                switch["iface"],
                Ether(dst='ff:ff:ff:ff:ff:ff', src=get_if_hwaddr(switch["iface"])) / ANN(neuron_id=0, data_1=tc["pkt_1_ipv4_tl_5"], data_2=tc["pkt_1_udp_len_9"], data_3=tc["pkt_0_udp_len_12"], data_4=tc["pkt_2_ipv4_tl_6"], data_5=tc["pkt_4_udp_len_8"], data_6=tc["pkt_3_udp_len_7"], data_7=tc["pkt_2_ipv4_tl_7"], data_8=tc["pkt_1_udp_len_8"], data_9=tc["pkt_3_ipv4_tl_5"], data_10=tc["pkt_0_udp_len_15"], data_11=tc["pkt_3_udp_len_15"], data_12=tc["pkt_1_udp_len_10"], data_13=tc["pkt_3_udp_len_9"], data_14=tc["pkt_0_ipv4_tl_10"], data_15=tc["pkt_2_udp_len_11"], data_16=tc["pkt_2_ipv4_tl_10"], data_17=tc["pkt_4_udp_len_7"], data_18=tc["pkt_1_udp_len_13"], data_19=tc["pkt_0_ipv4_tl_12"], data_20=tc["pkt_1_ipv4_tl_9"], data_21=tc["pkt_0_ipv4_ttl_6"], data_22=tc["pkt_3_ipv4_tl_11"], data_23=tc["pkt_2_ipv4_ttl_2"], data_24=tc["pkt_4_udp_dport_0"], data_25=tc["pkt_0_ipv4_ttl_2"], data_26=tc["pkt_1_udp_dport_1"], data_27=tc["pkt_2_udp_len_12"], run_id=tc_id)
            ))
# 
                ...
                while n_received_outputs < n_expected_outputs:               
                    ...
                    if ANN in out_pkt and out_pkt[ANN].run_id == tc_id:
                        if out_pkt[ANN].neuron_id == 126:
                            ...
                            tc_outputs["s126_data_5"] = (out_pkt[ANN].data_5)
                            tc_outputs["s126_data_6"] = (out_pkt[ANN].data_6)
                            tc_outputs["s126_data_7"] = (out_pkt[ANN].data_7)
                        ...
                        if out_pkt[ANN].neuron_id == 101:
                            ...
                            tc_outputs["s101_data_5"] = eoConverter(out_pkt[ANN].data_5)
                            tc_outputs["s101_data_6"] = eoConverter(out_pkt[ANN].data_6)
                            tc_outputs["s101_data_7"] = eoConverter(out_pkt[ANN].data_7)
