...
cfg = {
    "input_dataset_filename": "csv-files-input/df-test-netml-iot.csv",
    "output_csv_filename": "csv-files-output/p4-out-netml-iot-16x32x2-q12_12.csv",
    "input_switches": [
        {
            "name": "s1",
            "iface": "s1-eth1",
...
def main(cfg):
    ...
    for tc_id, tc in input_dataset.iterrows():
        ...
        for switch in cfg["input_switches"]:
            ...
            input_pkts.append((
                switch["iface"],
                Ether(dst='ff:ff:ff:ff:ff:ff', src=get_if_hwaddr(switch["iface"])) / ANN(neuron_id=0, data_1=tc["pkt_1_ipv4_dfbit_0"], data_2=tc["pkt_1_ipv4_ttl_1"], data_3=tc["pkt_1_ipv4_ttl_0"], data_4=tc["pkt_0_ipv4_ttl_1"], data_5=tc["pkt_3_ipv4_ttl_2"], data_6=tc["pkt_1_udp_dport_0"], data_7=tc["pkt_1_ipv4_tl_7"], data_8=tc["pkt_0_udp_len_9"], data_9=tc["pkt_1_ipv4_ver_0"], data_10=tc["pkt_0_ipv4_tl_10"], data_11=tc["pkt_0_udp_len_14"], data_12=tc["pkt_1_tcp_dprt_0"], data_13=tc["pkt_0_tcp_doff_2"], data_14=tc["pkt_1_tcp_doff_2"], data_15=tc["pkt_2_tcp_opt_39"], data_16=tc["pkt_0_udp_len_6"], run_id=tc_id)
            ))
# 
