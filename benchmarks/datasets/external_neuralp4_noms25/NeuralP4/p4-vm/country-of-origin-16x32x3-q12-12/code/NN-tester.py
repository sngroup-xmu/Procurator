...
cfg = {
    "input_dataset_filename": "csv-files-input/df-test-country-of-origin.csv",
    "output_csv_filename": "csv-files-output/p4-out-country-of-origin-16x32x3-q12_12.csv",
    "input_switches": [
        {
            "name": "s1",
            "iface": "s1-eth1",
...
def main(cfg):
    ...
    for tc_id, tc in input_dataset.iterrows():
        ...
        for switch in cfg["input_switches"]:
            ...
            input_pkts.append((
                switch["iface"],
                Ether(dst='ff:ff:ff:ff:ff:ff', src=get_if_hwaddr(switch["iface"])) / ANN(neuron_id=0, data_1=tc["pkt_5_tcp_opt_64"], data_2=tc["pkt_9_tcp_opt_64"], data_3=tc["pkt_5_tcp_opt_65"], data_4=tc["pkt_8_tcp_opt_64"], data_5=tc["pkt_7_tcp_opt_64"], data_6=tc["pkt_7_tcp_opt_65"], data_7=tc["pkt_3_tcp_opt_64"], data_8=tc["pkt_3_ipv4_ttl_6"], data_9=tc["pkt_6_tcp_opt_64"], data_10=tc["pkt_8_tcp_sprt_14"], data_11=tc["pkt_9_tcp_opt_95"], data_12=tc["pkt_8_ipv4_cksum_1"], data_13=tc["pkt_4_tcp_opt_64"], data_14=tc["pkt_6_tcp_opt_65"], data_15=tc["pkt_8_tcp_opt_65"], data_16=tc["pkt_0_ipv4_tl_11"], run_id=tc_id)
            ))
# 
