...
action add_only_vallen() {
	...
	hdr_eg.val1_hdr.setInvalid();
	hdr_eg.val2_hdr.setInvalid();
	hdr_eg.val3_hdr.setInvalid();
	hdr_eg.val4_hdr.setInvalid();
	hdr_eg.val5_hdr.setInvalid();
	hdr_eg.val6_hdr.setInvalid();
	hdr_eg.val7_hdr.setInvalid();
	hdr_eg.val8_hdr.setInvalid();
	hdr_eg.val9_hdr.setInvalid();
	hdr_eg.val10_hdr.setInvalid();
	hdr_eg.val11_hdr.setInvalid();
	hdr_eg.val12_hdr.setInvalid();
	hdr_eg.val13_hdr.setInvalid();
	hdr_eg.val14_hdr.setInvalid();
	hdr_eg.val15_hdr.setInvalid();
	hdr_eg.val16_hdr.setInvalid();
}

action add_to_val1() {
	hdr_eg.vallen_hdr.setValid();
	hdr_eg.val1_hdr.setValid();
	hdr_eg.val2_hdr.setInvalid();
	hdr_eg.val3_hdr.setInvalid();
	hdr_eg.val4_hdr.setInvalid();
	hdr_eg.val5_hdr.setInvalid();
...
action add_to_val16() {
	...
	hdr_eg.val14_hdr.setValid();
	hdr_eg.val15_hdr.setValid();
	hdr_eg.val16_hdr.setValid();
}

action remove_all() {
	hdr_eg.vallen_hdr.setInvalid();
	hdr_eg.val1_hdr.setInvalid();
	hdr_eg.val2_hdr.setInvalid();
	hdr_eg.val3_hdr.setInvalid();
	hdr_eg.val4_hdr.setInvalid();
...
table add_and_remove_value_header_tbl {
	key = {
		...
		hdr_eg.vallen_hdr.vallen: range;
	}
	actions = {
		add_only_vallen;
		add_to_val1;
...
action get_vallen() {
	hdr_eg.vallen_hdr.setValid();
	vallen_reg.read(hdr_eg.vallen_hdr.vallen,(bit<32>)meta.idx);
	meta.access_val_mode = 1; // get val_reg
}

action set_and_get_vallen() {
	
	vallen_reg.write((bit<32>)meta.idx,hdr_eg.vallen_hdr.vallen);
...
action get_vallo1() {
	vallo1_reg.read(hdr_eg.val1_hdr.vallo,(bit<32>)meta.idx);
}

action set_and_get_vallo1() {
	vallo1_reg.write((bit<32>)meta.idx,hdr_eg.val1_hdr.vallo);
}
...
action get_valhi1() {
	valhi1_reg.read(hdr_eg.val1_hdr.valhi,(bit<32>)meta.idx);
}
action set_and_get_valhi1() {
	valhi1_reg.write((bit<32>)meta.idx,hdr_eg.val1_hdr.valhi);
}
...
action get_vallo2() {
	...
	vallo2_reg.read(hdr_eg.val2_hdr.vallo,(bit<32>)meta.idx);
}
action set_and_get_vallo2() {
	
	vallo2_reg.write((bit<32>)meta.idx,hdr_eg.val2_hdr.vallo);
}
...
action get_valhi2() {
	...
	valhi2_reg.read(hdr_eg.val2_hdr.valhi,(bit<32>)meta.idx);
}
action set_and_get_valhi2() {
	
	valhi2_reg.write((bit<32>)meta.idx,hdr_eg.val2_hdr.valhi);
}
...
action get_vallo3() {
	...
	vallo3_reg.read(hdr_eg.val3_hdr.vallo,(bit<32>)meta.idx);
}
action set_and_get_vallo3() {
	
	vallo3_reg.write((bit<32>)meta.idx,hdr_eg.val3_hdr.vallo);
}
...
action get_valhi3() {
	...
	valhi3_reg.read(hdr_eg.val3_hdr.valhi,(bit<32>)meta.idx);
}
action set_and_get_valhi3() {
	
	valhi3_reg.write((bit<32>)meta.idx,hdr_eg.val3_hdr.valhi);
}
...
action get_vallo4() {
	...
	vallo4_reg.read(hdr_eg.val4_hdr.vallo,(bit<32>)meta.idx);
}
action set_and_get_vallo4() {
	
	vallo4_reg.write((bit<32>)meta.idx,hdr_eg.val4_hdr.vallo);
}
...
action get_valhi4() {
	...
	valhi4_reg.read(hdr_eg.val4_hdr.valhi,(bit<32>)meta.idx);
}
action set_and_get_valhi4() {
	
	valhi4_reg.write((bit<32>)meta.idx,hdr_eg.val4_hdr.valhi);
}
...
action get_vallo5() {
	...
	vallo5_reg.read(hdr_eg.val5_hdr.vallo,(bit<32>)meta.idx);
}
action set_and_get_vallo5() {
	
	vallo5_reg.write((bit<32>)meta.idx,hdr_eg.val5_hdr.vallo);
}
...
action get_valhi5() {
	...
	valhi5_reg.read(hdr_eg.val5_hdr.valhi,(bit<32>)meta.idx);
}
action set_and_get_valhi5() {
	
	valhi5_reg.write((bit<32>)meta.idx,hdr_eg.val5_hdr.valhi);
}
...
action get_vallo6() {
	...
	vallo6_reg.read(hdr_eg.val6_hdr.vallo,(bit<32>)meta.idx);
}
action set_and_get_vallo6() {
	
	vallo6_reg.write((bit<32>)meta.idx,hdr_eg.val6_hdr.vallo);
}
...
action get_valhi6() {
	...
	valhi6_reg.read(hdr_eg.val6_hdr.valhi,(bit<32>)meta.idx);
}
action set_and_get_valhi6() {
	
	valhi6_reg.write((bit<32>)meta.idx,hdr_eg.val6_hdr.valhi);
}
...
action get_vallo7() {
	...
	vallo7_reg.read(hdr_eg.val7_hdr.vallo,(bit<32>)meta.idx);
}
action set_and_get_vallo7() {
	
	vallo7_reg.write((bit<32>)meta.idx,hdr_eg.val7_hdr.vallo);
}
...
action get_valhi7() {
	...
	valhi7_reg.read(hdr_eg.val7_hdr.valhi,(bit<32>)meta.idx);
}
action set_and_get_valhi7() {
	
	valhi7_reg.write((bit<32>)meta.idx,hdr_eg.val7_hdr.valhi);
}
...
action get_vallo8() {
	...
	vallo8_reg.read(hdr_eg.val8_hdr.vallo,(bit<32>)meta.idx);
}
action set_and_get_vallo8() {
	
	vallo8_reg.write((bit<32>)meta.idx,hdr_eg.val8_hdr.vallo);
}
...
action get_valhi8() {
	...
	valhi8_reg.read(hdr_eg.val8_hdr.valhi,(bit<32>)meta.idx);
}
action set_and_get_valhi8() {
	
	valhi8_reg.write((bit<32>)meta.idx,hdr_eg.val8_hdr.valhi);
}
...
action get_vallo9() {
	...
	vallo9_reg.read(hdr_eg.val9_hdr.vallo,(bit<32>)meta.idx);
}
action set_and_get_vallo9() {
	
	vallo9_reg.write((bit<32>)meta.idx,hdr_eg.val9_hdr.vallo);
}
...
action get_valhi9() {
	...
	valhi9_reg.read(hdr_eg.val9_hdr.valhi,(bit<32>)meta.idx);
}
action set_and_get_valhi9() {
	
	valhi9_reg.write((bit<32>)meta.idx,hdr_eg.val9_hdr.valhi);
}
...
action get_vallo10() {
	...
	vallo10_reg.read(hdr_eg.val10_hdr.vallo,(bit<32>)meta.idx);
}
action set_and_get_vallo10() {
	
	vallo10_reg.write((bit<32>)meta.idx,hdr_eg.val10_hdr.vallo);
}
...
action get_valhi10() {
	...
	valhi10_reg.read(hdr_eg.val10_hdr.valhi,(bit<32>)meta.idx);
}
action set_and_get_valhi10() {
	
	valhi10_reg.write((bit<32>)meta.idx,hdr_eg.val10_hdr.valhi);
}
...
action get_vallo11() {
	...
	vallo11_reg.read(hdr_eg.val11_hdr.vallo,(bit<32>)meta.idx);
}
action set_and_get_vallo11() {
	
	vallo11_reg.write((bit<32>)meta.idx,hdr_eg.val11_hdr.vallo);
}
...
action get_valhi11() {
	...
	valhi11_reg.read(hdr_eg.val11_hdr.valhi,(bit<32>)meta.idx);
}
action set_and_get_valhi11() {
	
	valhi11_reg.write((bit<32>)meta.idx,hdr_eg.val11_hdr.valhi);
}
...
action get_vallo12() {
	...
	vallo12_reg.read(hdr_eg.val12_hdr.vallo,(bit<32>)meta.idx);
}
action set_and_get_vallo12() {
	
	vallo12_reg.write((bit<32>)meta.idx,hdr_eg.val12_hdr.vallo);
}
...
action get_valhi12() {
	...
	valhi12_reg.read(hdr_eg.val12_hdr.valhi,(bit<32>)meta.idx);
}
action set_and_get_valhi12() {
	
	valhi12_reg.write((bit<32>)meta.idx,hdr_eg.val12_hdr.valhi);
}
...
action get_vallo13() {
	...
	vallo13_reg.read(hdr_eg.val13_hdr.vallo,(bit<32>)meta.idx);
}
action set_and_get_vallo13() {
	
	vallo13_reg.write((bit<32>)meta.idx,hdr_eg.val13_hdr.vallo);
}
...
action get_valhi13() {
	...
	valhi13_reg.read(hdr_eg.val13_hdr.valhi,(bit<32>)meta.idx);
}
action set_and_get_valhi13() {
	
	valhi13_reg.write((bit<32>)meta.idx,hdr_eg.val13_hdr.valhi);
}
...
action get_vallo14() {
	...
	vallo14_reg.read(hdr_eg.val14_hdr.vallo,(bit<32>)meta.idx);
}
action set_and_get_vallo14() {
	
	vallo14_reg.write((bit<32>)meta.idx,hdr_eg.val14_hdr.vallo);
}
...
action get_valhi14() {
	...
	valhi14_reg.read(hdr_eg.val14_hdr.valhi,(bit<32>)meta.idx);
}
action set_and_get_valhi14() {
	
	valhi14_reg.write((bit<32>)meta.idx,hdr_eg.val14_hdr.valhi);
}
...
action get_vallo15() {
	...
	vallo15_reg.read(hdr_eg.val15_hdr.vallo,(bit<32>)meta.idx);
}
action set_and_get_vallo15() {
	
	vallo15_reg.write((bit<32>)meta.idx,hdr_eg.val15_hdr.vallo);
}
...
action get_valhi15() {
	...
	valhi15_reg.read(hdr_eg.val15_hdr.valhi,(bit<32>)meta.idx);
}
action set_and_get_valhi15() {
	
	valhi15_reg.write((bit<32>)meta.idx,hdr_eg.val15_hdr.valhi);
}
...
action get_vallo16() {
	...
	vallo16_reg.read(hdr_eg.val16_hdr.vallo,(bit<32>)meta.idx);
}
action set_and_get_vallo16() {
	
	vallo16_reg.write((bit<32>)meta.idx,hdr_eg.val16_hdr.vallo);
}
...
action get_valhi16() {
	...
	valhi16_reg.read(hdr_eg.val16_hdr.valhi,(bit<32>)meta.idx);
}
action set_and_get_valhi16() {
	
	valhi16_reg.write((bit<32>)meta.idx,hdr_eg.val16_hdr.valhi);
}
