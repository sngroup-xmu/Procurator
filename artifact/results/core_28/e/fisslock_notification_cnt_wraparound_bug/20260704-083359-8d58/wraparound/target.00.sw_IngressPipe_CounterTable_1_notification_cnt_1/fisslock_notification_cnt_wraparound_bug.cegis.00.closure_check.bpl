...
var sw_hdr.roce_deth:sw_Ref;
var sw_hdr.roce_deth.valid:bool;
var sw_hdr.roce_deth.qkey:sw_key_t;
var sw_hdr.roce_deth._reserved:bv8;
var sw_hdr.roce_deth.src_qp:sw_qp_t;
...
var sw_pkt:sw_Ref;
function sw_IngressDeparser_ipv4_checksum.update() returns(bv16);
var sw_eg_md:sw_metadata_t;
var sw_eg_md.dest2:bv16;
var sw_eg_md.lock_free_mode:bv1;
var sw_eg_md.lock_rw_mode:bv1;
var sw_eg_md.lock_agent:sw_host_t;
var sw_eg_md.lock_index:sw_lid_t;
var sw_eg_md.agent_changed:bv1;
var sw_eg_md.lock_out_of_range:bv1;
...
var sw_ig_intr_dprs_md:sw_egress_intrinsic_metadata_for_deparser_t;
var sw_ig_intr_dprs_md.drop_ctl:bv3;
var sw_ig_intr_dprs_md.mirror_type:sw_MirrorType_t;
var sw_ig_intr_dprs_md.coalesce_flush:bv1;
var sw_ig_intr_dprs_md.coalesce_length:bv7;
...
// sw_Table sw_IngressPipe_eth_fallback sw_Actionlist sw_Declaration
type sw_IngressPipe_eth_fallback.action;
var sw_IngressPipe_eth_fallback.IngressPipe_eth_forward.port:sw_PortId_t;
const unique sw_IngressPipe_eth_fallback.action.IngressPipe_eth_forward : sw_IngressPipe_eth_fallback.action;
const unique sw_IngressPipe_eth_fallback.action.IngressPipe_drop : sw_IngressPipe_eth_fallback.action;
var sw_IngressPipe_eth_fallback.action_run : sw_IngressPipe_eth_fallback.action;
var sw_IngressPipe_eth_fallback.hit : bool;
...
axiom sw_IngressPipe_CounterTable_1_notification_cnt_1.size == 524288bv32;
...
axiom sw_IngressPipe_CounterTable_2_notification_cnt_2.size == 524288bv32;
...
axiom sw_IngressPipe_CounterTable_3_notification_cnt_3.size == 524288bv32;
...
axiom sw_IngressPipe_LockOperation_1_lock_agent_array_1.size == 524288bv32;
...
axiom sw_IngressPipe_LockOperation_2_lock_agent_array_2.size == 524288bv32;
...
axiom sw_IngressPipe_LockOperation_3_lock_agent_array_3.size == 524288bv32;
...
var sw_meta:sw_metadata_t;
var sw_meta.dest2:bv16;
var sw_meta.lock_free_mode:bv1;
var sw_meta.lock_rw_mode:bv1;
var sw_meta.lock_agent:sw_host_t;
var sw_meta.lock_index:sw_lid_t;
var sw_meta.agent_changed:bv1;
var sw_meta.lock_out_of_range:bv1;
var sw_meta.is_roce:bv1;
var sw_meta.pkt_psn:sw_psn_t;
...
procedure {:inline 1} sw_IngressDeparser()
	modifies sw_hdr.ipv4.hdr_cksum;
{
    sw_hdr.ipv4.hdr_cksum := sw_IngressDeparser_ipv4_checksum.update();
    call sw_pkt.emit(sw_hdr);
}
    ...
    if(sw_isValid[sw_hdr.lock]){
        ...
        if((sw_ig_md.lock_out_of_range == 1bv1)){
            ...
            if(((((sw_hdr.lock.type == 5bv8)) || ((sw_hdr.lock.type == 6bv8))) && ((sw_hdr.lock.old_mode == 0bv1))) && ((sw_ig_md.agent_changed == 0bv1))){
                ...
                if((sw_hdr.lock.type == 3bv8)){
                    sw_hdr.lock.agent := sw_hdr.lock.machine_id;
                }
                else{
        ...
        sw_ig_intr_tm_md.mcast_grp_a := 0bv8++sw_hdr.lock.agent;
        sw_ig_intr_tm_md.mcast_grp_b := add.bv16(sw_ig_md.dest2, 128bv16);
    }
    else{
        if(sw_isValid[sw_hdr.ethernet]){
            call sw_IngressPipe_eth_fallback.apply();
        }
    }
}
	...
	modifies sw_IngressPipe_CounterTable_1_notification_cnt_1, sw_IngressPipe_CounterTable_1_notification_cnt_1__last0_old_value, sw_IngressPipe_CounterTable_1_notification_cnt_1__last0_value, sw_IngressPipe_CounterTable_1_notification_cnt_1__last_index, sw_IngressPipe_CounterTable_1_notification_cnt_1__last_old_value, sw_IngressPipe_CounterTable_1_notification_cnt_1__last_value, sw_IngressPipe_CounterTable_1_notification_cnt_1__last_write_site, sw_IngressPipe_CounterTable_1_notification_cnt_1__next_write_site, sw_IngressPipe_CounterTable_1_notification_cnt_1__wrote_any, sw_IngressPipe_CounterTable_1_notification_cnt_1__wrote_index0, sw___ra_ret_IngressPipe_CounterTable_1_cmp_ncnt, sw___ra_val_IngressPipe_CounterTable_1_cmp_ncnt, sw_ig_md.agent_changed;
{
    ...
    sw_IngressPipe_CounterTable_1_notification_cnt_1__last_old_value := sw_IngressPipe_CounterTable_1_notification_cnt_1[sw_ig_md.lock_index];
    sw_IngressPipe_CounterTable_1_notification_cnt_1[sw_ig_md.lock_index] := sw___ra_val_IngressPipe_CounterTable_1_cmp_ncnt;
    sw_IngressPipe_CounterTable_1_notification_cnt_1__last_index := sw_ig_md.lock_index;
    sw_IngressPipe_CounterTable_1_notification_cnt_1__last_value := sw___ra_val_IngressPipe_CounterTable_1_cmp_ncnt;
    sw_IngressPipe_CounterTable_1_notification_cnt_1__last_write_site := sw_IngressPipe_CounterTable_1_notification_cnt_1__next_write_site;
    sw_IngressPipe_CounterTable_1_notification_cnt_1__wrote_any := true;
    if (sw_ig_md.lock_index == 0bv32) {
        ...
        sw_IngressPipe_CounterTable_1_notification_cnt_1__last0_value := sw___ra_val_IngressPipe_CounterTable_1_cmp_ncnt;
    }
	...
	modifies sw_IngressPipe_CounterTable_1_notification_cnt_1, sw_IngressPipe_CounterTable_1_notification_cnt_1__last0_old_value, sw_IngressPipe_CounterTable_1_notification_cnt_1__last0_value, sw_IngressPipe_CounterTable_1_notification_cnt_1__last_index, sw_IngressPipe_CounterTable_1_notification_cnt_1__last_old_value, sw_IngressPipe_CounterTable_1_notification_cnt_1__last_value, sw_IngressPipe_CounterTable_1_notification_cnt_1__last_write_site, sw_IngressPipe_CounterTable_1_notification_cnt_1__next_write_site, sw_IngressPipe_CounterTable_1_notification_cnt_1__wrote_any, sw_IngressPipe_CounterTable_1_notification_cnt_1__wrote_index0, sw___ra_ret_IngressPipe_CounterTable_1_count_ncnt, sw___ra_val_IngressPipe_CounterTable_1_count_ncnt;
{
    ...
    sw_IngressPipe_CounterTable_1_notification_cnt_1__last_old_value := sw_IngressPipe_CounterTable_1_notification_cnt_1[sw_ig_md.lock_index];
    sw_IngressPipe_CounterTable_1_notification_cnt_1[sw_ig_md.lock_index] := sw___ra_val_IngressPipe_CounterTable_1_count_ncnt;
    sw_IngressPipe_CounterTable_1_notification_cnt_1__last_index := sw_ig_md.lock_index;
    sw_IngressPipe_CounterTable_1_notification_cnt_1__last_value := sw___ra_val_IngressPipe_CounterTable_1_count_ncnt;
    sw_IngressPipe_CounterTable_1_notification_cnt_1__last_write_site := sw_IngressPipe_CounterTable_1_notification_cnt_1__next_write_site;
    sw_IngressPipe_CounterTable_1_notification_cnt_1__wrote_any := true;
    if (sw_ig_md.lock_index == 0bv32) {
        sw_IngressPipe_CounterTable_1_notification_cnt_1__wrote_index0 := true;
        sw_IngressPipe_CounterTable_1_notification_cnt_1__last0_old_value := sw_IngressPipe_CounterTable_1_notification_cnt_1__last_old_value;
        sw_IngressPipe_CounterTable_1_notification_cnt_1__last0_value := sw___ra_val_IngressPipe_CounterTable_1_count_ncnt;
    }
}
	...
	modifies sw_IngressPipe_CounterTable_1_notification_cnt_1, sw_IngressPipe_CounterTable_1_notification_cnt_1__last0_old_value, sw_IngressPipe_CounterTable_1_notification_cnt_1__last0_value, sw_IngressPipe_CounterTable_1_notification_cnt_1__last_index, sw_IngressPipe_CounterTable_1_notification_cnt_1__last_old_value, sw_IngressPipe_CounterTable_1_notification_cnt_1__last_value, sw_IngressPipe_CounterTable_1_notification_cnt_1__last_write_site, sw_IngressPipe_CounterTable_1_notification_cnt_1__next_write_site, sw_IngressPipe_CounterTable_1_notification_cnt_1__wrote_any, sw_IngressPipe_CounterTable_1_notification_cnt_1__wrote_index0, sw___ra_ret_IngressPipe_CounterTable_1_reset_ncnt, sw___ra_val_IngressPipe_CounterTable_1_reset_ncnt;
{
    ...
    sw_IngressPipe_CounterTable_1_notification_cnt_1__last_old_value := sw_IngressPipe_CounterTable_1_notification_cnt_1[sw_ig_md.lock_index];
    sw_IngressPipe_CounterTable_1_notification_cnt_1[sw_ig_md.lock_index] := sw___ra_val_IngressPipe_CounterTable_1_reset_ncnt;
    sw_IngressPipe_CounterTable_1_notification_cnt_1__last_index := sw_ig_md.lock_index;
    sw_IngressPipe_CounterTable_1_notification_cnt_1__last_value := sw___ra_val_IngressPipe_CounterTable_1_reset_ncnt;
    sw_IngressPipe_CounterTable_1_notification_cnt_1__last_write_site := sw_IngressPipe_CounterTable_1_notification_cnt_1__next_write_site;
    sw_IngressPipe_CounterTable_1_notification_cnt_1__wrote_any := true;
    if (sw_ig_md.lock_index == 0bv32) {
        sw_IngressPipe_CounterTable_1_notification_cnt_1__wrote_index0 := true;
        sw_IngressPipe_CounterTable_1_notification_cnt_1__last0_old_value := sw_IngressPipe_CounterTable_1_notification_cnt_1__last_old_value;
        sw_IngressPipe_CounterTable_1_notification_cnt_1__last0_value := sw___ra_val_IngressPipe_CounterTable_1_reset_ncnt;
    }
}
	...
	modifies sw_IngressPipe_CounterTable_2_notification_cnt_2, sw_IngressPipe_CounterTable_2_notification_cnt_2__last0_old_value, sw_IngressPipe_CounterTable_2_notification_cnt_2__last0_value, sw_IngressPipe_CounterTable_2_notification_cnt_2__last_index, sw_IngressPipe_CounterTable_2_notification_cnt_2__last_old_value, sw_IngressPipe_CounterTable_2_notification_cnt_2__last_value, sw_IngressPipe_CounterTable_2_notification_cnt_2__last_write_site, sw_IngressPipe_CounterTable_2_notification_cnt_2__next_write_site, sw_IngressPipe_CounterTable_2_notification_cnt_2__wrote_any, sw_IngressPipe_CounterTable_2_notification_cnt_2__wrote_index0, sw___ra_ret_IngressPipe_CounterTable_2_cmp_ncnt, sw___ra_val_IngressPipe_CounterTable_2_cmp_ncnt, sw_ig_md.agent_changed;
{
    ...
    sw_IngressPipe_CounterTable_2_notification_cnt_2__last_old_value := sw_IngressPipe_CounterTable_2_notification_cnt_2[sw_ig_md.lock_index];
    sw_IngressPipe_CounterTable_2_notification_cnt_2[sw_ig_md.lock_index] := sw___ra_val_IngressPipe_CounterTable_2_cmp_ncnt;
    sw_IngressPipe_CounterTable_2_notification_cnt_2__last_index := sw_ig_md.lock_index;
    sw_IngressPipe_CounterTable_2_notification_cnt_2__last_value := sw___ra_val_IngressPipe_CounterTable_2_cmp_ncnt;
    ...
    if (sw_ig_md.lock_index == 0bv32) {
        ...
        sw_IngressPipe_CounterTable_2_notification_cnt_2__last0_value := sw___ra_val_IngressPipe_CounterTable_2_cmp_ncnt;
    }
	...
	modifies sw_IngressPipe_CounterTable_2_notification_cnt_2, sw_IngressPipe_CounterTable_2_notification_cnt_2__last0_old_value, sw_IngressPipe_CounterTable_2_notification_cnt_2__last0_value, sw_IngressPipe_CounterTable_2_notification_cnt_2__last_index, sw_IngressPipe_CounterTable_2_notification_cnt_2__last_old_value, sw_IngressPipe_CounterTable_2_notification_cnt_2__last_value, sw_IngressPipe_CounterTable_2_notification_cnt_2__last_write_site, sw_IngressPipe_CounterTable_2_notification_cnt_2__next_write_site, sw_IngressPipe_CounterTable_2_notification_cnt_2__wrote_any, sw_IngressPipe_CounterTable_2_notification_cnt_2__wrote_index0, sw___ra_ret_IngressPipe_CounterTable_2_count_ncnt, sw___ra_val_IngressPipe_CounterTable_2_count_ncnt;
{
    ...
    sw_IngressPipe_CounterTable_2_notification_cnt_2__last_old_value := sw_IngressPipe_CounterTable_2_notification_cnt_2[sw_ig_md.lock_index];
    sw_IngressPipe_CounterTable_2_notification_cnt_2[sw_ig_md.lock_index] := sw___ra_val_IngressPipe_CounterTable_2_count_ncnt;
    sw_IngressPipe_CounterTable_2_notification_cnt_2__last_index := sw_ig_md.lock_index;
    sw_IngressPipe_CounterTable_2_notification_cnt_2__last_value := sw___ra_val_IngressPipe_CounterTable_2_count_ncnt;
    sw_IngressPipe_CounterTable_2_notification_cnt_2__last_write_site := sw_IngressPipe_CounterTable_2_notification_cnt_2__next_write_site;
    sw_IngressPipe_CounterTable_2_notification_cnt_2__wrote_any := true;
    if (sw_ig_md.lock_index == 0bv32) {
        sw_IngressPipe_CounterTable_2_notification_cnt_2__wrote_index0 := true;
        sw_IngressPipe_CounterTable_2_notification_cnt_2__last0_old_value := sw_IngressPipe_CounterTable_2_notification_cnt_2__last_old_value;
        sw_IngressPipe_CounterTable_2_notification_cnt_2__last0_value := sw___ra_val_IngressPipe_CounterTable_2_count_ncnt;
    }
}
	...
	modifies sw_IngressPipe_CounterTable_2_notification_cnt_2, sw_IngressPipe_CounterTable_2_notification_cnt_2__last0_old_value, sw_IngressPipe_CounterTable_2_notification_cnt_2__last0_value, sw_IngressPipe_CounterTable_2_notification_cnt_2__last_index, sw_IngressPipe_CounterTable_2_notification_cnt_2__last_old_value, sw_IngressPipe_CounterTable_2_notification_cnt_2__last_value, sw_IngressPipe_CounterTable_2_notification_cnt_2__last_write_site, sw_IngressPipe_CounterTable_2_notification_cnt_2__next_write_site, sw_IngressPipe_CounterTable_2_notification_cnt_2__wrote_any, sw_IngressPipe_CounterTable_2_notification_cnt_2__wrote_index0, sw___ra_ret_IngressPipe_CounterTable_2_reset_ncnt, sw___ra_val_IngressPipe_CounterTable_2_reset_ncnt;
{
    ...
    sw_IngressPipe_CounterTable_2_notification_cnt_2__last_old_value := sw_IngressPipe_CounterTable_2_notification_cnt_2[sw_ig_md.lock_index];
    sw_IngressPipe_CounterTable_2_notification_cnt_2[sw_ig_md.lock_index] := sw___ra_val_IngressPipe_CounterTable_2_reset_ncnt;
    sw_IngressPipe_CounterTable_2_notification_cnt_2__last_index := sw_ig_md.lock_index;
    sw_IngressPipe_CounterTable_2_notification_cnt_2__last_value := sw___ra_val_IngressPipe_CounterTable_2_reset_ncnt;
    sw_IngressPipe_CounterTable_2_notification_cnt_2__last_write_site := sw_IngressPipe_CounterTable_2_notification_cnt_2__next_write_site;
    sw_IngressPipe_CounterTable_2_notification_cnt_2__wrote_any := true;
    if (sw_ig_md.lock_index == 0bv32) {
        sw_IngressPipe_CounterTable_2_notification_cnt_2__wrote_index0 := true;
        sw_IngressPipe_CounterTable_2_notification_cnt_2__last0_old_value := sw_IngressPipe_CounterTable_2_notification_cnt_2__last_old_value;
        sw_IngressPipe_CounterTable_2_notification_cnt_2__last0_value := sw___ra_val_IngressPipe_CounterTable_2_reset_ncnt;
    }
}
	...
	modifies sw_IngressPipe_CounterTable_3_notification_cnt_3, sw_IngressPipe_CounterTable_3_notification_cnt_3__last0_old_value, sw_IngressPipe_CounterTable_3_notification_cnt_3__last0_value, sw_IngressPipe_CounterTable_3_notification_cnt_3__last_index, sw_IngressPipe_CounterTable_3_notification_cnt_3__last_old_value, sw_IngressPipe_CounterTable_3_notification_cnt_3__last_value, sw_IngressPipe_CounterTable_3_notification_cnt_3__last_write_site, sw_IngressPipe_CounterTable_3_notification_cnt_3__next_write_site, sw_IngressPipe_CounterTable_3_notification_cnt_3__wrote_any, sw_IngressPipe_CounterTable_3_notification_cnt_3__wrote_index0, sw___ra_ret_IngressPipe_CounterTable_3_cmp_ncnt, sw___ra_val_IngressPipe_CounterTable_3_cmp_ncnt, sw_ig_md.agent_changed;
{
    ...
    sw_IngressPipe_CounterTable_3_notification_cnt_3__last_old_value := sw_IngressPipe_CounterTable_3_notification_cnt_3[sw_ig_md.lock_index];
    sw_IngressPipe_CounterTable_3_notification_cnt_3[sw_ig_md.lock_index] := sw___ra_val_IngressPipe_CounterTable_3_cmp_ncnt;
    sw_IngressPipe_CounterTable_3_notification_cnt_3__last_index := sw_ig_md.lock_index;
    sw_IngressPipe_CounterTable_3_notification_cnt_3__last_value := sw___ra_val_IngressPipe_CounterTable_3_cmp_ncnt;
    sw_IngressPipe_CounterTable_3_notification_cnt_3__last_write_site := sw_IngressPipe_CounterTable_3_notification_cnt_3__next_write_site;
    ...
    if (sw_ig_md.lock_index == 0bv32) {
        ...
        sw_IngressPipe_CounterTable_3_notification_cnt_3__last0_value := sw___ra_val_IngressPipe_CounterTable_3_cmp_ncnt;
    }
	...
	modifies sw_IngressPipe_CounterTable_3_notification_cnt_3, sw_IngressPipe_CounterTable_3_notification_cnt_3__last0_old_value, sw_IngressPipe_CounterTable_3_notification_cnt_3__last0_value, sw_IngressPipe_CounterTable_3_notification_cnt_3__last_index, sw_IngressPipe_CounterTable_3_notification_cnt_3__last_old_value, sw_IngressPipe_CounterTable_3_notification_cnt_3__last_value, sw_IngressPipe_CounterTable_3_notification_cnt_3__last_write_site, sw_IngressPipe_CounterTable_3_notification_cnt_3__next_write_site, sw_IngressPipe_CounterTable_3_notification_cnt_3__wrote_any, sw_IngressPipe_CounterTable_3_notification_cnt_3__wrote_index0, sw___ra_ret_IngressPipe_CounterTable_3_count_ncnt, sw___ra_val_IngressPipe_CounterTable_3_count_ncnt;
{
    ...
    sw_IngressPipe_CounterTable_3_notification_cnt_3__last_old_value := sw_IngressPipe_CounterTable_3_notification_cnt_3[sw_ig_md.lock_index];
    sw_IngressPipe_CounterTable_3_notification_cnt_3[sw_ig_md.lock_index] := sw___ra_val_IngressPipe_CounterTable_3_count_ncnt;
    sw_IngressPipe_CounterTable_3_notification_cnt_3__last_index := sw_ig_md.lock_index;
    sw_IngressPipe_CounterTable_3_notification_cnt_3__last_value := sw___ra_val_IngressPipe_CounterTable_3_count_ncnt;
    sw_IngressPipe_CounterTable_3_notification_cnt_3__last_write_site := sw_IngressPipe_CounterTable_3_notification_cnt_3__next_write_site;
    sw_IngressPipe_CounterTable_3_notification_cnt_3__wrote_any := true;
    if (sw_ig_md.lock_index == 0bv32) {
        sw_IngressPipe_CounterTable_3_notification_cnt_3__wrote_index0 := true;
        sw_IngressPipe_CounterTable_3_notification_cnt_3__last0_old_value := sw_IngressPipe_CounterTable_3_notification_cnt_3__last_old_value;
        sw_IngressPipe_CounterTable_3_notification_cnt_3__last0_value := sw___ra_val_IngressPipe_CounterTable_3_count_ncnt;
    }
}
	...
	modifies sw_IngressPipe_LockOperation_1_lock_agent_array_1, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last0_old_value, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last0_value, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last_index, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last_old_value, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last_value, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last_write_site, sw_IngressPipe_LockOperation_1_lock_agent_array_1__next_write_site, sw_IngressPipe_LockOperation_1_lock_agent_array_1__wrote_any, sw_IngressPipe_LockOperation_1_lock_agent_array_1__wrote_index0, sw___ra_ret_IngressPipe_LockOperation_1_get_lock_agent, sw___ra_val_IngressPipe_LockOperation_1_get_lock_agent, sw_hdr.lock.agent, sw_hdr.udp.dst_port;
{
    ...
    sw_IngressPipe_LockOperation_1_lock_agent_array_1__last_old_value := sw_IngressPipe_LockOperation_1_lock_agent_array_1[sw_ig_md.lock_index];
    sw_IngressPipe_LockOperation_1_lock_agent_array_1__last_index := sw_ig_md.lock_index;
    sw_IngressPipe_LockOperation_1_lock_agent_array_1__last_value := sw___ra_val_IngressPipe_LockOperation_1_get_lock_agent;
    ...
    if (sw_ig_md.lock_index == 0bv32) {
        ...
        sw_IngressPipe_LockOperation_1_lock_agent_array_1__last0_value := sw___ra_val_IngressPipe_LockOperation_1_get_lock_agent;
    }
...
procedure {:inline 1} sw_IngressPipe_LockOperation_1_mcast_to_agent()
	modifies sw_IngressPipe_LockOperation_1_lock_agent_array_1, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last0_old_value, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last0_value, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last_index, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last_old_value, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last_value, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last_write_site, sw_IngressPipe_LockOperation_1_lock_agent_array_1__next_write_site, sw_IngressPipe_LockOperation_1_lock_agent_array_1__wrote_any, sw_IngressPipe_LockOperation_1_lock_agent_array_1__wrote_index0, sw___ra_ret_IngressPipe_LockOperation_1_get_lock_agent, sw___ra_val_IngressPipe_LockOperation_1_get_lock_agent, sw_hdr.lock.agent, sw_hdr.lock.multicasted, sw_hdr.lock.type, sw_ig_md.dest2;
{
    sw_ig_md.dest2 := 0bv8++sw_hdr.lock.machine_id;
	...
	modifies sw_IngressPipe_LockOperation_1_lock_agent_array_1, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last0_old_value, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last0_value, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last_index, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last_old_value, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last_value, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last_write_site, sw_IngressPipe_LockOperation_1_lock_agent_array_1__next_write_site, sw_IngressPipe_LockOperation_1_lock_agent_array_1__wrote_any, sw_IngressPipe_LockOperation_1_lock_agent_array_1__wrote_index0, sw___ra_ret_IngressPipe_LockOperation_1_set_lock_agent, sw___ra_val_IngressPipe_LockOperation_1_set_lock_agent, sw_hdr.lock.agent, sw_hdr.lock.transferred, sw_hdr.lock.type, sw_hdr.udp.dst_port;
{
    ...
    sw_IngressPipe_LockOperation_1_lock_agent_array_1__last_old_value := sw_IngressPipe_LockOperation_1_lock_agent_array_1[sw_ig_md.lock_index];
    sw_IngressPipe_LockOperation_1_lock_agent_array_1[sw_ig_md.lock_index] := sw___ra_val_IngressPipe_LockOperation_1_set_lock_agent;
    sw_IngressPipe_LockOperation_1_lock_agent_array_1__last_index := sw_ig_md.lock_index;
    sw_IngressPipe_LockOperation_1_lock_agent_array_1__last_value := sw___ra_val_IngressPipe_LockOperation_1_set_lock_agent;
    sw_IngressPipe_LockOperation_1_lock_agent_array_1__last_write_site := sw_IngressPipe_LockOperation_1_lock_agent_array_1__next_write_site;
    sw_IngressPipe_LockOperation_1_lock_agent_array_1__wrote_any := true;
    if (sw_ig_md.lock_index == 0bv32) {
        sw_IngressPipe_LockOperation_1_lock_agent_array_1__wrote_index0 := true;
        sw_IngressPipe_LockOperation_1_lock_agent_array_1__last0_old_value := sw_IngressPipe_LockOperation_1_lock_agent_array_1__last_old_value;
        sw_IngressPipe_LockOperation_1_lock_agent_array_1__last0_value := sw___ra_val_IngressPipe_LockOperation_1_set_lock_agent;
    }
    sw_hdr.lock.agent := sw_hdr.lock.machine_id;
...
procedure {:inline 1} sw_IngressPipe_LockOperation_1_reset_agent()
	modifies sw_IngressPipe_LockOperation_1_lock_agent_array_1, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last0_old_value, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last0_value, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last_index, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last_old_value, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last_value, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last_write_site, sw_IngressPipe_LockOperation_1_lock_agent_array_1__next_write_site, sw_IngressPipe_LockOperation_1_lock_agent_array_1__wrote_any, sw_IngressPipe_LockOperation_1_lock_agent_array_1__wrote_index0, sw___ra_ret_IngressPipe_LockOperation_1_set_lock_agent, sw___ra_val_IngressPipe_LockOperation_1_set_lock_agent, sw_hdr.lock.agent, sw_ig_md.lock_agent;
{
	...
	modifies sw_IngressPipe_LockOperation_2_lock_agent_array_2, sw_IngressPipe_LockOperation_2_lock_agent_array_2__last0_old_value, sw_IngressPipe_LockOperation_2_lock_agent_array_2__last0_value, sw_IngressPipe_LockOperation_2_lock_agent_array_2__last_index, sw_IngressPipe_LockOperation_2_lock_agent_array_2__last_old_value, sw_IngressPipe_LockOperation_2_lock_agent_array_2__last_value, sw_IngressPipe_LockOperation_2_lock_agent_array_2__last_write_site, sw_IngressPipe_LockOperation_2_lock_agent_array_2__next_write_site, sw_IngressPipe_LockOperation_2_lock_agent_array_2__wrote_any, sw_IngressPipe_LockOperation_2_lock_agent_array_2__wrote_index0, sw___ra_ret_IngressPipe_LockOperation_2_get_lock_agent, sw___ra_val_IngressPipe_LockOperation_2_get_lock_agent, sw_hdr.lock.agent, sw_hdr.udp.dst_port;
{
    ...
    sw_IngressPipe_LockOperation_2_lock_agent_array_2__last_old_value := sw_IngressPipe_LockOperation_2_lock_agent_array_2[sw_ig_md.lock_index];
    sw_IngressPipe_LockOperation_2_lock_agent_array_2__last_index := sw_ig_md.lock_index;
    sw_IngressPipe_LockOperation_2_lock_agent_array_2__last_value := sw___ra_val_IngressPipe_LockOperation_2_get_lock_agent;
    sw_IngressPipe_LockOperation_2_lock_agent_array_2__last_write_site := sw_IngressPipe_LockOperation_2_lock_agent_array_2__next_write_site;
    ...
    if (sw_ig_md.lock_index == 0bv32) {
        ...
        sw_IngressPipe_LockOperation_2_lock_agent_array_2__last0_value := sw___ra_val_IngressPipe_LockOperation_2_get_lock_agent;
    }
...
procedure {:inline 1} sw_IngressPipe_LockOperation_2_new_agent()
	modifies sw_IngressPipe_LockOperation_2_lock_agent_array_2, sw_IngressPipe_LockOperation_2_lock_agent_array_2__last0_old_value, sw_IngressPipe_LockOperation_2_lock_agent_array_2__last0_value, sw_IngressPipe_LockOperation_2_lock_agent_array_2__last_index, sw_IngressPipe_LockOperation_2_lock_agent_array_2__last_old_value, sw_IngressPipe_LockOperation_2_lock_agent_array_2__last_value, sw_IngressPipe_LockOperation_2_lock_agent_array_2__last_write_site, sw_IngressPipe_LockOperation_2_lock_agent_array_2__next_write_site, sw_IngressPipe_LockOperation_2_lock_agent_array_2__wrote_any, sw_IngressPipe_LockOperation_2_lock_agent_array_2__wrote_index0, sw___ra_ret_IngressPipe_LockOperation_2_set_lock_agent, sw___ra_val_IngressPipe_LockOperation_2_set_lock_agent, sw_hdr.lock.agent, sw_hdr.lock.transferred, sw_hdr.lock.type, sw_hdr.udp.dst_port;
{
    ...
    sw_IngressPipe_LockOperation_2_lock_agent_array_2__last_old_value := sw_IngressPipe_LockOperation_2_lock_agent_array_2[sw_ig_md.lock_index];
    sw_IngressPipe_LockOperation_2_lock_agent_array_2[sw_ig_md.lock_index] := sw___ra_val_IngressPipe_LockOperation_2_set_lock_agent;
    sw_IngressPipe_LockOperation_2_lock_agent_array_2__last_index := sw_ig_md.lock_index;
    sw_IngressPipe_LockOperation_2_lock_agent_array_2__last_value := sw___ra_val_IngressPipe_LockOperation_2_set_lock_agent;
    sw_IngressPipe_LockOperation_2_lock_agent_array_2__last_write_site := sw_IngressPipe_LockOperation_2_lock_agent_array_2__next_write_site;
    sw_IngressPipe_LockOperation_2_lock_agent_array_2__wrote_any := true;
    if (sw_ig_md.lock_index == 0bv32) {
        sw_IngressPipe_LockOperation_2_lock_agent_array_2__wrote_index0 := true;
        sw_IngressPipe_LockOperation_2_lock_agent_array_2__last0_old_value := sw_IngressPipe_LockOperation_2_lock_agent_array_2__last_old_value;
        sw_IngressPipe_LockOperation_2_lock_agent_array_2__last0_value := sw___ra_val_IngressPipe_LockOperation_2_set_lock_agent;
    }
    sw_hdr.lock.agent := sw_hdr.lock.machine_id;
    sw_hdr.lock.type := 2bv8;
    sw_hdr.udp.dst_port := 20002bv16;
...
procedure {:inline 1} sw_IngressPipe_LockOperation_2_reset_agent()
	modifies sw_IngressPipe_LockOperation_2_lock_agent_array_2, sw_IngressPipe_LockOperation_2_lock_agent_array_2__last0_old_value, sw_IngressPipe_LockOperation_2_lock_agent_array_2__last0_value, sw_IngressPipe_LockOperation_2_lock_agent_array_2__last_index, sw_IngressPipe_LockOperation_2_lock_agent_array_2__last_old_value, sw_IngressPipe_LockOperation_2_lock_agent_array_2__last_value, sw_IngressPipe_LockOperation_2_lock_agent_array_2__last_write_site, sw_IngressPipe_LockOperation_2_lock_agent_array_2__next_write_site, sw_IngressPipe_LockOperation_2_lock_agent_array_2__wrote_any, sw_IngressPipe_LockOperation_2_lock_agent_array_2__wrote_index0, sw___ra_ret_IngressPipe_LockOperation_2_set_lock_agent, sw___ra_val_IngressPipe_LockOperation_2_set_lock_agent, sw_hdr.lock.agent, sw_ig_md.lock_agent;
{
    sw_ig_md.lock_agent := 0bv8;
    sw___ra_val_IngressPipe_LockOperation_2_set_lock_agent := sw_IngressPipe_LockOperation_2_lock_agent_array_2.read(sw_IngressPipe_LockOperation_2_lock_agent_array_2, sw_ig_md.lock_index);
    call sw___ra_val_IngressPipe_LockOperation_2_set_lock_agent := sw_IngressPipe_LockOperation_2_set_lock_agent.apply(sw___ra_val_IngressPipe_LockOperation_2_set_lock_agent);
	...
	modifies sw_IngressPipe_LockOperation_3_lock_agent_array_3, sw_IngressPipe_LockOperation_3_lock_agent_array_3__last0_old_value, sw_IngressPipe_LockOperation_3_lock_agent_array_3__last0_value, sw_IngressPipe_LockOperation_3_lock_agent_array_3__last_index, sw_IngressPipe_LockOperation_3_lock_agent_array_3__last_old_value, sw_IngressPipe_LockOperation_3_lock_agent_array_3__last_value, sw_IngressPipe_LockOperation_3_lock_agent_array_3__last_write_site, sw_IngressPipe_LockOperation_3_lock_agent_array_3__next_write_site, sw_IngressPipe_LockOperation_3_lock_agent_array_3__wrote_any, sw_IngressPipe_LockOperation_3_lock_agent_array_3__wrote_index0, sw___ra_ret_IngressPipe_LockOperation_3_get_lock_agent, sw___ra_val_IngressPipe_LockOperation_3_get_lock_agent, sw_hdr.lock.agent, sw_hdr.udp.dst_port;
{
    ...
    sw_IngressPipe_LockOperation_3_lock_agent_array_3__last_old_value := sw_IngressPipe_LockOperation_3_lock_agent_array_3[sw_ig_md.lock_index];
    sw_IngressPipe_LockOperation_3_lock_agent_array_3__last_index := sw_ig_md.lock_index;
    sw_IngressPipe_LockOperation_3_lock_agent_array_3__last_value := sw___ra_val_IngressPipe_LockOperation_3_get_lock_agent;
    ...
    if (sw_ig_md.lock_index == 0bv32) {
        ...
        sw_IngressPipe_LockOperation_3_lock_agent_array_3__last0_value := sw___ra_val_IngressPipe_LockOperation_3_get_lock_agent;
    }
...
procedure {:inline 1} sw_IngressPipe_LockOperation_3_mcast_to_agent()
	modifies sw_IngressPipe_LockOperation_3_lock_agent_array_3, sw_IngressPipe_LockOperation_3_lock_agent_array_3__last0_old_value, sw_IngressPipe_LockOperation_3_lock_agent_array_3__last0_value, sw_IngressPipe_LockOperation_3_lock_agent_array_3__last_index, sw_IngressPipe_LockOperation_3_lock_agent_array_3__last_old_value, sw_IngressPipe_LockOperation_3_lock_agent_array_3__last_value, sw_IngressPipe_LockOperation_3_lock_agent_array_3__last_write_site, sw_IngressPipe_LockOperation_3_lock_agent_array_3__next_write_site, sw_IngressPipe_LockOperation_3_lock_agent_array_3__wrote_any, sw_IngressPipe_LockOperation_3_lock_agent_array_3__wrote_index0, sw___ra_ret_IngressPipe_LockOperation_3_get_lock_agent, sw___ra_val_IngressPipe_LockOperation_3_get_lock_agent, sw_hdr.lock.agent, sw_hdr.lock.multicasted, sw_hdr.lock.type, sw_ig_md.dest2;
{
    sw_ig_md.dest2 := 0bv8++sw_hdr.lock.machine_id;
    sw_hdr.lock.multicasted := 1bv1;
    sw___ra_val_IngressPipe_LockOperation_3_get_lock_agent := sw_IngressPipe_LockOperation_3_lock_agent_array_3.read(sw_IngressPipe_LockOperation_3_lock_agent_array_3, sw_ig_md.lock_index);
	...
	modifies sw_IngressPipe_LockOperation_3_lock_agent_array_3, sw_IngressPipe_LockOperation_3_lock_agent_array_3__last0_old_value, sw_IngressPipe_LockOperation_3_lock_agent_array_3__last0_value, sw_IngressPipe_LockOperation_3_lock_agent_array_3__last_index, sw_IngressPipe_LockOperation_3_lock_agent_array_3__last_old_value, sw_IngressPipe_LockOperation_3_lock_agent_array_3__last_value, sw_IngressPipe_LockOperation_3_lock_agent_array_3__last_write_site, sw_IngressPipe_LockOperation_3_lock_agent_array_3__next_write_site, sw_IngressPipe_LockOperation_3_lock_agent_array_3__wrote_any, sw_IngressPipe_LockOperation_3_lock_agent_array_3__wrote_index0, sw___ra_ret_IngressPipe_LockOperation_3_set_lock_agent, sw___ra_val_IngressPipe_LockOperation_3_set_lock_agent, sw_hdr.lock.agent, sw_hdr.lock.transferred, sw_hdr.lock.type, sw_hdr.udp.dst_port;
{
    ...
    sw_IngressPipe_LockOperation_3_lock_agent_array_3__last_old_value := sw_IngressPipe_LockOperation_3_lock_agent_array_3[sw_ig_md.lock_index];
    sw_IngressPipe_LockOperation_3_lock_agent_array_3[sw_ig_md.lock_index] := sw___ra_val_IngressPipe_LockOperation_3_set_lock_agent;
    sw_IngressPipe_LockOperation_3_lock_agent_array_3__last_index := sw_ig_md.lock_index;
    sw_IngressPipe_LockOperation_3_lock_agent_array_3__last_value := sw___ra_val_IngressPipe_LockOperation_3_set_lock_agent;
    sw_IngressPipe_LockOperation_3_lock_agent_array_3__last_write_site := sw_IngressPipe_LockOperation_3_lock_agent_array_3__next_write_site;
    sw_IngressPipe_LockOperation_3_lock_agent_array_3__wrote_any := true;
    if (sw_ig_md.lock_index == 0bv32) {
        sw_IngressPipe_LockOperation_3_lock_agent_array_3__wrote_index0 := true;
        sw_IngressPipe_LockOperation_3_lock_agent_array_3__last0_old_value := sw_IngressPipe_LockOperation_3_lock_agent_array_3__last_old_value;
        sw_IngressPipe_LockOperation_3_lock_agent_array_3__last0_value := sw___ra_val_IngressPipe_LockOperation_3_set_lock_agent;
    }
    sw_hdr.lock.agent := sw_hdr.lock.machine_id;
    sw_hdr.lock.type := 2bv8;
    sw_hdr.udp.dst_port := 20002bv16;
	...
	modifies sw_IngressPipe_lock_free_mode_array, sw_IngressPipe_lock_free_mode_array__last0_old_value, sw_IngressPipe_lock_free_mode_array__last0_value, sw_IngressPipe_lock_free_mode_array__last_index, sw_IngressPipe_lock_free_mode_array__last_old_value, sw_IngressPipe_lock_free_mode_array__last_value, sw_IngressPipe_lock_free_mode_array__last_write_site, sw_IngressPipe_lock_free_mode_array__next_write_site, sw_IngressPipe_lock_free_mode_array__wrote_any, sw_IngressPipe_lock_free_mode_array__wrote_index0, sw___ra_ret_IngressPipe_acquire, sw___ra_val_IngressPipe_acquire, sw_ig_md.lock_free_mode;
{
    ...
    sw_IngressPipe_lock_free_mode_array__last_old_value := sw_IngressPipe_lock_free_mode_array[sw_hdr.lock.id];
    sw_IngressPipe_lock_free_mode_array[sw_hdr.lock.id] := sw___ra_val_IngressPipe_acquire;
    sw_IngressPipe_lock_free_mode_array__last_index := sw_hdr.lock.id;
    sw_IngressPipe_lock_free_mode_array__last_value := sw___ra_val_IngressPipe_acquire;
    sw_IngressPipe_lock_free_mode_array__last_write_site := sw_IngressPipe_lock_free_mode_array__next_write_site;
    sw_IngressPipe_lock_free_mode_array__wrote_any := true;
    if (sw_hdr.lock.id == 0bv32) {
        ...
        sw_IngressPipe_lock_free_mode_array__last0_value := sw___ra_val_IngressPipe_acquire;
    }
...
// sw_Action sw_IngressPipe_drop
procedure {:inline 1} sw_IngressPipe_drop()
	modifies sw_ig_intr_dprsr_md.drop_ctl;
{
    sw_ig_intr_dprsr_md.drop_ctl := 1bv3;
}

// sw_Table sw_IngressPipe_eth_fallback
procedure {:inline 1} sw_IngressPipe_eth_fallback.apply()
	modifies sw_IngressPipe_eth_fallback.action_run, sw_IngressPipe_eth_fallback.hit, sw_hdr.ethernet.dst_mac, sw_ig_intr_dprsr_md.drop_ctl, sw_ig_intr_tm_md.ucast_egress_port;
{
    sw_hdr.ethernet.dst_mac := sw_hdr.ethernet.dst_mac;
    sw_IngressPipe_eth_fallback.hit := false;
    goto sw_action_IngressPipe_eth_forward, sw_action_IngressPipe_drop;

    sw_action_IngressPipe_eth_forward:
    assume sw_IngressPipe_eth_fallback.action_run == sw_IngressPipe_eth_fallback.action.IngressPipe_eth_forward;
    sw_ig_intr_tm_md.ucast_egress_port := sw_IngressPipe_eth_fallback.IngressPipe_eth_forward.port;
    sw_ig_intr_dprsr_md.drop_ctl := 0bv3;
    goto sw_Exit;

    sw_action_IngressPipe_drop:
    assume sw_IngressPipe_eth_fallback.action_run == sw_IngressPipe_eth_fallback.action.IngressPipe_drop;
    call sw_IngressPipe_drop();
    goto sw_Exit;

    sw_Exit:
}

// sw_Action sw_IngressPipe_eth_forward
procedure {:inline 1} sw_IngressPipe_eth_forward(sw_port:sw_PortId_t)
	modifies sw_ig_intr_dprsr_md.drop_ctl, sw_ig_intr_tm_md.ucast_egress_port;
{
    sw_ig_intr_tm_md.ucast_egress_port := sw_port;
    sw_ig_intr_dprsr_md.drop_ctl := 0bv3;
}
	...
	modifies sw_IngressPipe_lock_rw_mode_array, sw_IngressPipe_lock_rw_mode_array__last0_old_value, sw_IngressPipe_lock_rw_mode_array__last0_value, sw_IngressPipe_lock_rw_mode_array__last_index, sw_IngressPipe_lock_rw_mode_array__last_old_value, sw_IngressPipe_lock_rw_mode_array__last_value, sw_IngressPipe_lock_rw_mode_array__last_write_site, sw_IngressPipe_lock_rw_mode_array__next_write_site, sw_IngressPipe_lock_rw_mode_array__wrote_any, sw_IngressPipe_lock_rw_mode_array__wrote_index0, sw___ra_ret_IngressPipe_set_excl, sw___ra_val_IngressPipe_set_excl, sw_ig_md.lock_rw_mode;
{
    ...
    sw_IngressPipe_lock_rw_mode_array__last_old_value := sw_IngressPipe_lock_rw_mode_array[sw_hdr.lock.id];
    sw_IngressPipe_lock_rw_mode_array[sw_hdr.lock.id] := sw___ra_val_IngressPipe_set_excl;
    sw_IngressPipe_lock_rw_mode_array__last_index := sw_hdr.lock.id;
    sw_IngressPipe_lock_rw_mode_array__last_value := sw___ra_val_IngressPipe_set_excl;
    ...
    if (sw_hdr.lock.id == 0bv32) {
        ...
        sw_IngressPipe_lock_rw_mode_array__last0_value := sw___ra_val_IngressPipe_set_excl;
    }
	...
	modifies sw_IngressPipe_lock_rw_mode_array, sw_IngressPipe_lock_rw_mode_array__last0_old_value, sw_IngressPipe_lock_rw_mode_array__last0_value, sw_IngressPipe_lock_rw_mode_array__last_index, sw_IngressPipe_lock_rw_mode_array__last_old_value, sw_IngressPipe_lock_rw_mode_array__last_value, sw_IngressPipe_lock_rw_mode_array__last_write_site, sw_IngressPipe_lock_rw_mode_array__next_write_site, sw_IngressPipe_lock_rw_mode_array__wrote_any, sw_IngressPipe_lock_rw_mode_array__wrote_index0, sw___ra_ret_IngressPipe_get_mode, sw___ra_val_IngressPipe_get_mode, sw_ig_md.lock_rw_mode;
{
    ...
    sw_IngressPipe_lock_rw_mode_array__last_old_value := sw_IngressPipe_lock_rw_mode_array[sw_hdr.lock.id];
    sw_IngressPipe_lock_rw_mode_array__last_index := sw_hdr.lock.id;
    sw_IngressPipe_lock_rw_mode_array__last_value := sw___ra_val_IngressPipe_get_mode;
    sw_IngressPipe_lock_rw_mode_array__last_write_site := sw_IngressPipe_lock_rw_mode_array__next_write_site;
    sw_IngressPipe_lock_rw_mode_array__wrote_any := true;
    if (sw_hdr.lock.id == 0bv32) {
        sw_IngressPipe_lock_rw_mode_array__wrote_index0 := true;
        sw_IngressPipe_lock_rw_mode_array__last0_old_value := sw_IngressPipe_lock_rw_mode_array__last_old_value;
        sw_IngressPipe_lock_rw_mode_array__last0_value := sw___ra_val_IngressPipe_get_mode;
    }
	...
	modifies sw_IngressPipe_lock_rw_mode_array, sw_IngressPipe_lock_rw_mode_array__last0_old_value, sw_IngressPipe_lock_rw_mode_array__last0_value, sw_IngressPipe_lock_rw_mode_array__last_index, sw_IngressPipe_lock_rw_mode_array__last_old_value, sw_IngressPipe_lock_rw_mode_array__last_value, sw_IngressPipe_lock_rw_mode_array__last_write_site, sw_IngressPipe_lock_rw_mode_array__next_write_site, sw_IngressPipe_lock_rw_mode_array__wrote_any, sw_IngressPipe_lock_rw_mode_array__wrote_index0, sw___ra_ret_IngressPipe_set_shared, sw___ra_val_IngressPipe_set_shared, sw_ig_md.lock_rw_mode;
{
    ...
    sw_IngressPipe_lock_rw_mode_array__last_old_value := sw_IngressPipe_lock_rw_mode_array[sw_hdr.lock.id];
    sw_IngressPipe_lock_rw_mode_array[sw_hdr.lock.id] := sw___ra_val_IngressPipe_set_shared;
    sw_IngressPipe_lock_rw_mode_array__last_index := sw_hdr.lock.id;
    sw_IngressPipe_lock_rw_mode_array__last_value := sw___ra_val_IngressPipe_set_shared;
    sw_IngressPipe_lock_rw_mode_array__last_write_site := sw_IngressPipe_lock_rw_mode_array__next_write_site;
    sw_IngressPipe_lock_rw_mode_array__wrote_any := true;
    if (sw_hdr.lock.id == 0bv32) {
        sw_IngressPipe_lock_rw_mode_array__wrote_index0 := true;
        sw_IngressPipe_lock_rw_mode_array__last0_old_value := sw_IngressPipe_lock_rw_mode_array__last_old_value;
        sw_IngressPipe_lock_rw_mode_array__last0_value := sw___ra_val_IngressPipe_set_shared;
    }
	...
	modifies sw_IngressPipe_lock_free_mode_array, sw_IngressPipe_lock_free_mode_array__last0_old_value, sw_IngressPipe_lock_free_mode_array__last0_value, sw_IngressPipe_lock_free_mode_array__last_index, sw_IngressPipe_lock_free_mode_array__last_old_value, sw_IngressPipe_lock_free_mode_array__last_value, sw_IngressPipe_lock_free_mode_array__last_write_site, sw_IngressPipe_lock_free_mode_array__next_write_site, sw_IngressPipe_lock_free_mode_array__wrote_any, sw_IngressPipe_lock_free_mode_array__wrote_index0, sw___ra_ret_IngressPipe_release, sw___ra_val_IngressPipe_release, sw_ig_md.lock_free_mode;
{
    ...
    sw_IngressPipe_lock_free_mode_array__last_old_value := sw_IngressPipe_lock_free_mode_array[sw_hdr.lock.id];
    sw_IngressPipe_lock_free_mode_array[sw_hdr.lock.id] := sw___ra_val_IngressPipe_release;
    sw_IngressPipe_lock_free_mode_array__last_index := sw_hdr.lock.id;
    sw_IngressPipe_lock_free_mode_array__last_value := sw___ra_val_IngressPipe_release;
    sw_IngressPipe_lock_free_mode_array__last_write_site := sw_IngressPipe_lock_free_mode_array__next_write_site;
    sw_IngressPipe_lock_free_mode_array__wrote_any := true;
    if (sw_hdr.lock.id == 0bv32) {
        sw_IngressPipe_lock_free_mode_array__wrote_index0 := true;
        sw_IngressPipe_lock_free_mode_array__last0_old_value := sw_IngressPipe_lock_free_mode_array__last_old_value;
        sw_IngressPipe_lock_free_mode_array__last0_value := sw___ra_val_IngressPipe_release;
    }
...
procedure {:inline 1} sw_main()
	modifies sw_IngressPipe_CounterTable_1_counter_table_1.action_run, sw_IngressPipe_CounterTable_1_counter_table_1.hit, sw_IngressPipe_CounterTable_1_notification_cnt_1, sw_IngressPipe_CounterTable_1_notification_cnt_1__last0_old_value, sw_IngressPipe_CounterTable_1_notification_cnt_1__last0_value, sw_IngressPipe_CounterTable_1_notification_cnt_1__last_index, sw_IngressPipe_CounterTable_1_notification_cnt_1__last_old_value, sw_IngressPipe_CounterTable_1_notification_cnt_1__last_value, sw_IngressPipe_CounterTable_1_notification_cnt_1__last_write_site, sw_IngressPipe_CounterTable_1_notification_cnt_1__next_write_site, sw_IngressPipe_CounterTable_1_notification_cnt_1__wrote_any, sw_IngressPipe_CounterTable_1_notification_cnt_1__wrote_index0, sw_IngressPipe_CounterTable_2_counter_table_2.action_run, sw_IngressPipe_CounterTable_2_counter_table_2.hit, sw_IngressPipe_CounterTable_2_notification_cnt_2, sw_IngressPipe_CounterTable_2_notification_cnt_2__last0_old_value, sw_IngressPipe_CounterTable_2_notification_cnt_2__last0_value, sw_IngressPipe_CounterTable_2_notification_cnt_2__last_index, sw_IngressPipe_CounterTable_2_notification_cnt_2__last_old_value, sw_IngressPipe_CounterTable_2_notification_cnt_2__last_value, sw_IngressPipe_CounterTable_2_notification_cnt_2__last_write_site, sw_IngressPipe_CounterTable_2_notification_cnt_2__next_write_site, sw_IngressPipe_CounterTable_2_notification_cnt_2__wrote_any, sw_IngressPipe_CounterTable_2_notification_cnt_2__wrote_index0, sw_IngressPipe_CounterTable_3_counter_table_3.action_run, sw_IngressPipe_CounterTable_3_counter_table_3.hit, sw_IngressPipe_CounterTable_3_notification_cnt_3, sw_IngressPipe_CounterTable_3_notification_cnt_3__last0_old_value, sw_IngressPipe_CounterTable_3_notification_cnt_3__last0_value, sw_IngressPipe_CounterTable_3_notification_cnt_3__last_index, sw_IngressPipe_CounterTable_3_notification_cnt_3__last_old_value, sw_IngressPipe_CounterTable_3_notification_cnt_3__last_value, sw_IngressPipe_CounterTable_3_notification_cnt_3__last_write_site, sw_IngressPipe_CounterTable_3_notification_cnt_3__next_write_site, sw_IngressPipe_CounterTable_3_notification_cnt_3__wrote_any, sw_IngressPipe_CounterTable_3_notification_cnt_3__wrote_index0, sw_IngressPipe_LockOperation_1_lock_agent_array_1, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last0_old_value, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last0_value, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last_index, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last_old_value, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last_value, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last_write_site, sw_IngressPipe_LockOperation_1_lock_agent_array_1__next_write_site, sw_IngressPipe_LockOperation_1_lock_agent_array_1__wrote_any, sw_IngressPipe_LockOperation_1_lock_agent_array_1__wrote_index0, sw_IngressPipe_LockOperation_1_lock_operation_1.action_run, sw_IngressPipe_LockOperation_1_lock_operation_1.hit, sw_IngressPipe_LockOperation_2_lock_agent_array_2, sw_IngressPipe_LockOperation_2_lock_agent_array_2__last0_old_value, sw_IngressPipe_LockOperation_2_lock_agent_array_2__last0_value, sw_IngressPipe_LockOperation_2_lock_agent_array_2__last_index, sw_IngressPipe_LockOperation_2_lock_agent_array_2__last_old_value, sw_IngressPipe_LockOperation_2_lock_agent_array_2__last_value, sw_IngressPipe_LockOperation_2_lock_agent_array_2__last_write_site, sw_IngressPipe_LockOperation_2_lock_agent_array_2__next_write_site, sw_IngressPipe_LockOperation_2_lock_agent_array_2__wrote_any, sw_IngressPipe_LockOperation_2_lock_agent_array_2__wrote_index0, sw_IngressPipe_LockOperation_2_lock_operation_2.action_run, sw_IngressPipe_LockOperation_2_lock_operation_2.hit, sw_IngressPipe_LockOperation_3_lock_agent_array_3, sw_IngressPipe_LockOperation_3_lock_agent_array_3__last0_old_value, sw_IngressPipe_LockOperation_3_lock_agent_array_3__last0_value, sw_IngressPipe_LockOperation_3_lock_agent_array_3__last_index, sw_IngressPipe_LockOperation_3_lock_agent_array_3__last_old_value, sw_IngressPipe_LockOperation_3_lock_agent_array_3__last_value, sw_IngressPipe_LockOperation_3_lock_agent_array_3__last_write_site, sw_IngressPipe_LockOperation_3_lock_agent_array_3__next_write_site, sw_IngressPipe_LockOperation_3_lock_agent_array_3__wrote_any, sw_IngressPipe_LockOperation_3_lock_agent_array_3__wrote_index0, sw_IngressPipe_LockOperation_3_lock_operation_3.action_run, sw_IngressPipe_LockOperation_3_lock_operation_3.hit, sw_IngressPipe_acquire_table.action_run, sw_IngressPipe_acquire_table.hit, sw_IngressPipe_eth_fallback.action_run, sw_IngressPipe_eth_fallback.hit, sw_IngressPipe_lock_free_mode_array, sw_IngressPipe_lock_free_mode_array__last0_old_value, sw_IngressPipe_lock_free_mode_array__last0_value, sw_IngressPipe_lock_free_mode_array__last_index, sw_IngressPipe_lock_free_mode_array__last_old_value, sw_IngressPipe_lock_free_mode_array__last_value, sw_IngressPipe_lock_free_mode_array__last_write_site, sw_IngressPipe_lock_free_mode_array__next_write_site, sw_IngressPipe_lock_free_mode_array__wrote_any, sw_IngressPipe_lock_free_mode_array__wrote_index0, sw_IngressPipe_lock_rw_mode_array, sw_IngressPipe_lock_rw_mode_array__last0_old_value, sw_IngressPipe_lock_rw_mode_array__last0_value, sw_IngressPipe_lock_rw_mode_array__last_index, sw_IngressPipe_lock_rw_mode_array__last_old_value, sw_IngressPipe_lock_rw_mode_array__last_value, sw_IngressPipe_lock_rw_mode_array__last_write_site, sw_IngressPipe_lock_rw_mode_array__next_write_site, sw_IngressPipe_lock_rw_mode_array__wrote_any, sw_IngressPipe_lock_rw_mode_array__wrote_index0, sw_IngressPipe_release_table.action_run, sw_IngressPipe_release_table.hit, sw_IngressPipe_rw_table.action_run, sw_IngressPipe_rw_table.hit, sw___ra_ret_IngressPipe_CounterTable_1_cmp_ncnt, sw___ra_ret_IngressPipe_CounterTable_1_count_ncnt, sw___ra_ret_IngressPipe_CounterTable_1_reset_ncnt, sw___ra_ret_IngressPipe_CounterTable_2_cmp_ncnt, sw___ra_ret_IngressPipe_CounterTable_2_count_ncnt, sw___ra_ret_IngressPipe_CounterTable_2_reset_ncnt, sw___ra_ret_IngressPipe_CounterTable_3_cmp_ncnt, sw___ra_ret_IngressPipe_CounterTable_3_count_ncnt, sw___ra_ret_IngressPipe_CounterTable_3_reset_ncnt, sw___ra_ret_IngressPipe_LockOperation_1_get_lock_agent, sw___ra_ret_IngressPipe_LockOperation_1_set_lock_agent, sw___ra_ret_IngressPipe_LockOperation_2_get_lock_agent, sw___ra_ret_IngressPipe_LockOperation_2_set_lock_agent, sw___ra_ret_IngressPipe_LockOperation_3_get_lock_agent, sw___ra_ret_IngressPipe_LockOperation_3_set_lock_agent, sw___ra_ret_IngressPipe_acquire, sw___ra_ret_IngressPipe_get_mode, sw___ra_ret_IngressPipe_release, sw___ra_ret_IngressPipe_set_excl, sw___ra_ret_IngressPipe_set_shared, sw___ra_val_IngressPipe_CounterTable_1_cmp_ncnt, sw___ra_val_IngressPipe_CounterTable_1_count_ncnt, sw___ra_val_IngressPipe_CounterTable_1_reset_ncnt, sw___ra_val_IngressPipe_CounterTable_2_cmp_ncnt, sw___ra_val_IngressPipe_CounterTable_2_count_ncnt, sw___ra_val_IngressPipe_CounterTable_2_reset_ncnt, sw___ra_val_IngressPipe_CounterTable_3_cmp_ncnt, sw___ra_val_IngressPipe_CounterTable_3_count_ncnt, sw___ra_val_IngressPipe_CounterTable_3_reset_ncnt, sw___ra_val_IngressPipe_LockOperation_1_get_lock_agent, sw___ra_val_IngressPipe_LockOperation_1_set_lock_agent, sw___ra_val_IngressPipe_LockOperation_2_get_lock_agent, sw___ra_val_IngressPipe_LockOperation_2_set_lock_agent, sw___ra_val_IngressPipe_LockOperation_3_get_lock_agent, sw___ra_val_IngressPipe_LockOperation_3_set_lock_agent, sw___ra_val_IngressPipe_acquire, sw___ra_val_IngressPipe_get_mode, sw___ra_val_IngressPipe_release, sw___ra_val_IngressPipe_set_excl, sw___ra_val_IngressPipe_set_shared, sw_drop, sw_eg_md.is_roce, sw_eg_md.pkt_psn, sw_hdr.ethernet.dst_mac, sw_hdr.ipv4.hdr_cksum, sw_hdr.lock.agent, sw_hdr.lock.granted, sw_hdr.lock.mode, sw_hdr.lock.multicasted, sw_hdr.lock.old_mode, sw_hdr.lock.transferred, sw_hdr.lock.type, sw_hdr.udp.dst_port, sw_ig_intr_dprsr_md.drop_ctl, sw_ig_intr_tm_md.mcast_grp_a, sw_ig_intr_tm_md.mcast_grp_b, sw_ig_intr_tm_md.ucast_egress_port, sw_ig_md.agent_changed, sw_ig_md.dest2, sw_ig_md.is_roce, sw_ig_md.lock_agent, sw_ig_md.lock_free_mode, sw_ig_md.lock_index, sw_ig_md.lock_out_of_range, sw_ig_md.lock_rw_mode, sw_ig_md.pkt_psn, sw_isValid;
{
    call sw_pipe();
    if(sw_forward == false){
        sw_drop := true;
...
var client_hdr.ethernet.src_mac: sw_mac_addr_t;
...
var client_hdr.ipv4.total_len: bv16;
var client_hdr.ipv4.ident: bv16;
var client_hdr.ipv4.flags: bv3;
var client_hdr.ipv4.frag_offset: bv13;
var client_hdr.ipv4.ttl: bv8;
var client_hdr.ipv4.l4_proto: bv8;
var client_hdr.ipv4.hdr_cksum: bv16;
var client_hdr.ipv4.src_ip: sw_ipv4_addr_t;
var client_hdr.ipv4.dst_ip: sw_ipv4_addr_t;
var client_hdr.ipv6.valid: bool;
var client_hdr.ipv6.version: bv4;
var client_hdr.ipv6.traffic_class: bv8;
var client_hdr.ipv6.flow_table: bv20;
var client_hdr.ipv6.payload_len: bv16;
var client_hdr.ipv6.next_hdr: bv8;
var client_hdr.ipv6.hop_limit: bv8;
var client_hdr.ipv6.src_ip: sw_ipv6_addr_t;
var client_hdr.ipv6.dst_ip: sw_ipv6_addr_t;
var client_hdr.arp.valid: bool;
var client_hdr.arp.hw_type: bv16;
var client_hdr.arp.proto_type: bv16;
var client_hdr.arp.hw_addr_len: bv8;
var client_hdr.arp.proto_addr_len: bv8;
var client_hdr.arp.opcode: bv16;
var client_hdr.arp.src_mac: sw_mac_addr_t;
var client_hdr.arp.src_ip: sw_ipv4_addr_t;
var client_hdr.arp.dst_mac: sw_mac_addr_t;
var client_hdr.arp.dst_ip: sw_ipv4_addr_t;
var client_hdr.udp.valid: bool;
var client_hdr.udp.src_port: sw_udp_port_t;
var client_hdr.udp.dst_port: sw_udp_port_t;
var client_hdr.udp.len: bv16;
var client_hdr.udp.checksum: bv16;
var client_hdr.roce.valid: bool;
var client_hdr.roce.opcode: bv8;
var client_hdr.roce._unused: bv4;
var client_hdr.roce.trans_hdr_ver: bv4;
var client_hdr.roce.p_key: bv16;
var client_hdr.roce._reserved: bv8;
var client_hdr.roce.dest_qp: sw_qp_t;
var client_hdr.roce.ack_req: bv1;
var client_hdr.roce.__reserved: bv7;
var client_hdr.roce.psn: sw_psn_t;
var client_hdr.roce_reth.valid: bool;
var client_hdr.roce_reth.vaddr: sw_mem_addr_t;
var client_hdr.roce_reth.rkey: sw_key_t;
var client_hdr.roce_reth.length: bv32;
var client_hdr.roce_deth.valid: bool;
var client_hdr.roce_deth.qkey: sw_key_t;
var client_hdr.roce_deth._reserved: bv8;
var client_hdr.roce_deth.src_qp: sw_qp_t;
var client_hdr.roce_aeth.valid: bool;
var client_hdr.roce_aeth.syndrome: bv8;
var client_hdr.roce_aeth.msn: sw_msn_t;
...
var client_hdr.lock.reserved: bv3;
...
var client_eg_md.dest2: bv16;
var client_eg_md.lock_free_mode: bv1;
var client_eg_md.lock_rw_mode: bv1;
var client_eg_md.lock_agent: sw_host_t;
var client_eg_md.lock_index: sw_lid_t;
var client_eg_md.agent_changed: bv1;
var client_eg_md.lock_out_of_range: bv1;
...
var client_ig_intr_dprs_md.drop_ctl: bv3;
var client_ig_intr_dprs_md.mirror_type: sw_MirrorType_t;
var client_ig_intr_dprs_md.coalesce_flush: bv1;
var client_ig_intr_dprs_md.coalesce_length: bv7;
...
var client_meta.dest2: bv16;
var client_meta.lock_free_mode: bv1;
var client_meta.lock_rw_mode: bv1;
var client_meta.lock_agent: sw_host_t;
var client_meta.lock_index: sw_lid_t;
var client_meta.agent_changed: bv1;
var client_meta.lock_out_of_range: bv1;
var client_meta.is_roce: bv1;
var client_meta.pkt_psn: sw_psn_t;
...
procedure main() returns()
  modifies client_eg_intr_md._pad0, client_eg_intr_md._pad1, client_eg_intr_md._pad10, client_eg_intr_md._pad2, client_eg_intr_md._pad3, client_eg_intr_md._pad4, client_eg_intr_md._pad5, client_eg_intr_md._pad6, client_eg_intr_md._pad7, client_eg_intr_md._pad8, client_eg_intr_md._pad9, client_eg_intr_md.app_pool_congest_stat, client_eg_intr_md.deflection_flag, client_eg_intr_md.deq_congest_stat, client_eg_intr_md.deq_qdepth, client_eg_intr_md.deq_timedelta, client_eg_intr_md.egress_cos, client_eg_intr_md.egress_qid, client_eg_intr_md.egress_rid, client_eg_intr_md.egress_rid_first, client_eg_intr_md.enq_congest_stat, client_eg_intr_md.enq_qdepth, client_eg_intr_md.enq_tstamp, client_eg_intr_md.pkt_length, client_eg_intr_md.valid, client_eg_intr_oport_md.capture_tstamp_on_tx, client_eg_intr_oport_md.update_delay_on_tx, client_eg_md.agent_changed, client_eg_md.dest2, client_eg_md.is_roce, client_eg_md.lock_agent, client_eg_md.lock_free_mode, client_eg_md.lock_index, client_eg_md.lock_out_of_range, client_eg_md.lock_rw_mode, client_eg_md.pkt_psn, client_hdr.arp.dst_ip, client_hdr.arp.dst_mac, client_hdr.arp.hw_addr_len, client_hdr.arp.hw_type, client_hdr.arp.opcode, client_hdr.arp.proto_addr_len, client_hdr.arp.proto_type, client_hdr.arp.src_ip, client_hdr.arp.src_mac, client_hdr.arp.valid, client_hdr.ethernet.dst_mac, client_hdr.ethernet.l3_proto, client_hdr.ethernet.src_mac, client_hdr.ethernet.valid, client_hdr.ipv4.diffserv, client_hdr.ipv4.dst_ip, client_hdr.ipv4.flags, client_hdr.ipv4.frag_offset, client_hdr.ipv4.hdr_cksum, client_hdr.ipv4.ident, client_hdr.ipv4.ihl, client_hdr.ipv4.l4_proto, client_hdr.ipv4.src_ip, client_hdr.ipv4.total_len, client_hdr.ipv4.ttl, client_hdr.ipv4.valid, client_hdr.ipv4.version, client_hdr.ipv6.dst_ip, client_hdr.ipv6.flow_table, client_hdr.ipv6.hop_limit, client_hdr.ipv6.next_hdr, client_hdr.ipv6.payload_len, client_hdr.ipv6.src_ip, client_hdr.ipv6.traffic_class, client_hdr.ipv6.valid, client_hdr.ipv6.version, client_hdr.lock.agent, client_hdr.lock.granted, client_hdr.lock.id, client_hdr.lock.machine_id, client_hdr.lock.mode, client_hdr.lock.multicasted, client_hdr.lock.ncnt, client_hdr.lock.old_mode, client_hdr.lock.reserved, client_hdr.lock.task_id, client_hdr.lock.transferred, client_hdr.lock.type, client_hdr.lock.valid, client_hdr.lock.wq_size, client_hdr.roce.__reserved, client_hdr.roce._reserved, client_hdr.roce._unused, client_hdr.roce.ack_req, client_hdr.roce.dest_qp, client_hdr.roce.opcode, client_hdr.roce.p_key, client_hdr.roce.psn, client_hdr.roce.trans_hdr_ver, client_hdr.roce.valid, client_hdr.roce_aeth.msn, client_hdr.roce_aeth.syndrome, client_hdr.roce_aeth.valid, client_hdr.roce_deth._reserved, client_hdr.roce_deth.qkey, client_hdr.roce_deth.src_qp, client_hdr.roce_deth.valid, client_hdr.roce_reth.length, client_hdr.roce_reth.rkey, client_hdr.roce_reth.vaddr, client_hdr.roce_reth.valid, client_hdr.udp.checksum, client_hdr.udp.dst_port, client_hdr.udp.len, client_hdr.udp.src_port, client_hdr.udp.valid, client_ig_intr_dprs_md.coalesce_flush, client_ig_intr_dprs_md.coalesce_length, client_ig_intr_dprs_md.drop_ctl, client_ig_intr_dprs_md.mirror_type, client_ig_intr_dprsr_md.digest_type, client_ig_intr_dprsr_md.drop_ctl, client_ig_intr_dprsr_md.mirror_type, client_ig_intr_dprsr_md.resubmit_type, client_ig_intr_md._pad1, client_ig_intr_md._pad2, client_ig_intr_md.ingress_mac_tstamp, client_ig_intr_md.ingress_port, client_ig_intr_md.packet_version, client_ig_intr_md.resubmit_flag, client_ig_intr_md.valid, client_ig_intr_prsr_md.global_tstamp, client_ig_intr_prsr_md.global_ver, client_ig_intr_prsr_md.parser_err, client_ig_intr_tm_md.bypass_egress, client_ig_intr_tm_md.copy_to_cpu, client_ig_intr_tm_md.deflect_on_drop, client_ig_intr_tm_md.disable_ucast_cutthru, client_ig_intr_tm_md.enable_mcast_cutthru, client_ig_intr_tm_md.icos_for_copy_to_cpu, client_ig_intr_tm_md.ingress_cos, client_ig_intr_tm_md.level1_exclusion_id, client_ig_intr_tm_md.level1_mcast_hash, client_ig_intr_tm_md.level2_exclusion_id, client_ig_intr_tm_md.level2_mcast_hash, client_ig_intr_tm_md.mcast_grp_a, client_ig_intr_tm_md.mcast_grp_b, client_ig_intr_tm_md.packet_color, client_ig_intr_tm_md.qid, client_ig_intr_tm_md.rid, client_ig_md.agent_changed, client_ig_md.dest2, client_ig_md.is_roce, client_ig_md.lock_agent, client_ig_md.lock_free_mode, client_ig_md.lock_index, client_ig_md.lock_out_of_range, client_ig_md.lock_rw_mode, client_ig_md.pkt_psn, client_inbox_count, client_meta.agent_changed, client_meta.dest2, client_meta.is_roce, client_meta.lock_agent, client_meta.lock_free_mode, client_meta.lock_index, client_meta.lock_out_of_range, client_meta.lock_rw_mode, client_meta.pkt_psn, client_pkt_external, dsl_pump_mode, procurator_phase, procurator_step, sw_IngressPipe_CounterTable_1_counter_table_1.action_run, sw_IngressPipe_CounterTable_1_counter_table_1.hit, sw_IngressPipe_CounterTable_1_notification_cnt_1, sw_IngressPipe_CounterTable_1_notification_cnt_1__last0_old_value, sw_IngressPipe_CounterTable_1_notification_cnt_1__last0_value, sw_IngressPipe_CounterTable_1_notification_cnt_1__last_index, sw_IngressPipe_CounterTable_1_notification_cnt_1__last_old_value, sw_IngressPipe_CounterTable_1_notification_cnt_1__last_value, sw_IngressPipe_CounterTable_1_notification_cnt_1__last_write_site, sw_IngressPipe_CounterTable_1_notification_cnt_1__next_write_site, sw_IngressPipe_CounterTable_1_notification_cnt_1__wrote_any, sw_IngressPipe_CounterTable_1_notification_cnt_1__wrote_index0, sw_IngressPipe_CounterTable_2_counter_table_2.action_run, sw_IngressPipe_CounterTable_2_counter_table_2.hit, sw_IngressPipe_CounterTable_2_notification_cnt_2, sw_IngressPipe_CounterTable_2_notification_cnt_2__last0_old_value, sw_IngressPipe_CounterTable_2_notification_cnt_2__last0_value, sw_IngressPipe_CounterTable_2_notification_cnt_2__last_index, sw_IngressPipe_CounterTable_2_notification_cnt_2__last_old_value, sw_IngressPipe_CounterTable_2_notification_cnt_2__last_value, sw_IngressPipe_CounterTable_2_notification_cnt_2__last_write_site, sw_IngressPipe_CounterTable_2_notification_cnt_2__next_write_site, sw_IngressPipe_CounterTable_2_notification_cnt_2__wrote_any, sw_IngressPipe_CounterTable_2_notification_cnt_2__wrote_index0, sw_IngressPipe_CounterTable_3_counter_table_3.action_run, sw_IngressPipe_CounterTable_3_counter_table_3.hit, sw_IngressPipe_CounterTable_3_notification_cnt_3, sw_IngressPipe_CounterTable_3_notification_cnt_3__last0_old_value, sw_IngressPipe_CounterTable_3_notification_cnt_3__last0_value, sw_IngressPipe_CounterTable_3_notification_cnt_3__last_index, sw_IngressPipe_CounterTable_3_notification_cnt_3__last_old_value, sw_IngressPipe_CounterTable_3_notification_cnt_3__last_value, sw_IngressPipe_CounterTable_3_notification_cnt_3__last_write_site, sw_IngressPipe_CounterTable_3_notification_cnt_3__next_write_site, sw_IngressPipe_CounterTable_3_notification_cnt_3__wrote_any, sw_IngressPipe_CounterTable_3_notification_cnt_3__wrote_index0, sw_IngressPipe_LockOperation_1_lock_agent_array_1, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last0_old_value, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last0_value, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last_index, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last_old_value, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last_value, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last_write_site, sw_IngressPipe_LockOperation_1_lock_agent_array_1__next_write_site, sw_IngressPipe_LockOperation_1_lock_agent_array_1__wrote_any, sw_IngressPipe_LockOperation_1_lock_agent_array_1__wrote_index0, sw_IngressPipe_LockOperation_1_lock_operation_1.action_run, sw_IngressPipe_LockOperation_1_lock_operation_1.hit, sw_IngressPipe_LockOperation_2_lock_agent_array_2, sw_IngressPipe_LockOperation_2_lock_agent_array_2__last0_old_value, sw_IngressPipe_LockOperation_2_lock_agent_array_2__last0_value, sw_IngressPipe_LockOperation_2_lock_agent_array_2__last_index, sw_IngressPipe_LockOperation_2_lock_agent_array_2__last_old_value, sw_IngressPipe_LockOperation_2_lock_agent_array_2__last_value, sw_IngressPipe_LockOperation_2_lock_agent_array_2__last_write_site, sw_IngressPipe_LockOperation_2_lock_agent_array_2__next_write_site, sw_IngressPipe_LockOperation_2_lock_agent_array_2__wrote_any, sw_IngressPipe_LockOperation_2_lock_agent_array_2__wrote_index0, sw_IngressPipe_LockOperation_2_lock_operation_2.action_run, sw_IngressPipe_LockOperation_2_lock_operation_2.hit, sw_IngressPipe_LockOperation_3_lock_agent_array_3, sw_IngressPipe_LockOperation_3_lock_agent_array_3__last0_old_value, sw_IngressPipe_LockOperation_3_lock_agent_array_3__last0_value, sw_IngressPipe_LockOperation_3_lock_agent_array_3__last_index, sw_IngressPipe_LockOperation_3_lock_agent_array_3__last_old_value, sw_IngressPipe_LockOperation_3_lock_agent_array_3__last_value, sw_IngressPipe_LockOperation_3_lock_agent_array_3__last_write_site, sw_IngressPipe_LockOperation_3_lock_agent_array_3__next_write_site, sw_IngressPipe_LockOperation_3_lock_agent_array_3__wrote_any, sw_IngressPipe_LockOperation_3_lock_agent_array_3__wrote_index0, sw_IngressPipe_LockOperation_3_lock_operation_3.action_run, sw_IngressPipe_LockOperation_3_lock_operation_3.hit, sw_IngressPipe_acquire_table.action_run, sw_IngressPipe_acquire_table.hit, sw_IngressPipe_eth_fallback.action_run, sw_IngressPipe_eth_fallback.hit, sw_IngressPipe_lock_free_mode_array, sw_IngressPipe_lock_free_mode_array__last0_old_value, sw_IngressPipe_lock_free_mode_array__last0_value, sw_IngressPipe_lock_free_mode_array__last_index, sw_IngressPipe_lock_free_mode_array__last_old_value, sw_IngressPipe_lock_free_mode_array__last_value, sw_IngressPipe_lock_free_mode_array__last_write_site, sw_IngressPipe_lock_free_mode_array__next_write_site, sw_IngressPipe_lock_free_mode_array__wrote_any, sw_IngressPipe_lock_free_mode_array__wrote_index0, sw_IngressPipe_lock_rw_mode_array, sw_IngressPipe_lock_rw_mode_array__last0_old_value, sw_IngressPipe_lock_rw_mode_array__last0_value, sw_IngressPipe_lock_rw_mode_array__last_index, sw_IngressPipe_lock_rw_mode_array__last_old_value, sw_IngressPipe_lock_rw_mode_array__last_value, sw_IngressPipe_lock_rw_mode_array__last_write_site, sw_IngressPipe_lock_rw_mode_array__next_write_site, sw_IngressPipe_lock_rw_mode_array__wrote_any, sw_IngressPipe_lock_rw_mode_array__wrote_index0, sw_IngressPipe_release_table.action_run, sw_IngressPipe_release_table.hit, sw_IngressPipe_rw_table.action_run, sw_IngressPipe_rw_table.hit, sw___ra_ret_IngressPipe_CounterTable_1_cmp_ncnt, sw___ra_ret_IngressPipe_CounterTable_1_count_ncnt, sw___ra_ret_IngressPipe_CounterTable_1_reset_ncnt, sw___ra_ret_IngressPipe_CounterTable_2_cmp_ncnt, sw___ra_ret_IngressPipe_CounterTable_2_count_ncnt, sw___ra_ret_IngressPipe_CounterTable_2_reset_ncnt, sw___ra_ret_IngressPipe_CounterTable_3_cmp_ncnt, sw___ra_ret_IngressPipe_CounterTable_3_count_ncnt, sw___ra_ret_IngressPipe_CounterTable_3_reset_ncnt, sw___ra_ret_IngressPipe_LockOperation_1_get_lock_agent, sw___ra_ret_IngressPipe_LockOperation_1_set_lock_agent, sw___ra_ret_IngressPipe_LockOperation_2_get_lock_agent, sw___ra_ret_IngressPipe_LockOperation_2_set_lock_agent, sw___ra_ret_IngressPipe_LockOperation_3_get_lock_agent, sw___ra_ret_IngressPipe_LockOperation_3_set_lock_agent, sw___ra_ret_IngressPipe_acquire, sw___ra_ret_IngressPipe_get_mode, sw___ra_ret_IngressPipe_release, sw___ra_ret_IngressPipe_set_excl, sw___ra_ret_IngressPipe_set_shared, sw___ra_val_IngressPipe_CounterTable_1_cmp_ncnt, sw___ra_val_IngressPipe_CounterTable_1_count_ncnt, sw___ra_val_IngressPipe_CounterTable_1_reset_ncnt, sw___ra_val_IngressPipe_CounterTable_2_cmp_ncnt, sw___ra_val_IngressPipe_CounterTable_2_count_ncnt, sw___ra_val_IngressPipe_CounterTable_2_reset_ncnt, sw___ra_val_IngressPipe_CounterTable_3_cmp_ncnt, sw___ra_val_IngressPipe_CounterTable_3_count_ncnt, sw___ra_val_IngressPipe_CounterTable_3_reset_ncnt, sw___ra_val_IngressPipe_LockOperation_1_get_lock_agent, sw___ra_val_IngressPipe_LockOperation_1_set_lock_agent, sw___ra_val_IngressPipe_LockOperation_2_get_lock_agent, sw___ra_val_IngressPipe_LockOperation_2_set_lock_agent, sw___ra_val_IngressPipe_LockOperation_3_get_lock_agent, sw___ra_val_IngressPipe_LockOperation_3_set_lock_agent, sw___ra_val_IngressPipe_acquire, sw___ra_val_IngressPipe_get_mode, sw___ra_val_IngressPipe_release, sw___ra_val_IngressPipe_set_excl, sw___ra_val_IngressPipe_set_shared, sw_drop, sw_eg_intr_md._pad0, sw_eg_intr_md._pad1, sw_eg_intr_md._pad10, sw_eg_intr_md._pad2, sw_eg_intr_md._pad3, sw_eg_intr_md._pad4, sw_eg_intr_md._pad5, sw_eg_intr_md._pad6, sw_eg_intr_md._pad7, sw_eg_intr_md._pad8, sw_eg_intr_md._pad9, sw_eg_intr_md.app_pool_congest_stat, sw_eg_intr_md.deflection_flag, sw_eg_intr_md.deq_congest_stat, sw_eg_intr_md.deq_qdepth, sw_eg_intr_md.deq_timedelta, sw_eg_intr_md.egress_cos, sw_eg_intr_md.egress_qid, sw_eg_intr_md.egress_rid, sw_eg_intr_md.egress_rid_first, sw_eg_intr_md.enq_congest_stat, sw_eg_intr_md.enq_qdepth, sw_eg_intr_md.enq_tstamp, sw_eg_intr_md.pkt_length, sw_eg_intr_md.valid, sw_eg_intr_oport_md.capture_tstamp_on_tx, sw_eg_intr_oport_md.update_delay_on_tx, sw_eg_md.agent_changed, sw_eg_md.dest2, sw_eg_md.is_roce, sw_eg_md.lock_agent, sw_eg_md.lock_free_mode, sw_eg_md.lock_index, sw_eg_md.lock_out_of_range, sw_eg_md.lock_rw_mode, sw_eg_md.pkt_psn, sw_hdr.arp.dst_ip, sw_hdr.arp.dst_mac, sw_hdr.arp.hw_addr_len, sw_hdr.arp.hw_type, sw_hdr.arp.opcode, sw_hdr.arp.proto_addr_len, sw_hdr.arp.proto_type, sw_hdr.arp.src_ip, sw_hdr.arp.src_mac, sw_hdr.arp.valid, sw_hdr.ethernet.dst_mac, sw_hdr.ethernet.l3_proto, sw_hdr.ethernet.src_mac, sw_hdr.ethernet.valid, sw_hdr.ipv4.diffserv, sw_hdr.ipv4.dst_ip, sw_hdr.ipv4.flags, sw_hdr.ipv4.frag_offset, sw_hdr.ipv4.hdr_cksum, sw_hdr.ipv4.ident, sw_hdr.ipv4.ihl, sw_hdr.ipv4.l4_proto, sw_hdr.ipv4.src_ip, sw_hdr.ipv4.total_len, sw_hdr.ipv4.ttl, sw_hdr.ipv4.valid, sw_hdr.ipv4.version, sw_hdr.ipv6.dst_ip, sw_hdr.ipv6.flow_table, sw_hdr.ipv6.hop_limit, sw_hdr.ipv6.next_hdr, sw_hdr.ipv6.payload_len, sw_hdr.ipv6.src_ip, sw_hdr.ipv6.traffic_class, sw_hdr.ipv6.valid, sw_hdr.ipv6.version, sw_hdr.lock.agent, sw_hdr.lock.granted, sw_hdr.lock.id, sw_hdr.lock.machine_id, sw_hdr.lock.mode, sw_hdr.lock.multicasted, sw_hdr.lock.ncnt, sw_hdr.lock.old_mode, sw_hdr.lock.reserved, sw_hdr.lock.task_id, sw_hdr.lock.transferred, sw_hdr.lock.type, sw_hdr.lock.valid, sw_hdr.lock.wq_size, sw_hdr.roce.__reserved, sw_hdr.roce._reserved, sw_hdr.roce._unused, sw_hdr.roce.ack_req, sw_hdr.roce.dest_qp, sw_hdr.roce.opcode, sw_hdr.roce.p_key, sw_hdr.roce.psn, sw_hdr.roce.trans_hdr_ver, sw_hdr.roce.valid, sw_hdr.roce_aeth.msn, sw_hdr.roce_aeth.syndrome, sw_hdr.roce_aeth.valid, sw_hdr.roce_deth._reserved, sw_hdr.roce_deth.qkey, sw_hdr.roce_deth.src_qp, sw_hdr.roce_deth.valid, sw_hdr.roce_reth.length, sw_hdr.roce_reth.rkey, sw_hdr.roce_reth.vaddr, sw_hdr.roce_reth.valid, sw_hdr.udp.checksum, sw_hdr.udp.dst_port, sw_hdr.udp.len, sw_hdr.udp.src_port, sw_hdr.udp.valid, sw_ig_intr_dprs_md.coalesce_flush, sw_ig_intr_dprs_md.coalesce_length, sw_ig_intr_dprs_md.drop_ctl, sw_ig_intr_dprs_md.mirror_type, sw_ig_intr_dprsr_md.digest_type, sw_ig_intr_dprsr_md.drop_ctl, sw_ig_intr_dprsr_md.mirror_type, sw_ig_intr_dprsr_md.resubmit_type, sw_ig_intr_md._pad1, sw_ig_intr_md._pad2, sw_ig_intr_md.ingress_mac_tstamp, sw_ig_intr_md.ingress_port, sw_ig_intr_md.packet_version, sw_ig_intr_md.resubmit_flag, sw_ig_intr_md.valid, sw_ig_intr_prsr_md.global_tstamp, sw_ig_intr_prsr_md.global_ver, sw_ig_intr_prsr_md.parser_err, sw_ig_intr_tm_md.bypass_egress, sw_ig_intr_tm_md.copy_to_cpu, sw_ig_intr_tm_md.deflect_on_drop, sw_ig_intr_tm_md.disable_ucast_cutthru, sw_ig_intr_tm_md.enable_mcast_cutthru, sw_ig_intr_tm_md.icos_for_copy_to_cpu, sw_ig_intr_tm_md.ingress_cos, sw_ig_intr_tm_md.level1_exclusion_id, sw_ig_intr_tm_md.level1_mcast_hash, sw_ig_intr_tm_md.level2_exclusion_id, sw_ig_intr_tm_md.level2_mcast_hash, sw_ig_intr_tm_md.mcast_grp_a, sw_ig_intr_tm_md.mcast_grp_b, sw_ig_intr_tm_md.packet_color, sw_ig_intr_tm_md.qid, sw_ig_intr_tm_md.rid, sw_ig_intr_tm_md.ucast_egress_port, sw_ig_md.agent_changed, sw_ig_md.dest2, sw_ig_md.is_roce, sw_ig_md.lock_agent, sw_ig_md.lock_free_mode, sw_ig_md.lock_index, sw_ig_md.lock_out_of_range, sw_ig_md.lock_rw_mode, sw_ig_md.pkt_psn, sw_inbox_count, sw_isValid, sw_meta.agent_changed, sw_meta.dest2, sw_meta.is_roce, sw_meta.lock_agent, sw_meta.lock_free_mode, sw_meta.lock_index, sw_meta.lock_out_of_range, sw_meta.lock_rw_mode, sw_meta.pkt_psn, sw_p4b_checksum_error, sw_p4b_checksum_updated, sw_p4b_checksum_verified, sw_p4b_clone_e2e, sw_p4b_clone_i2e, sw_p4b_clone_i2i, sw_p4b_digest, sw_p4b_recirculate, sw_pkt_external;
{
  ...
  if (procurator_phase == 0) {
    ...
    if (sw_inbox_count < 1) {
      ...
      havoc client_hdr.ethernet.src_mac;
      havoc client_hdr.ipv4.version;
      havoc client_hdr.ipv4.ihl;
      havoc client_hdr.ipv4.diffserv;
      havoc client_hdr.ipv4.total_len;
      havoc client_hdr.ipv4.ident;
      havoc client_hdr.ipv4.flags;
      havoc client_hdr.ipv4.frag_offset;
      havoc client_hdr.ipv4.ttl;
      havoc client_hdr.ipv4.src_ip;
      havoc client_hdr.ipv4.dst_ip;
      havoc client_hdr.ipv6.valid;
      havoc client_hdr.ipv6.version;
      havoc client_hdr.ipv6.traffic_class;
      havoc client_hdr.ipv6.flow_table;
      havoc client_hdr.ipv6.payload_len;
      havoc client_hdr.ipv6.next_hdr;
      havoc client_hdr.ipv6.hop_limit;
      havoc client_hdr.ipv6.src_ip;
      havoc client_hdr.ipv6.dst_ip;
      havoc client_hdr.arp.valid;
      havoc client_hdr.arp.hw_type;
      havoc client_hdr.arp.proto_type;
      havoc client_hdr.arp.hw_addr_len;
      havoc client_hdr.arp.proto_addr_len;
      havoc client_hdr.arp.opcode;
      havoc client_hdr.arp.src_mac;
      havoc client_hdr.arp.src_ip;
      havoc client_hdr.arp.dst_mac;
      havoc client_hdr.arp.dst_ip;
      havoc client_hdr.udp.src_port;
      havoc client_hdr.udp.len;
      havoc client_hdr.udp.checksum;
      havoc client_hdr.roce.valid;
      havoc client_hdr.roce._unused;
      havoc client_hdr.roce.trans_hdr_ver;
      havoc client_hdr.roce.p_key;
      havoc client_hdr.roce._reserved;
      havoc client_hdr.roce.dest_qp;
      havoc client_hdr.roce.ack_req;
      havoc client_hdr.roce.__reserved;
      havoc client_hdr.roce_reth.valid;
      havoc client_hdr.roce_reth.vaddr;
      havoc client_hdr.roce_reth.rkey;
      havoc client_hdr.roce_reth.length;
      havoc client_hdr.roce_deth.valid;
      havoc client_hdr.roce_deth.qkey;
      havoc client_hdr.roce_deth._reserved;
      havoc client_hdr.roce_deth.src_qp;
      havoc client_hdr.roce_aeth.valid;
      havoc client_hdr.roce_aeth.syndrome;
      havoc client_hdr.roce_aeth.msn;
      havoc client_hdr.lock.type;
      havoc client_hdr.lock.reserved;
      havoc client_ig_md.dest2;
      ...
      havoc client_eg_md.dest2;
      havoc client_eg_md.lock_free_mode;
      havoc client_eg_md.lock_rw_mode;
      havoc client_eg_md.lock_agent;
      havoc client_eg_md.lock_index;
      havoc client_eg_md.agent_changed;
      havoc client_eg_md.lock_out_of_range;
      ...
      havoc client_ig_intr_dprs_md.drop_ctl;
      havoc client_ig_intr_dprs_md.mirror_type;
      havoc client_ig_intr_dprs_md.coalesce_flush;
      havoc client_ig_intr_dprs_md.coalesce_length;
      ...
      havoc client_ig_intr_dprsr_md.mirror_type;
      ...
      havoc client_meta.dest2;
      havoc client_meta.lock_free_mode;
      havoc client_meta.lock_rw_mode;
      havoc client_meta.lock_agent;
      havoc client_meta.lock_index;
      havoc client_meta.agent_changed;
      havoc client_meta.lock_out_of_range;
      havoc client_meta.is_roce;
      havoc client_meta.pkt_psn;
      ...
      sw_hdr.ethernet.src_mac := client_hdr.ethernet.src_mac;
      ...
      sw_hdr.ipv4.total_len := client_hdr.ipv4.total_len;
      sw_hdr.ipv4.ident := client_hdr.ipv4.ident;
      sw_hdr.ipv4.flags := client_hdr.ipv4.flags;
      sw_hdr.ipv4.frag_offset := client_hdr.ipv4.frag_offset;
      ...
      sw_hdr.ipv4.src_ip := client_hdr.ipv4.src_ip;
      sw_hdr.ipv4.dst_ip := client_hdr.ipv4.dst_ip;
      sw_hdr.ipv6.valid := client_hdr.ipv6.valid;
      sw_hdr.ipv6.version := client_hdr.ipv6.version;
      sw_hdr.ipv6.traffic_class := client_hdr.ipv6.traffic_class;
      sw_hdr.ipv6.flow_table := client_hdr.ipv6.flow_table;
      sw_hdr.ipv6.payload_len := client_hdr.ipv6.payload_len;
      sw_hdr.ipv6.next_hdr := client_hdr.ipv6.next_hdr;
      sw_hdr.ipv6.hop_limit := client_hdr.ipv6.hop_limit;
      sw_hdr.ipv6.src_ip := client_hdr.ipv6.src_ip;
      sw_hdr.ipv6.dst_ip := client_hdr.ipv6.dst_ip;
      sw_hdr.arp.valid := client_hdr.arp.valid;
      sw_hdr.arp.hw_type := client_hdr.arp.hw_type;
      sw_hdr.arp.proto_type := client_hdr.arp.proto_type;
      sw_hdr.arp.hw_addr_len := client_hdr.arp.hw_addr_len;
      sw_hdr.arp.proto_addr_len := client_hdr.arp.proto_addr_len;
      sw_hdr.arp.opcode := client_hdr.arp.opcode;
      sw_hdr.arp.src_mac := client_hdr.arp.src_mac;
      sw_hdr.arp.src_ip := client_hdr.arp.src_ip;
      sw_hdr.arp.dst_mac := client_hdr.arp.dst_mac;
      sw_hdr.arp.dst_ip := client_hdr.arp.dst_ip;
      sw_hdr.udp.valid := client_hdr.udp.valid;
      sw_hdr.udp.src_port := client_hdr.udp.src_port;
      sw_hdr.udp.dst_port := client_hdr.udp.dst_port;
      sw_hdr.udp.len := client_hdr.udp.len;
      sw_hdr.udp.checksum := client_hdr.udp.checksum;
      sw_hdr.roce.valid := client_hdr.roce.valid;
      sw_hdr.roce.opcode := client_hdr.roce.opcode;
      sw_hdr.roce._unused := client_hdr.roce._unused;
      sw_hdr.roce.trans_hdr_ver := client_hdr.roce.trans_hdr_ver;
      sw_hdr.roce.p_key := client_hdr.roce.p_key;
      sw_hdr.roce._reserved := client_hdr.roce._reserved;
      sw_hdr.roce.dest_qp := client_hdr.roce.dest_qp;
      sw_hdr.roce.ack_req := client_hdr.roce.ack_req;
      sw_hdr.roce.__reserved := client_hdr.roce.__reserved;
      sw_hdr.roce.psn := client_hdr.roce.psn;
      sw_hdr.roce_reth.valid := client_hdr.roce_reth.valid;
      sw_hdr.roce_reth.vaddr := client_hdr.roce_reth.vaddr;
      sw_hdr.roce_reth.rkey := client_hdr.roce_reth.rkey;
      sw_hdr.roce_reth.length := client_hdr.roce_reth.length;
      sw_hdr.roce_deth.valid := client_hdr.roce_deth.valid;
      sw_hdr.roce_deth.qkey := client_hdr.roce_deth.qkey;
      sw_hdr.roce_deth._reserved := client_hdr.roce_deth._reserved;
      sw_hdr.roce_deth.src_qp := client_hdr.roce_deth.src_qp;
      sw_hdr.roce_aeth.valid := client_hdr.roce_aeth.valid;
      sw_hdr.roce_aeth.syndrome := client_hdr.roce_aeth.syndrome;
      sw_hdr.roce_aeth.msn := client_hdr.roce_aeth.msn;
      ...
      sw_hdr.lock.reserved := client_hdr.lock.reserved;
      ...
      sw_ig_md.dest2 := client_ig_md.dest2;
      ...
      sw_eg_md.dest2 := client_eg_md.dest2;
      sw_eg_md.lock_free_mode := client_eg_md.lock_free_mode;
      sw_eg_md.lock_rw_mode := client_eg_md.lock_rw_mode;
      sw_eg_md.lock_agent := client_eg_md.lock_agent;
      sw_eg_md.lock_index := client_eg_md.lock_index;
      sw_eg_md.agent_changed := client_eg_md.agent_changed;
      sw_eg_md.lock_out_of_range := client_eg_md.lock_out_of_range;
      ...
      sw_ig_intr_dprs_md.drop_ctl := client_ig_intr_dprs_md.drop_ctl;
      sw_ig_intr_dprs_md.mirror_type := client_ig_intr_dprs_md.mirror_type;
      sw_ig_intr_dprs_md.coalesce_flush := client_ig_intr_dprs_md.coalesce_flush;
      sw_ig_intr_dprs_md.coalesce_length := client_ig_intr_dprs_md.coalesce_length;
      ...
      sw_meta.dest2 := client_meta.dest2;
      sw_meta.lock_free_mode := client_meta.lock_free_mode;
      sw_meta.lock_rw_mode := client_meta.lock_rw_mode;
      sw_meta.lock_agent := client_meta.lock_agent;
      sw_meta.lock_index := client_meta.lock_index;
      sw_meta.agent_changed := client_meta.agent_changed;
      sw_meta.lock_out_of_range := client_meta.lock_out_of_range;
      sw_meta.is_roce := client_meta.is_roce;
      sw_meta.pkt_psn := client_meta.pkt_psn;
  ...
  modifies client_eg_intr_md._pad0, client_eg_intr_md._pad1, client_eg_intr_md._pad10, client_eg_intr_md._pad2, client_eg_intr_md._pad3, client_eg_intr_md._pad4, client_eg_intr_md._pad5, client_eg_intr_md._pad6, client_eg_intr_md._pad7, client_eg_intr_md._pad8, client_eg_intr_md._pad9, client_eg_intr_md.app_pool_congest_stat, client_eg_intr_md.deflection_flag, client_eg_intr_md.deq_congest_stat, client_eg_intr_md.deq_qdepth, client_eg_intr_md.deq_timedelta, client_eg_intr_md.egress_cos, client_eg_intr_md.egress_qid, client_eg_intr_md.egress_rid, client_eg_intr_md.egress_rid_first, client_eg_intr_md.enq_congest_stat, client_eg_intr_md.enq_qdepth, client_eg_intr_md.enq_tstamp, client_eg_intr_md.pkt_length, client_eg_intr_md.valid, client_eg_intr_oport_md.capture_tstamp_on_tx, client_eg_intr_oport_md.update_delay_on_tx, client_eg_md.agent_changed, client_eg_md.dest2, client_eg_md.is_roce, client_eg_md.lock_agent, client_eg_md.lock_free_mode, client_eg_md.lock_index, client_eg_md.lock_out_of_range, client_eg_md.lock_rw_mode, client_eg_md.pkt_psn, client_hdr.arp.dst_ip, client_hdr.arp.dst_mac, client_hdr.arp.hw_addr_len, client_hdr.arp.hw_type, client_hdr.arp.opcode, client_hdr.arp.proto_addr_len, client_hdr.arp.proto_type, client_hdr.arp.src_ip, client_hdr.arp.src_mac, client_hdr.arp.valid, client_hdr.ethernet.dst_mac, client_hdr.ethernet.l3_proto, client_hdr.ethernet.src_mac, client_hdr.ethernet.valid, client_hdr.ipv4.diffserv, client_hdr.ipv4.dst_ip, client_hdr.ipv4.flags, client_hdr.ipv4.frag_offset, client_hdr.ipv4.hdr_cksum, client_hdr.ipv4.ident, client_hdr.ipv4.ihl, client_hdr.ipv4.l4_proto, client_hdr.ipv4.src_ip, client_hdr.ipv4.total_len, client_hdr.ipv4.ttl, client_hdr.ipv4.valid, client_hdr.ipv4.version, client_hdr.ipv6.dst_ip, client_hdr.ipv6.flow_table, client_hdr.ipv6.hop_limit, client_hdr.ipv6.next_hdr, client_hdr.ipv6.payload_len, client_hdr.ipv6.src_ip, client_hdr.ipv6.traffic_class, client_hdr.ipv6.valid, client_hdr.ipv6.version, client_hdr.lock.agent, client_hdr.lock.granted, client_hdr.lock.id, client_hdr.lock.machine_id, client_hdr.lock.mode, client_hdr.lock.multicasted, client_hdr.lock.ncnt, client_hdr.lock.old_mode, client_hdr.lock.reserved, client_hdr.lock.task_id, client_hdr.lock.transferred, client_hdr.lock.type, client_hdr.lock.valid, client_hdr.lock.wq_size, client_hdr.roce.__reserved, client_hdr.roce._reserved, client_hdr.roce._unused, client_hdr.roce.ack_req, client_hdr.roce.dest_qp, client_hdr.roce.opcode, client_hdr.roce.p_key, client_hdr.roce.psn, client_hdr.roce.trans_hdr_ver, client_hdr.roce.valid, client_hdr.roce_aeth.msn, client_hdr.roce_aeth.syndrome, client_hdr.roce_aeth.valid, client_hdr.roce_deth._reserved, client_hdr.roce_deth.qkey, client_hdr.roce_deth.src_qp, client_hdr.roce_deth.valid, client_hdr.roce_reth.length, client_hdr.roce_reth.rkey, client_hdr.roce_reth.vaddr, client_hdr.roce_reth.valid, client_hdr.udp.checksum, client_hdr.udp.dst_port, client_hdr.udp.len, client_hdr.udp.src_port, client_hdr.udp.valid, client_ig_intr_dprs_md.coalesce_flush, client_ig_intr_dprs_md.coalesce_length, client_ig_intr_dprs_md.drop_ctl, client_ig_intr_dprs_md.mirror_type, client_ig_intr_dprsr_md.digest_type, client_ig_intr_dprsr_md.drop_ctl, client_ig_intr_dprsr_md.mirror_type, client_ig_intr_dprsr_md.resubmit_type, client_ig_intr_md._pad1, client_ig_intr_md._pad2, client_ig_intr_md.ingress_mac_tstamp, client_ig_intr_md.ingress_port, client_ig_intr_md.packet_version, client_ig_intr_md.resubmit_flag, client_ig_intr_md.valid, client_ig_intr_prsr_md.global_tstamp, client_ig_intr_prsr_md.global_ver, client_ig_intr_prsr_md.parser_err, client_ig_intr_tm_md.bypass_egress, client_ig_intr_tm_md.copy_to_cpu, client_ig_intr_tm_md.deflect_on_drop, client_ig_intr_tm_md.disable_ucast_cutthru, client_ig_intr_tm_md.enable_mcast_cutthru, client_ig_intr_tm_md.icos_for_copy_to_cpu, client_ig_intr_tm_md.ingress_cos, client_ig_intr_tm_md.level1_exclusion_id, client_ig_intr_tm_md.level1_mcast_hash, client_ig_intr_tm_md.level2_exclusion_id, client_ig_intr_tm_md.level2_mcast_hash, client_ig_intr_tm_md.mcast_grp_a, client_ig_intr_tm_md.mcast_grp_b, client_ig_intr_tm_md.packet_color, client_ig_intr_tm_md.qid, client_ig_intr_tm_md.rid, client_ig_md.agent_changed, client_ig_md.dest2, client_ig_md.is_roce, client_ig_md.lock_agent, client_ig_md.lock_free_mode, client_ig_md.lock_index, client_ig_md.lock_out_of_range, client_ig_md.lock_rw_mode, client_ig_md.pkt_psn, client_inbox_count, client_meta.agent_changed, client_meta.dest2, client_meta.is_roce, client_meta.lock_agent, client_meta.lock_free_mode, client_meta.lock_index, client_meta.lock_out_of_range, client_meta.lock_rw_mode, client_meta.pkt_psn, client_pkt_external, dsl_pump_mode, procurator_phase, procurator_step, sw_IngressPipe_CounterTable_1_counter_table_1.action_run, sw_IngressPipe_CounterTable_1_counter_table_1.hit, sw_IngressPipe_CounterTable_1_notification_cnt_1, sw_IngressPipe_CounterTable_1_notification_cnt_1__last0_old_value, sw_IngressPipe_CounterTable_1_notification_cnt_1__last0_value, sw_IngressPipe_CounterTable_1_notification_cnt_1__last_index, sw_IngressPipe_CounterTable_1_notification_cnt_1__last_old_value, sw_IngressPipe_CounterTable_1_notification_cnt_1__last_value, sw_IngressPipe_CounterTable_1_notification_cnt_1__last_write_site, sw_IngressPipe_CounterTable_1_notification_cnt_1__next_write_site, sw_IngressPipe_CounterTable_1_notification_cnt_1__wrote_any, sw_IngressPipe_CounterTable_1_notification_cnt_1__wrote_index0, sw_IngressPipe_CounterTable_2_counter_table_2.action_run, sw_IngressPipe_CounterTable_2_counter_table_2.hit, sw_IngressPipe_CounterTable_2_notification_cnt_2, sw_IngressPipe_CounterTable_2_notification_cnt_2__last0_old_value, sw_IngressPipe_CounterTable_2_notification_cnt_2__last0_value, sw_IngressPipe_CounterTable_2_notification_cnt_2__last_index, sw_IngressPipe_CounterTable_2_notification_cnt_2__last_old_value, sw_IngressPipe_CounterTable_2_notification_cnt_2__last_value, sw_IngressPipe_CounterTable_2_notification_cnt_2__last_write_site, sw_IngressPipe_CounterTable_2_notification_cnt_2__next_write_site, sw_IngressPipe_CounterTable_2_notification_cnt_2__wrote_any, sw_IngressPipe_CounterTable_2_notification_cnt_2__wrote_index0, sw_IngressPipe_CounterTable_3_counter_table_3.action_run, sw_IngressPipe_CounterTable_3_counter_table_3.hit, sw_IngressPipe_CounterTable_3_notification_cnt_3, sw_IngressPipe_CounterTable_3_notification_cnt_3__last0_old_value, sw_IngressPipe_CounterTable_3_notification_cnt_3__last0_value, sw_IngressPipe_CounterTable_3_notification_cnt_3__last_index, sw_IngressPipe_CounterTable_3_notification_cnt_3__last_old_value, sw_IngressPipe_CounterTable_3_notification_cnt_3__last_value, sw_IngressPipe_CounterTable_3_notification_cnt_3__last_write_site, sw_IngressPipe_CounterTable_3_notification_cnt_3__next_write_site, sw_IngressPipe_CounterTable_3_notification_cnt_3__wrote_any, sw_IngressPipe_CounterTable_3_notification_cnt_3__wrote_index0, sw_IngressPipe_LockOperation_1_lock_agent_array_1, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last0_old_value, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last0_value, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last_index, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last_old_value, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last_value, sw_IngressPipe_LockOperation_1_lock_agent_array_1__last_write_site, sw_IngressPipe_LockOperation_1_lock_agent_array_1__next_write_site, sw_IngressPipe_LockOperation_1_lock_agent_array_1__wrote_any, sw_IngressPipe_LockOperation_1_lock_agent_array_1__wrote_index0, sw_IngressPipe_LockOperation_1_lock_operation_1.action_run, sw_IngressPipe_LockOperation_1_lock_operation_1.hit, sw_IngressPipe_LockOperation_2_lock_agent_array_2, sw_IngressPipe_LockOperation_2_lock_agent_array_2__last0_old_value, sw_IngressPipe_LockOperation_2_lock_agent_array_2__last0_value, sw_IngressPipe_LockOperation_2_lock_agent_array_2__last_index, sw_IngressPipe_LockOperation_2_lock_agent_array_2__last_old_value, sw_IngressPipe_LockOperation_2_lock_agent_array_2__last_value, sw_IngressPipe_LockOperation_2_lock_agent_array_2__last_write_site, sw_IngressPipe_LockOperation_2_lock_agent_array_2__next_write_site, sw_IngressPipe_LockOperation_2_lock_agent_array_2__wrote_any, sw_IngressPipe_LockOperation_2_lock_agent_array_2__wrote_index0, sw_IngressPipe_LockOperation_2_lock_operation_2.action_run, sw_IngressPipe_LockOperation_2_lock_operation_2.hit, sw_IngressPipe_LockOperation_3_lock_agent_array_3, sw_IngressPipe_LockOperation_3_lock_agent_array_3__last0_old_value, sw_IngressPipe_LockOperation_3_lock_agent_array_3__last0_value, sw_IngressPipe_LockOperation_3_lock_agent_array_3__last_index, sw_IngressPipe_LockOperation_3_lock_agent_array_3__last_old_value, sw_IngressPipe_LockOperation_3_lock_agent_array_3__last_value, sw_IngressPipe_LockOperation_3_lock_agent_array_3__last_write_site, sw_IngressPipe_LockOperation_3_lock_agent_array_3__next_write_site, sw_IngressPipe_LockOperation_3_lock_agent_array_3__wrote_any, sw_IngressPipe_LockOperation_3_lock_agent_array_3__wrote_index0, sw_IngressPipe_LockOperation_3_lock_operation_3.action_run, sw_IngressPipe_LockOperation_3_lock_operation_3.hit, sw_IngressPipe_acquire_table.action_run, sw_IngressPipe_acquire_table.hit, sw_IngressPipe_eth_fallback.action_run, sw_IngressPipe_eth_fallback.hit, sw_IngressPipe_lock_free_mode_array, sw_IngressPipe_lock_free_mode_array__last0_old_value, sw_IngressPipe_lock_free_mode_array__last0_value, sw_IngressPipe_lock_free_mode_array__last_index, sw_IngressPipe_lock_free_mode_array__last_old_value, sw_IngressPipe_lock_free_mode_array__last_value, sw_IngressPipe_lock_free_mode_array__last_write_site, sw_IngressPipe_lock_free_mode_array__next_write_site, sw_IngressPipe_lock_free_mode_array__wrote_any, sw_IngressPipe_lock_free_mode_array__wrote_index0, sw_IngressPipe_lock_rw_mode_array, sw_IngressPipe_lock_rw_mode_array__last0_old_value, sw_IngressPipe_lock_rw_mode_array__last0_value, sw_IngressPipe_lock_rw_mode_array__last_index, sw_IngressPipe_lock_rw_mode_array__last_old_value, sw_IngressPipe_lock_rw_mode_array__last_value, sw_IngressPipe_lock_rw_mode_array__last_write_site, sw_IngressPipe_lock_rw_mode_array__next_write_site, sw_IngressPipe_lock_rw_mode_array__wrote_any, sw_IngressPipe_lock_rw_mode_array__wrote_index0, sw_IngressPipe_release_table.action_run, sw_IngressPipe_release_table.hit, sw_IngressPipe_rw_table.action_run, sw_IngressPipe_rw_table.hit, sw___ra_ret_IngressPipe_CounterTable_1_cmp_ncnt, sw___ra_ret_IngressPipe_CounterTable_1_count_ncnt, sw___ra_ret_IngressPipe_CounterTable_1_reset_ncnt, sw___ra_ret_IngressPipe_CounterTable_2_cmp_ncnt, sw___ra_ret_IngressPipe_CounterTable_2_count_ncnt, sw___ra_ret_IngressPipe_CounterTable_2_reset_ncnt, sw___ra_ret_IngressPipe_CounterTable_3_cmp_ncnt, sw___ra_ret_IngressPipe_CounterTable_3_count_ncnt, sw___ra_ret_IngressPipe_CounterTable_3_reset_ncnt, sw___ra_ret_IngressPipe_LockOperation_1_get_lock_agent, sw___ra_ret_IngressPipe_LockOperation_1_set_lock_agent, sw___ra_ret_IngressPipe_LockOperation_2_get_lock_agent, sw___ra_ret_IngressPipe_LockOperation_2_set_lock_agent, sw___ra_ret_IngressPipe_LockOperation_3_get_lock_agent, sw___ra_ret_IngressPipe_LockOperation_3_set_lock_agent, sw___ra_ret_IngressPipe_acquire, sw___ra_ret_IngressPipe_get_mode, sw___ra_ret_IngressPipe_release, sw___ra_ret_IngressPipe_set_excl, sw___ra_ret_IngressPipe_set_shared, sw___ra_val_IngressPipe_CounterTable_1_cmp_ncnt, sw___ra_val_IngressPipe_CounterTable_1_count_ncnt, sw___ra_val_IngressPipe_CounterTable_1_reset_ncnt, sw___ra_val_IngressPipe_CounterTable_2_cmp_ncnt, sw___ra_val_IngressPipe_CounterTable_2_count_ncnt, sw___ra_val_IngressPipe_CounterTable_2_reset_ncnt, sw___ra_val_IngressPipe_CounterTable_3_cmp_ncnt, sw___ra_val_IngressPipe_CounterTable_3_count_ncnt, sw___ra_val_IngressPipe_CounterTable_3_reset_ncnt, sw___ra_val_IngressPipe_LockOperation_1_get_lock_agent, sw___ra_val_IngressPipe_LockOperation_1_set_lock_agent, sw___ra_val_IngressPipe_LockOperation_2_get_lock_agent, sw___ra_val_IngressPipe_LockOperation_2_set_lock_agent, sw___ra_val_IngressPipe_LockOperation_3_get_lock_agent, sw___ra_val_IngressPipe_LockOperation_3_set_lock_agent, sw___ra_val_IngressPipe_acquire, sw___ra_val_IngressPipe_get_mode, sw___ra_val_IngressPipe_release, sw___ra_val_IngressPipe_set_excl, sw___ra_val_IngressPipe_set_shared, sw_drop, sw_eg_intr_md._pad0, sw_eg_intr_md._pad1, sw_eg_intr_md._pad10, sw_eg_intr_md._pad2, sw_eg_intr_md._pad3, sw_eg_intr_md._pad4, sw_eg_intr_md._pad5, sw_eg_intr_md._pad6, sw_eg_intr_md._pad7, sw_eg_intr_md._pad8, sw_eg_intr_md._pad9, sw_eg_intr_md.app_pool_congest_stat, sw_eg_intr_md.deflection_flag, sw_eg_intr_md.deq_congest_stat, sw_eg_intr_md.deq_qdepth, sw_eg_intr_md.deq_timedelta, sw_eg_intr_md.egress_cos, sw_eg_intr_md.egress_qid, sw_eg_intr_md.egress_rid, sw_eg_intr_md.egress_rid_first, sw_eg_intr_md.enq_congest_stat, sw_eg_intr_md.enq_qdepth, sw_eg_intr_md.enq_tstamp, sw_eg_intr_md.pkt_length, sw_eg_intr_md.valid, sw_eg_intr_oport_md.capture_tstamp_on_tx, sw_eg_intr_oport_md.update_delay_on_tx, sw_eg_md.agent_changed, sw_eg_md.dest2, sw_eg_md.is_roce, sw_eg_md.lock_agent, sw_eg_md.lock_free_mode, sw_eg_md.lock_index, sw_eg_md.lock_out_of_range, sw_eg_md.lock_rw_mode, sw_eg_md.pkt_psn, sw_hdr.arp.dst_ip, sw_hdr.arp.dst_mac, sw_hdr.arp.hw_addr_len, sw_hdr.arp.hw_type, sw_hdr.arp.opcode, sw_hdr.arp.proto_addr_len, sw_hdr.arp.proto_type, sw_hdr.arp.src_ip, sw_hdr.arp.src_mac, sw_hdr.arp.valid, sw_hdr.ethernet.dst_mac, sw_hdr.ethernet.l3_proto, sw_hdr.ethernet.src_mac, sw_hdr.ethernet.valid, sw_hdr.ipv4.diffserv, sw_hdr.ipv4.dst_ip, sw_hdr.ipv4.flags, sw_hdr.ipv4.frag_offset, sw_hdr.ipv4.hdr_cksum, sw_hdr.ipv4.ident, sw_hdr.ipv4.ihl, sw_hdr.ipv4.l4_proto, sw_hdr.ipv4.src_ip, sw_hdr.ipv4.total_len, sw_hdr.ipv4.ttl, sw_hdr.ipv4.valid, sw_hdr.ipv4.version, sw_hdr.ipv6.dst_ip, sw_hdr.ipv6.flow_table, sw_hdr.ipv6.hop_limit, sw_hdr.ipv6.next_hdr, sw_hdr.ipv6.payload_len, sw_hdr.ipv6.src_ip, sw_hdr.ipv6.traffic_class, sw_hdr.ipv6.valid, sw_hdr.ipv6.version, sw_hdr.lock.agent, sw_hdr.lock.granted, sw_hdr.lock.id, sw_hdr.lock.machine_id, sw_hdr.lock.mode, sw_hdr.lock.multicasted, sw_hdr.lock.ncnt, sw_hdr.lock.old_mode, sw_hdr.lock.reserved, sw_hdr.lock.task_id, sw_hdr.lock.transferred, sw_hdr.lock.type, sw_hdr.lock.valid, sw_hdr.lock.wq_size, sw_hdr.roce.__reserved, sw_hdr.roce._reserved, sw_hdr.roce._unused, sw_hdr.roce.ack_req, sw_hdr.roce.dest_qp, sw_hdr.roce.opcode, sw_hdr.roce.p_key, sw_hdr.roce.psn, sw_hdr.roce.trans_hdr_ver, sw_hdr.roce.valid, sw_hdr.roce_aeth.msn, sw_hdr.roce_aeth.syndrome, sw_hdr.roce_aeth.valid, sw_hdr.roce_deth._reserved, sw_hdr.roce_deth.qkey, sw_hdr.roce_deth.src_qp, sw_hdr.roce_deth.valid, sw_hdr.roce_reth.length, sw_hdr.roce_reth.rkey, sw_hdr.roce_reth.vaddr, sw_hdr.roce_reth.valid, sw_hdr.udp.checksum, sw_hdr.udp.dst_port, sw_hdr.udp.len, sw_hdr.udp.src_port, sw_hdr.udp.valid, sw_ig_intr_dprs_md.coalesce_flush, sw_ig_intr_dprs_md.coalesce_length, sw_ig_intr_dprs_md.drop_ctl, sw_ig_intr_dprs_md.mirror_type, sw_ig_intr_dprsr_md.digest_type, sw_ig_intr_dprsr_md.drop_ctl, sw_ig_intr_dprsr_md.mirror_type, sw_ig_intr_dprsr_md.resubmit_type, sw_ig_intr_md._pad1, sw_ig_intr_md._pad2, sw_ig_intr_md.ingress_mac_tstamp, sw_ig_intr_md.ingress_port, sw_ig_intr_md.packet_version, sw_ig_intr_md.resubmit_flag, sw_ig_intr_md.valid, sw_ig_intr_prsr_md.global_tstamp, sw_ig_intr_prsr_md.global_ver, sw_ig_intr_prsr_md.parser_err, sw_ig_intr_tm_md.bypass_egress, sw_ig_intr_tm_md.copy_to_cpu, sw_ig_intr_tm_md.deflect_on_drop, sw_ig_intr_tm_md.disable_ucast_cutthru, sw_ig_intr_tm_md.enable_mcast_cutthru, sw_ig_intr_tm_md.icos_for_copy_to_cpu, sw_ig_intr_tm_md.ingress_cos, sw_ig_intr_tm_md.level1_exclusion_id, sw_ig_intr_tm_md.level1_mcast_hash, sw_ig_intr_tm_md.level2_exclusion_id, sw_ig_intr_tm_md.level2_mcast_hash, sw_ig_intr_tm_md.mcast_grp_a, sw_ig_intr_tm_md.mcast_grp_b, sw_ig_intr_tm_md.packet_color, sw_ig_intr_tm_md.qid, sw_ig_intr_tm_md.rid, sw_ig_intr_tm_md.ucast_egress_port, sw_ig_md.agent_changed, sw_ig_md.dest2, sw_ig_md.is_roce, sw_ig_md.lock_agent, sw_ig_md.lock_free_mode, sw_ig_md.lock_index, sw_ig_md.lock_out_of_range, sw_ig_md.lock_rw_mode, sw_ig_md.pkt_psn, sw_inbox_count, sw_isValid, sw_meta.agent_changed, sw_meta.dest2, sw_meta.is_roce, sw_meta.lock_agent, sw_meta.lock_free_mode, sw_meta.lock_index, sw_meta.lock_out_of_range, sw_meta.lock_rw_mode, sw_meta.pkt_psn, sw_p4b_checksum_error, sw_p4b_checksum_updated, sw_p4b_checksum_verified, sw_p4b_clone_e2e, sw_p4b_clone_i2e, sw_p4b_clone_i2i, sw_p4b_digest, sw_p4b_recirculate, sw_pkt_external;
{
  ...
  var wrap_closure_seq0: bv8;
  var wrap_closure_after_sw_IngressPipe_CounterTable_1_notification_cnt_1: bv8;
  var wrap_closure_snap_client_inbox_count: int;
  var wrap_closure_snap_procurator_phase: int;
  var wrap_closure_snap_sw_inbox_count: int;
  ...
  assume bvule.bv8(wrap_closure_seq0, 254bv8);
  sw_IngressPipe_CounterTable_1_notification_cnt_1[0bv32] := wrap_closure_seq0;

  sw_IngressPipe_CounterTable_1_notification_cnt_1__last_index := 0bv32;

  sw_IngressPipe_CounterTable_1_notification_cnt_1__last_value := wrap_closure_seq0;
  ...
  if (0bv32 == 0bv32) {
    ...
    sw_IngressPipe_CounterTable_1_notification_cnt_1__last0_value := wrap_closure_seq0;

  }
  dsl_pump_mode := true;
  assume((procurator_phase == 0));
  wrap_closure_snap_client_inbox_count := client_inbox_count;
  wrap_closure_snap_procurator_phase := procurator_phase;
  wrap_closure_snap_sw_inbox_count := sw_inbox_count;
  ...
  wrap_closure_after_sw_IngressPipe_CounterTable_1_notification_cnt_1 := sw_IngressPipe_CounterTable_1_notification_cnt_1__last0_value;
  call __wraparound_closure_assert_all((client_inbox_count == wrap_closure_snap_client_inbox_count) && (procurator_phase == wrap_closure_snap_procurator_phase) && (sw_inbox_count == wrap_closure_snap_sw_inbox_count) && (wrap_closure_after_sw_IngressPipe_CounterTable_1_notification_cnt_1 == add.bv8(wrap_closure_seq0, 1bv8)) && ((procurator_phase == 0)));
