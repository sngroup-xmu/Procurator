...
procedure {:inline 1} s1_MyIngress()
	modifies s1_count, s1_count__last0_old_value, s1_count__last0_value, s1_count__last_index, s1_count__last_old_value, s1_count__last_value, s1_count__last_write_site, s1_count__next_write_site, s1_count__wrote_any, s1_count__wrote_index0, s1_forward, s1_hdr.ethernet.dstAddr, s1_hdr.ipv4_tunnel.diffserv, s1_hdr.ipv4_tunnel.dstAddr, s1_hdr.ipv4_tunnel.flags, s1_hdr.ipv4_tunnel.fragOffset, s1_hdr.ipv4_tunnel.identification, s1_hdr.ipv4_tunnel.ihl, s1_hdr.ipv4_tunnel.protocol, s1_hdr.ipv4_tunnel.srcAddr, s1_hdr.ipv4_tunnel.totalLen, s1_hdr.ipv4_tunnel.ttl, s1_hdr.ipv4_tunnel.version, s1_hdr.udp_tunnel.checksum, s1_hdr.udp_tunnel.dstport, s1_hdr.udp_tunnel.srcport, s1_hdr.udp_tunnel.userlength, s1_isValid, s1_standard_metadata.egress_port, s1_standard_metadata.egress_spec, s1_temp_0;
{
havoc s1_temp_0;
...
procedure {:inline 1} s1_main()
	modifies s1_count, s1_count__last0_old_value, s1_count__last0_value, s1_count__last_index, s1_count__last_old_value, s1_count__last_value, s1_count__last_write_site, s1_count__next_write_site, s1_count__wrote_any, s1_count__wrote_index0, s1_drop, s1_forward, s1_hdr.ethernet.dstAddr, s1_hdr.ipv4_tunnel.diffserv, s1_hdr.ipv4_tunnel.dstAddr, s1_hdr.ipv4_tunnel.flags, s1_hdr.ipv4_tunnel.fragOffset, s1_hdr.ipv4_tunnel.identification, s1_hdr.ipv4_tunnel.ihl, s1_hdr.ipv4_tunnel.protocol, s1_hdr.ipv4_tunnel.srcAddr, s1_hdr.ipv4_tunnel.totalLen, s1_hdr.ipv4_tunnel.ttl, s1_hdr.ipv4_tunnel.version, s1_hdr.udp_tunnel.checksum, s1_hdr.udp_tunnel.dstport, s1_hdr.udp_tunnel.srcport, s1_hdr.udp_tunnel.userlength, s1_isValid, s1_standard_metadata.egress_port, s1_standard_metadata.egress_spec, s1_temp_0;
{
    call s1_MyParser();
...
procedure s1_mainProcedure()
	modifies s1_count, s1_count__last0_old_value, s1_count__last0_value, s1_count__last_index, s1_count__last_old_value, s1_count__last_value, s1_count__last_write_site, s1_count__next_write_site, s1_count__wrote_any, s1_count__wrote_index0, s1_drop, s1_forward, s1_hdr.ethernet.dstAddr, s1_hdr.ipv4_tunnel.diffserv, s1_hdr.ipv4_tunnel.dstAddr, s1_hdr.ipv4_tunnel.flags, s1_hdr.ipv4_tunnel.fragOffset, s1_hdr.ipv4_tunnel.identification, s1_hdr.ipv4_tunnel.ihl, s1_hdr.ipv4_tunnel.protocol, s1_hdr.ipv4_tunnel.srcAddr, s1_hdr.ipv4_tunnel.totalLen, s1_hdr.ipv4_tunnel.ttl, s1_hdr.ipv4_tunnel.version, s1_hdr.udp_tunnel.checksum, s1_hdr.udp_tunnel.dstport, s1_hdr.udp_tunnel.srcport, s1_hdr.udp_tunnel.userlength, s1_isValid, s1_p4b_checksum_error, s1_p4b_checksum_updated, s1_p4b_checksum_verified, s1_p4b_clone_e2e, s1_p4b_clone_i2e, s1_p4b_clone_i2i, s1_p4b_digest, s1_p4b_recirculate, s1_standard_metadata.egress_port, s1_standard_metadata.egress_spec, s1_temp_0;
{
  ...
  modifies procurator_bad, procurator_step, s1_count, s1_count__dbg0, s1_count__last0_old_value, s1_count__last0_old_value__dbg, s1_count__last0_value, s1_count__last0_value__dbg, s1_count__last_index, s1_count__last_index__dbg, s1_count__last_old_value, s1_count__last_old_value__dbg, s1_count__last_value, s1_count__last_value__dbg, s1_count__last_write_site, s1_count__next_write_site, s1_count__wrote_any, s1_count__wrote_any__dbg, s1_count__wrote_index0, s1_count__wrote_index0__dbg, s1_drop, s1_forward, s1_hdr.ethernet.dstAddr, s1_hdr.ethernet.etherType, s1_hdr.ethernet.srcAddr, s1_hdr.ethernet.valid, s1_hdr.ipv4.diffserv, s1_hdr.ipv4.dstAddr, s1_hdr.ipv4.flags, s1_hdr.ipv4.fragOffset, s1_hdr.ipv4.identification, s1_hdr.ipv4.protocol, s1_hdr.ipv4.srcAddr, s1_hdr.ipv4.totalLen, s1_hdr.ipv4.ttl, s1_hdr.ipv4.valid, s1_hdr.ipv4.version, s1_hdr.ipv4_tunnel.diffserv, s1_hdr.ipv4_tunnel.dstAddr, s1_hdr.ipv4_tunnel.flags, s1_hdr.ipv4_tunnel.fragOffset, s1_hdr.ipv4_tunnel.identification, s1_hdr.ipv4_tunnel.ihl, s1_hdr.ipv4_tunnel.protocol, s1_hdr.ipv4_tunnel.srcAddr, s1_hdr.ipv4_tunnel.totalLen, s1_hdr.ipv4_tunnel.ttl, s1_hdr.ipv4_tunnel.version, s1_hdr.ipv6.nextheader, s1_hdr.tcp.valid, s1_hdr.udp_tunnel.checksum, s1_hdr.udp_tunnel.dstport, s1_hdr.udp_tunnel.srcport, s1_hdr.udp_tunnel.userlength, s1_inbox_count, s1_isValid, s1_p4b_checksum_error, s1_p4b_checksum_updated, s1_p4b_checksum_verified, s1_p4b_clone_e2e, s1_p4b_clone_i2e, s1_p4b_clone_i2i, s1_p4b_digest, s1_p4b_recirculate, s1_pkt_external, s1_standard_metadata.egress_port, s1_standard_metadata.egress_spec, s1_standard_metadata.ingress_port, s1_temp_0;
{
  ...
  assume (s1_hdr.ipv4.srcAddr == 16843009bv32);
  ...
  if (!(((s1_standard_metadata.ingress_port != 0bv9) || (s1_standard_metadata.egress_spec != 2bv9) || (s1_hdr.ipv4_tunnel.srcAddr != s1_hdr.ipv4.srcAddr)))) { procurator_bad := true; }
  }
  procurator_step := procurator_step + 1;
