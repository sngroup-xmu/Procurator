...
axiom s1_appID_and_Seq.size == 1bv32;
...
procedure {:inline 1} s1_MyIngress()
	modifies s1_appID_and_Seq, s1_appID_and_Seq__last0_old_value, s1_appID_and_Seq__last0_value, s1_appID_and_Seq__last_index, s1_appID_and_Seq__last_old_value, s1_appID_and_Seq__last_value, s1_appID_and_Seq__last_write_site, s1_appID_and_Seq__next_write_site, s1_appID_and_Seq__wrote_any, s1_appID_and_Seq__wrote_index0, s1_bitmap, s1_bitmap__last0_old_value, s1_bitmap__last0_value, s1_bitmap__last_index, s1_bitmap__last_old_value, s1_bitmap__last_value, s1_bitmap__last_write_site, s1_bitmap__next_write_site, s1_bitmap__wrote_any, s1_bitmap__wrote_index0, s1_meta.isMyAppIDandMyCurrentSeq, s1_meta.read_reg_appID_and_Seq, s1_meta.read_reg_bitmap, s1_meta.tmp_reg_bitmap;
{
    if(s1_isValid[s1_hdr.p4ml]){
        if((s1_hdr.p4ml.isACK == 1bv1)){
            if(((s1_hdr.p4ml.overflow == 1bv1)) && ((s1_hdr.p4ml.isResend == 0bv1))){
                ...
                // s1_read
                                assume (0bv16++s1_hdr.p4ml_agtr_index.agtr == 0bv32);
...
procedure s1_mainProcedure()
	modifies s1_appID_and_Seq, s1_appID_and_Seq__last0_old_value, s1_appID_and_Seq__last0_value, s1_appID_and_Seq__last_index, s1_appID_and_Seq__last_old_value, s1_appID_and_Seq__last_value, s1_appID_and_Seq__last_write_site, s1_appID_and_Seq__next_write_site, s1_appID_and_Seq__wrote_any, s1_appID_and_Seq__wrote_index0, s1_bitmap, s1_bitmap__last0_old_value, s1_bitmap__last0_value, s1_bitmap__last_index, s1_bitmap__last_old_value, s1_bitmap__last_value, s1_bitmap__last_write_site, s1_bitmap__next_write_site, s1_bitmap__wrote_any, s1_bitmap__wrote_index0, s1_drop, s1_isValid, s1_meta.isMyAppIDandMyCurrentSeq, s1_meta.read_reg_appID_and_Seq, s1_meta.read_reg_bitmap, s1_meta.tmp_reg_bitmap, s1_p4b_checksum_error, s1_p4b_checksum_updated, s1_p4b_checksum_verified, s1_p4b_clone_e2e, s1_p4b_clone_i2e, s1_p4b_clone_i2i, s1_p4b_digest, s1_p4b_recirculate;
{
...
procedure mainProcedure() returns()
  modifies dsl_phase, io_hdr.ethernet.ether_type, io_hdr.ethernet.valid, io_hdr.ipv4.valid, io_hdr.p4ml.ECN, io_hdr.p4ml.PSIndex, io_hdr.p4ml.agtr_time, io_hdr.p4ml.appIDandSeqNum, io_hdr.p4ml.bitmap, io_hdr.p4ml.dataIndex, io_hdr.p4ml.isACK, io_hdr.p4ml.isResend, io_hdr.p4ml.isSWCollision, io_hdr.p4ml.overflow, io_hdr.p4ml.valid, io_hdr.p4ml_agtr_index.agtr, io_hdr.p4ml_agtr_index.valid, io_hdr.p4ml_entries.data0, io_hdr.p4ml_entries.data1, io_hdr.p4ml_entries.data2, io_hdr.p4ml_entries.data3, io_hdr.p4ml_entries.valid, io_hdr.udp.dst_port, io_hdr.udp.valid, io_inbox_count, io_meta.isMyAppIDandMyCurrentSeq, io_meta.read_reg_appID_and_Seq, io_meta.read_reg_bitmap, io_meta.tmp_reg_bitmap, io_pkt_external, procurator_bad, procurator_step, s1_appID_and_Seq, s1_appID_and_Seq__dbg0, s1_appID_and_Seq__last0_old_value, s1_appID_and_Seq__last0_old_value__dbg, s1_appID_and_Seq__last0_value, s1_appID_and_Seq__last0_value__dbg, s1_appID_and_Seq__last_index, s1_appID_and_Seq__last_index__dbg, s1_appID_and_Seq__last_old_value, s1_appID_and_Seq__last_old_value__dbg, s1_appID_and_Seq__last_value, s1_appID_and_Seq__last_value__dbg, s1_appID_and_Seq__last_write_site, s1_appID_and_Seq__next_write_site, s1_appID_and_Seq__wrote_any, s1_appID_and_Seq__wrote_any__dbg, s1_appID_and_Seq__wrote_index0, s1_appID_and_Seq__wrote_index0__dbg, s1_bitmap, s1_bitmap__dbg0, s1_bitmap__last0_old_value, s1_bitmap__last0_old_value__dbg, s1_bitmap__last0_value, s1_bitmap__last0_value__dbg, s1_bitmap__last_index, s1_bitmap__last_index__dbg, s1_bitmap__last_old_value, s1_bitmap__last_old_value__dbg, s1_bitmap__last_value, s1_bitmap__last_value__dbg, s1_bitmap__last_write_site, s1_bitmap__next_write_site, s1_bitmap__wrote_any, s1_bitmap__wrote_any__dbg, s1_bitmap__wrote_index0, s1_bitmap__wrote_index0__dbg, s1_drop, s1_dsl_processed, s1_hdr.ethernet.ether_type, s1_hdr.ethernet.valid, s1_hdr.ipv4.valid, s1_hdr.p4ml.ECN, s1_hdr.p4ml.PSIndex, s1_hdr.p4ml.agtr_time, s1_hdr.p4ml.appIDandSeqNum, s1_hdr.p4ml.bitmap, s1_hdr.p4ml.dataIndex, s1_hdr.p4ml.isACK, s1_hdr.p4ml.isResend, s1_hdr.p4ml.isSWCollision, s1_hdr.p4ml.overflow, s1_hdr.p4ml.valid, s1_hdr.p4ml_agtr_index.agtr, s1_hdr.p4ml_agtr_index.valid, s1_hdr.p4ml_entries.data0, s1_hdr.p4ml_entries.data1, s1_hdr.p4ml_entries.data2, s1_hdr.p4ml_entries.data3, s1_hdr.p4ml_entries.valid, s1_hdr.udp.dst_port, s1_hdr.udp.valid, s1_inbox_count, s1_isValid, s1_meta.isMyAppIDandMyCurrentSeq, s1_meta.read_reg_appID_and_Seq, s1_meta.read_reg_bitmap, s1_meta.tmp_reg_bitmap, s1_p4b_checksum_error, s1_p4b_checksum_updated, s1_p4b_checksum_verified, s1_p4b_clone_e2e, s1_p4b_clone_i2e, s1_p4b_clone_i2i, s1_p4b_digest, s1_p4b_recirculate, s1_pkt_external;
{
  // initialize inboxes
  s1_inbox_count := 0;
  ...
  if (s1_inbox_count < 1) {
    ...
    havoc io_hdr.p4ml.bitmap;
    havoc io_hdr.p4ml.agtr_time;
    havoc io_hdr.p4ml.isResend;
    ...
    if ((dsl_phase == 0)) {
      ...
      io_hdr.p4ml.agtr_time := 1bv8;
      dsl_phase := 1;
    } else {
      io_hdr.p4ml.isResend := 1bv1;
      io_hdr.p4ml.bitmap := 2bv32;
      io_hdr.p4ml.agtr_time := 1bv8;
    }
  ...
  if ((s1_pkt_external && s1_hdr.p4ml.valid)) {
    s1_dsl_processed := s1_dsl_processed + 1;
  }
  ...
  if (!(((s1_dsl_processed < 2) || (s1_bitmap__dbg0 == 3bv32)))) { procurator_bad := true; }
  }
  procurator_step := procurator_step + 1;
  // step 3: host_send -> io
  // inject packet into connected node (host -> node)
