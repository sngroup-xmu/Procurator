...
"""
    ...
    def test_can_ignore_sourcecode_and_assignments(self) -> None:
        wa = extract_assumptions_from_graphml(
            """<?xml version="1.0" encoding="UTF-8"?>
<graphml xmlns="http://graphml.graphdrawing.org/xmlns">
  <key id="assumption" attr.name="assumption" for="edge"/>
  ...
  <graph edgedefault="directed">
    ...
    <edge source="N0" target="N1">
      <data key="assumption">dsl_pump_mode == true</data>
      <data key="sourcecode">clientTrack_meta.hashval_for_partition := 7</data>
    </edge>
  </graph>
</graphml>
""",
        ...
        self.assertEqual([a.expr for a in wa], ["dsl_pump_mode == true"])

    def test_sourcecode_equality_kept_when_enabled(self) -> None:
        wa = extract_assumptions_from_graphml(
            """<?xml version="1.0" encoding="UTF-8"?>
<graphml xmlns="http://graphml.graphdrawing.org/xmlns">
  <key id="sourcecode" attr.name="sourcecode" for="edge"/>
  <graph edgedefault="directed">
    ...
    <node id="N1"/>
    <edge source="N0" target="N1">
      <data key="sourcecode">clientTrack_meta.hashval_for_partition == 0x4</data>
    </edge>
  </graph>
</graphml>
""",
        ...
        assumes = synthesize_boogie_assumes(witness_assumptions=wa, base_bpl_text=_BPL)
        self.assertIn("clientTrack_meta.hashval_for_partition == 4bv16", assumes)
