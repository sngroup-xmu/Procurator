...
from dslc.workflows.wraparound_cegis import _synthesize_shape_assumes_from_witness


class TestWraparoundCegisShapeAssumes(unittest.TestCase):
    def test_synthesizes_table_control_and_enum_action(self) -> None:
        base_bpl = "\n".join(
            [
...
"""
        ...
        out = _synthesize_shape_assumes_from_witness(
        ...
        # Avoid pinning scheduler variables as "shape" constraints.
