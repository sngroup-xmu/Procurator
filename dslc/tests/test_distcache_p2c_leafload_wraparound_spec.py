...
class TestDistcacheP2CLeafloadWraparoundSpec(unittest.TestCase):
    def test_spec_file_exists_and_is_functional(self) -> None:
        p = pathlib.Path("Procurator/argo/code/spec/bench/distcache_p2c_wraparound_bug.prop")
        ...
        # Functional: key the property on the ingress decision event, not on optype at end of pass.
