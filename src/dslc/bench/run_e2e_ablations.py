...
def main(argv: list[str]) -> int:
    ...
    benches: list[Bench] = [
        ...
        Bench(
            ...
            spec="benchmarks/specs/bench/distcache_p2c_spineload_wraparound_bug.prop",
            category="wraparound",
            env="spec",
            wraparound="auto",
            timeout_s=max(ns.timeout, 600),
        ...
        Bench(
            ...
            spec="benchmarks/specs/bench/distcache_p2c_wraparound_bug.prop",
            category="wraparound",
            env="spec",
            wraparound="auto",
            timeout_s=max(ns.timeout, 600),
        ...
        Bench(
            ...
            spec="benchmarks/specs/bench/fisslock_notification_cnt_wraparound_bug.prop",
            category="wraparound",
            env="spec",
            wraparound="auto",
            timeout_s=max(ns.timeout, 600),
        ...
        Bench(
            ...
            spec="benchmarks/specs/bench/atp_count_mismatch_bug.prop",
            category="functional",
            env="spec",
            wraparound="off",
            timeout_s=max(ns.timeout, 600),
        ...
        Bench(
            ...
            spec="benchmarks/specs/bench/distcache_leaf_pktloss_clone_drop_bug.prop",
            category="functional",
            env="spec",
            wraparound="off",
            timeout_s=max(ns.timeout, 600),
            ...
            base_settings="src/dslc/toolchain/ultimate/ReachSafety-32bit-GemCutter-internal-no-por.epf",
        ),
        Bench(
            name="DistCache CM3/CM4 write wiring",
            spec="benchmarks/specs/bench/distcache_cm34_write_bug.prop",
            category="implementation",
            env="spec",
            wraparound="off",
            timeout_s=max(ns.timeout, 600),
        ...
        Bench(
            ...
            spec="benchmarks/specs/bench/distcache_spine_cache_frequency_idx_bug.prop",
            category="implementation",
            env="spec",
            wraparound="off",
        ...
        Bench(
            ...
            spec="benchmarks/specs/bench/ddosd_window_label_collision_bug.prop",
            category="implementation",
            env="spec",
            wraparound="off",
            timeout_s=max(ns.timeout, 600),
        ...
        Bench(
            ...
            spec="benchmarks/specs/bench/frr_bug1_unexpected_mirror.prop",
            category="implementation",
            env="spec",
            wraparound="off",
            timeout_s=max(ns.timeout, 600),
        ...
        Bench(
            ...
            spec="benchmarks/specs/bench/frr_bug2_state_inconsistency.prop",
        ...
        Bench(
            ...
            spec="benchmarks/specs/bench/p4nis_bug1_forwarding_sequence_desync.prop",
            category="interleaving",
            env="spec",
            wraparound="off",
            timeout_s=max(ns.timeout, 600),
        ...
        Bench(
            ...
            spec="benchmarks/specs/bench/p4nis_bug2_tunnel_state_leakage.prop",
            category="functional",
            env="spec",
            wraparound="off",
            timeout_s=max(ns.timeout, 600),
        ...
        Bench(
            ...
            extra_args=[
                "--no-reg-debug",
                "--settings",
                "src/dslc/toolchain/ultimate/ReachSafety-32bit-GemCutter-ALL-8g-smallblocks.epf",
            ],
            notes="",
        ),
        Bench(
            name="Gecko bug2: Limited Concurrency Handling (NSDI)",
            spec="benchmarks/specs/bench/gecko_bug2_concurrency.prop",
            category="interleaving",
            env="spec",
            wraparound="off",
            timeout_s=max(ns.timeout, 900),
        ...
        Bench(
            ...
            spec="benchmarks/specs/bench/gecko_bug3_timer_init.prop",
            category="implementation",
            env="spec",
            wraparound="off",
            timeout_s=max(ns.timeout, 600),
        ...
        Bench(
            ...
            spec="benchmarks/specs/bench/p4xos_dropflag_bug.prop",
            category="implementation",
            env="spec",
            wraparound="off",
            timeout_s=max(ns.timeout, 600),
        ...
        Bench(
            ...
            spec="benchmarks/specs/bench/p4xos_majority_quorum_bug.prop",
            category="interleaving",
            env="spec",
            wraparound="off",
            timeout_s=max(ns.timeout, 900),
        ...
        Bench(
            ...
            spec="benchmarks/specs/bench/cheetah_slot_index_collision_bug.prop",
            category="implementation",
            env="spec",
            wraparound="off",
        ...
        Bench(
            ...
            spec="benchmarks/specs/bench/netlock_pkt_type_bug.prop",
            category="implementation",
            env="spec",
            wraparound="off",
            timeout_s=max(ns.timeout, 600),
        ...
        Bench(
            ...
            spec="benchmarks/specs/bench/netlock_pushback_length_in_server_underflow_bug.prop",
            category="implementation",
            env="spec",
            wraparound="off",
            timeout_s=max(ns.timeout, 600),
        ...
        Bench(
            ...
            spec="benchmarks/specs/bench/netlock_release_counter_underflow_bug.prop",
            category="implementation",
            env="spec",
            wraparound="off",
            timeout_s=max(ns.timeout, 600),
        ...
        Bench(
            ...
            spec="benchmarks/specs/bench/netlock_release_empty_queue_head_bug.prop",
            category="functional",
            env="spec",
            wraparound="off",
            timeout_s=max(ns.timeout, 600),
        ...
        Bench(
            ...
            spec="benchmarks/specs/bench/netlock_release_empty_slots_overflow_bug.prop",
            category="implementation",
            env="spec",
            wraparound="off",
            timeout_s=max(ns.timeout, 600),
        ...
        Bench(
            ...
            spec="benchmarks/specs/bench/p4db_router_ttl_expiry_bug.prop",
            category="implementation",
            env="spec",
            wraparound="off",
            timeout_s=max(ns.timeout, 600),
        ...
        Bench(
            ...
            spec="benchmarks/specs/bench/p4db_damper_threshold_off_by_one_bug.prop",
            category="implementation",
            env="spec",
            wraparound="off",
            timeout_s=max(ns.timeout, 600),
