...
class TestP4BTranslatorRegressions(unittest.TestCase):
    ...
    def test_atp_register_slicing_emits_register_decls(self) -> None:
        ...
        p4 = repo_root / "benchmarks" / "datasets" / "ATP" / "p4src" / "p4ml_lc_16.p4"
        entries = repo_root / "benchmarks" / "datasets" / "ATP" / "p4src" / "atp" / "flow.txt"
    ...
    def test_json_ir_slicing_does_not_prune_register_domains(self) -> None:
        ...
        p4json = repo_root / "benchmarks" / "datasets" / "gecko" / "timer_b.json"
    ...
    def test_gecko_json_register_actions_and_packet_emit_are_well_declared(self) -> None:
        ...
        p4json = repo_root / "benchmarks" / "datasets" / "gecko" / "timer_a.json"
        entries = repo_root / "benchmarks" / "datasets" / "gecko" / "control" / "a.txt"
        p4include = repo_root / "third_party" / "p4c" / "source" / "p4include"
    ...
    def test_ubpf_three_arg_hash_lowers_to_target_helper_summary(self) -> None:
        ...
        p4 = repo_root / "third_party" / "p4c" / "source" / "testdata" / "p4_16_samples" / "hash_ubpf.p4"
        p4include = repo_root / "third_party" / "p4c" / "source" / "p4include"
        sample_include = repo_root / "third_party" / "p4c" / "source" / "testdata" / "p4_16_samples"
        if not p4.exists() or not p4include.is_dir():
    ...
    def test_psa_identity_hash_extern_lowers_to_precise_slice(self) -> None:
        ...
        p4include = repo_root / "third_party" / "p4c" / "source" / "p4include"
        sample_dir = repo_root / "third_party" / "p4c" / "source" / "testdata" / "p4_16_samples"
...
"""
    ...
    def test_tofino_constructor_style_local_instantiation_translates(self) -> None:
        ...
        p4 = repo_root / "benchmarks" / "datasets" / "tofinoTest" / "test.p4"
        p4include = repo_root / "third_party" / "p4c" / "source" / "p4include"
        if not p4.exists() or not p4include.is_dir():
