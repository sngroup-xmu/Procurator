...
class TestP4BTranslatorSlicingSelftest(unittest.TestCase):
    ...
    def test_distcache_register_alias_seed_slicing(self) -> None:
        ...
        p4 = repo_root / "benchmarks" / "datasets" / "distcache" / "leafswitch" / "netcache.p4"
        entries = (
            repo_root / "benchmarks" / "datasets" / "distcache" / "leafswitch" / "flow_entries.txt"
        )
        p4include = repo_root / "third_party" / "p4c" / "source" / "p4include"
        if not p4.exists() or not entries.exists() or not p4include.is_dir():
    ...
    def test_distcache_kept_registers_keep_write_helpers(self) -> None:
        ...
        p4 = repo_root / "benchmarks" / "datasets" / "distcache" / "leafswitch" / "netcache.p4"
        entries = repo_root / "benchmarks" / "specs" / "bench" / "distcache_leaf_cm_hotness_entries_min.txt"
        p4include = repo_root / "third_party" / "p4c" / "source" / "p4include"
        if not p4.exists() or not entries.exists() or not p4include.is_dir():
    ...
    def test_p4db_struct_types_are_declared(self) -> None:
        ...
        p4 = repo_root / "benchmarks" / "datasets" / "P4DB" / "tests" / "damper" / "router.p4"
        entries = repo_root / "benchmarks" / "specs" / "bench" / "p4db_damper_threshold1_commands.txt"
        p4include = repo_root / "third_party" / "p4c" / "source" / "p4include"
        if not p4.exists() or not entries.exists() or not p4include.is_dir():
    ...
    def test_frr_pkt_par_write_not_dropped_by_action_slicing(self) -> None:
        ...
        p4 = repo_root / "benchmarks" / "datasets" / "FRR" / "main.p4"
        entries = repo_root / "benchmarks" / "datasets" / "FRR" / "commands.txt"
        p4include = repo_root / "third_party" / "p4c" / "source" / "p4include"
        if not p4.exists() or not entries.exists() or not p4include.is_dir():
    ...
    def test_netlock_pushback_underflow_regaction_execute_not_dropped_in_assignments(self) -> None:
        ...
        p4 = repo_root / "benchmarks" / "datasets" / "NetLock" / "switch" / "p4" / "netlock.p4"
        entries = repo_root / "benchmarks" / "specs" / "bench" / "netlock_min_entries_pushback_empty0.txt"
        p4include = repo_root / "third_party" / "p4c" / "source" / "p4include"
        if not p4.exists() or not entries.exists() or not p4include.is_dir():
    ...
    def test_psa_random_read_lowered_to_bounded_nondet(self) -> None:
        ...
        p4 = repo_root / "third_party" / "p4c" / "source" / "testdata" / "p4_16_samples" / "psa-random.p4"
        p4include = repo_root / "third_party" / "p4c" / "source" / "p4include"
        if not p4.exists() or not p4include.is_dir():
    ...
    def test_external_int_flowdos_parser_compatibility(self) -> None:
        ...
        p4 = repo_root / "benchmarks" / "datasets" / "external_int_flowdos" / "switch-flow.p4"
        p4include = repo_root / "third_party" / "p4c" / "source" / "p4include"
        if not p4.exists() or not p4include.is_dir():
    ...
    def test_external_etc_noms2024_tna_hash_get_uses_data_fields(self) -> None:
        ...
        p4 = repo_root / "benchmarks" / "datasets" / "external_etc_noms2024" / "noms_20_5_4.p4"
        p4include = repo_root / "third_party" / "p4c" / "source" / "p4include"
        if not p4.exists() or not p4include.is_dir():
    ...
    def test_fisslock_const_entries_translated_to_key_matches(self) -> None:
        ...
        p4 = repo_root / "benchmarks" / "datasets" / "fisslock" / "p4" / "switch.p4"
        p4include = repo_root / "third_party" / "p4c" / "source" / "p4include"
        if not p4.exists() or not p4include.is_dir():
    ...
    def test_gecko_json_slicing_keeps_child_field_decls(self) -> None:
        ...
        ir_json = repo_root / "benchmarks" / "datasets" / "gecko" / "timer_b.json"
        entries = repo_root / "benchmarks" / "datasets" / "gecko" / "control" / "b.txt"
