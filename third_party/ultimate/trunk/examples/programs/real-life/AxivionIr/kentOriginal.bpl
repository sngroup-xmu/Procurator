 ...
 *
 * Obtained from Daniel OOM during simplification (e.g., while using CAMEL).
 * 
 * My analysis
 * (1) SP/WP does not work well because of uninterpreted functions
 *     quantifier elimination fails and Z3 returns UNKNOWN for the
 *     corresponding Hoare triple checks.
 * (2) I cannot see a simple way to improve the quantifier elimination.
 * (3) SMTInterpol could compute good interpolants, but failes because
