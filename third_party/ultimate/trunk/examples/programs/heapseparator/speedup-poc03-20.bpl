...
implementation main() {
  var p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19, p20 : int;
  ...
  while (*) {
    if (*) {
      ...
      #memory_int[p19] := #memory_int[p19] + 1;
    } else {
      #memory_int[p20] := #memory_int[p20] - 1;
    }
  }
  ...
  assert #memory_int[p19] >= 0;
  assert #memory_int[p20] <= 0;
}
