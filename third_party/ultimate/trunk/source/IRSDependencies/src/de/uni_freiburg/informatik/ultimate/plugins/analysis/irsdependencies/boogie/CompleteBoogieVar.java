...
/**
 * Class is used by Daniel for debugging symbol table. Orignially this was a subclass of BoogieVar
 *
 *
 */
public class CompleteBoogieVar {
	...
	public CompleteBoogieVar(final String identifier, final String procedure, final IBoogieType iType) {
