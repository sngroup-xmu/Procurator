...
public class RCFGUnrollWalkerAnnotation extends IRSDependenciesAnnotation {
	...
	public RCFGUnrollWalkerAnnotation(final IcfgLocation honda, final boolean isEntry, final boolean isExit) {
	...
	public void setHonda(final IcfgLocation mHonda) {
		this.mHonda = mHonda;
	}
	...
	public void setIsLoopExit(final boolean mIsLoopExit) {
	...
	public void setLoopEntry(final boolean mIsLoopEntry) {
