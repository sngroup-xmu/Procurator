...
/**
 * {@link AStar} will only consider edges that are not forbidden during its search. Edges can be forbidden based on the
...
public interface IEdgeDenier<E> {
	 ...
	 *            The current edge
	 * @param currentTrace
	 *            An iterator describing the path from the source of the current edge to the start of the search
	 * @return true iff this edge should not be considered (it will be as if this edge is not in the graph)
	 */
