...
/**
 * This walker traverses RCFG-graphs in breadth-first order with incoming edges and nodes as one unit. I.e. an observer
 * sees (root node -> root edge, program point -> some edge, program point -> ...). No edge is traversed twice.
 *
 * @author dietsch
 *
 */
public class RCFGWalkerBreadthFirst extends RCFGWalker {
	...
	public RCFGWalkerBreadthFirst(final ObserverDispatcher dispatcher, final ILogger logger) {
