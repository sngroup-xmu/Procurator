...
public class DependencyFinder extends BaseObserver {
	...
	public DependencyFinder(final ILogger logger) {
		mUnrollings = 1;
		mLogger = logger;
	}
	...
	private void doit(final IElement root, final int unrollings) {
		...
		final Collection<IcfgEdge> startEdges = BoogieIcfgContainer.extractStartEdges((BoogieIcfgContainer) root);
