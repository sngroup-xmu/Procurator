...
public class SCC implements Iterable<IcfgLocation> {
	...
	public <T extends IcfgLocation> SCC(final Collection<T> all) {
		mVertices = new HashSet<>(all);

	}

	void add(final IcfgLocation member) {
	...
	public boolean contains(final IcfgLocation node) {
