 ...
 * <li>a set of supporting invariants that are required to prove the ranking function.
 * </ul>
 *
 * @author Jan Leike
 */
public class TerminationArgument implements Serializable {
	 ...
	 *            a collection of required supporting invariants
	 * @param arrayIndexSupportingInvariants
	 */
	public TerminationArgument(final RankingFunction ranking_function,
			final Collection<SupportingInvariant> supporting_invariants,
	...
	public Collection<Term> getArrayIndexSupportingInvariants() {
		return Collections.unmodifiableCollection(mArrayIndexSupportingInvariants);
	}
