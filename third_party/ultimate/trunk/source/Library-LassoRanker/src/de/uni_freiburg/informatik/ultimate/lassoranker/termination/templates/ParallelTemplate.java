...
/**
 * The parallel template finds ranking functions that consist of multiple linear ranking functions that decrease in any
 * order.
 *
 * On the ordinals, a parallel ranking function represents the addition of two (linear) ranking functions. It is
 * probably only really useful as a composition of two (or more) other templates.
 *
 * Warning: the size of the constraints is _exponential_ in the number of parallel ranking functions
 *
...
public class ParallelTemplate extends RankingTemplate {
	...
	/**
	 * @param numfunctions
	 *            number of parallel ranking functions
	 */
