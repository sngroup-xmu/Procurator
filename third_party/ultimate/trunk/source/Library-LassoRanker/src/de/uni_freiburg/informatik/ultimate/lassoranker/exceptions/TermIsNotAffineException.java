...
/**
 * This type of exception is raised when processing a term which contains non-linear operations.
 *
 * @author Jan Leike
 */
public class TermIsNotAffineException extends TermException {
	...
	public TermIsNotAffineException(final String message, final Term term) {
		super(message, term);
	}
}
