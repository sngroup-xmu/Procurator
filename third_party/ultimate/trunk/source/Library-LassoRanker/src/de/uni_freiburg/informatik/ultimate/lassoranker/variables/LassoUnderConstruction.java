...
/**
 * Container for stem and loop that is used while constructing a lasso that is defined by linear inequalities from a
 * lasso that is defined by TransFormulas. Although this object itself is immutable, the stem and the loop may be
 * modifiable.
 *
