...
/**
 * This exception is thrown if an application term containing an unknown function symbol was encountered.
 *
 * @author Jan Leike
 */
public class UnknownFunctionException extends TermException {
	...
	public UnknownFunctionException(final ApplicationTerm term) {
