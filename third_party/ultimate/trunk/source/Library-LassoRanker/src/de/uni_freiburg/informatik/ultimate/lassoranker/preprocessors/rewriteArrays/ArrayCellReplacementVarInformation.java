...
/**
 * Object for storing information about an array cell for which we will construct a replacement var.
 *
...
public class ArrayCellReplacementVarInformation {
	...
	/**
	 * Index in which each TermVariable is translated to the representative of the corresponding BoogieVar.
	 */
	...
	public ArrayCellReplacementVarInformation(final TermVariable arrayInstance, final TermVariable arrayRepresentative,
			final ArrayIndex index, final ArrayIndex indexRepresentative, final VarType varType,
	...
	public void setReplacementVar(final IReplacementVarOrConst replacementVar) {
