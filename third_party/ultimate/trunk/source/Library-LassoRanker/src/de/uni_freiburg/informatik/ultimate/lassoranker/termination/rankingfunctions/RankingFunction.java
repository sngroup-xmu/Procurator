...
public abstract class RankingFunction implements Serializable {
	...
	/**
	 * Return the ranking function as a lexicographically ordered list of SMTLib terms, with the highest component being
	 * the list's first item. The length of this list is asserted to be constant throughout the lifetime of this object.
	 *
	 * @param script
	 *            the current script
	 */
