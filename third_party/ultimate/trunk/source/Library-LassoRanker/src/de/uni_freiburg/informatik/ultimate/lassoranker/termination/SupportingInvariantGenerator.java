...
/**
 * Creates and extracts supporting invariants. This class is the counterpart of the RankingFunctionTemplate classes for
...
class SupportingInvariantGenerator extends AffineFunctionGenerator {
	 ...
	 *            The SMTLib script
	 * @param variables
	 *            A collection of all variables that are relevant for the supporting invariant
	 * @param strict
	 *            is this invariant a strict inequality?
	 */
	SupportingInvariantGenerator(final Script script, final Collection<IProgramVar> variables, final boolean strict) {
		super(script, variables, s_prefix + (new InstanceCounting()).getInstanceNumber());
		this.strict = strict;
	}
	 ...
	 */
	public SupportingInvariant extractSupportingInvariant(final Map<Term, Rational> val) throws SMTLIBException {
