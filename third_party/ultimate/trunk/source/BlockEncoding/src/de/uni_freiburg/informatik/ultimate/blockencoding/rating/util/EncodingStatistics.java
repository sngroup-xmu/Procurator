...
/**
 * To create an rating heuristic, which can decide on basis of the underlying program, we need to store some statistical
 * properties, which we can use for that. <br>
 * So for example, the amount of edges in the graph, or the amount of disjunctions used in the minimization, or the
 * amount of variables, and so on...
 *
...
public class EncodingStatistics {
	...
	/**
	 * stores the total amount of created disjunctions (minimizing parallel edges), this is useful because it seems to
	 * be good, to break at some amount of disjunctions
	 */
	public static int countOfDisjunctions;

	/**
	 * stores the maximum number of disjunctions, which are contained in one composite edge
	 */
	...
	/**
	 * Initializes, all stored statistics. This have to be done, before we start a new run of block encoding.
	 */
	 ...
	 * @param value
	 */
	public static void setMaxDisjunctionsInOneEdge(final int value) {
	 ...
	 * @param value
	 */
	public static void setMaxElementsInOneDisjunction(final int value) {
	 ...
	 * @param value
	 */
	public static void setMaxMinDiffVariablesInOneEdge(final int value) {
		// we ignore zero
		if (value == 0) {
			return;
		}
	 ...
	 * @param ratingValue
	 */
	public static void addToTotalRating(final int ratingValue) {
	...
	public static void setMaxRatingOneEdge(final int val, final IMinimizedEdge edge) {
