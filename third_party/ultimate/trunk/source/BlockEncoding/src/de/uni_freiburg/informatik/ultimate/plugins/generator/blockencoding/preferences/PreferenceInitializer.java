...
public class PreferenceInitializer extends UltimatePreferenceInitializer {
	...
	protected UltimatePreferenceItem<?>[] initDefaultPreferences() {
		return new UltimatePreferenceItem[] {
				new UltimatePreferenceItem<>(LABEL_CALLMINIMIZE, false, PreferenceType.Boolean),
				new UltimatePreferenceItem<>(LABEL_EXECUTETESTS, false, PreferenceType.Boolean),
				new UltimatePreferenceItem<>(LABEL_STRATEGY, RatingStrategy.DEFAULT, PreferenceType.Combo,
						RatingStrategy.values()),
				new UltimatePreferenceItem<>(LABEL_USESTATHEURISTIC, false, PreferenceType.Boolean),
				new UltimatePreferenceItem<>(LABEL_USEDYNAMICHEURISTIC, false, PreferenceType.Boolean),
				new UltimatePreferenceItem<>(LABEL_RATINGBOUND, "", PreferenceType.String),
