...
public class DataflowDAG<T> extends ModifiableLabeledEdgesMultigraph<DataflowDAG<T>, ScopedBoogieVar> {
	...
	public DataflowDAG(final T stmt) {
		mNodeLabel = stmt;
	}
	...
	public void printGraphDebug(final ILogger logger) {
	...
	private void getDebugString(final StringBuilder st, final DataflowDAG<T> dag, final String edgeLabel,
			final String ident) {
