...
public class ReachDefBoogieAnnotator {
	...
	public ReachDefBoogieAnnotator(final Collection<ReachDefStatementAnnotation> predecessors,
			final ReachDefStatementAnnotation current, final ILogger logger, final ScopedBoogieVarBuilder builder) {
	 ...
	 * @throws Throwable
	 */
	public boolean annotate(final Statement stmt, final UnmodifiableTransFormula transFormula) throws Throwable {
	...
	/**
	 * Changes current s.t. it contains the union of current's defs with the defs of previousRDs.
	 *
	 * @param current
	 * @param previousRDs
	 */
	private void union(final ReachDefStatementAnnotation current,
			final Collection<ReachDefStatementAnnotation> previousRDs) {
		if (previousRDs == null) {
			return;
		}
