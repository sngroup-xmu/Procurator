...
public class ScopedBoogieVar {
	...
	public ScopedBoogieVar(final String identifier, final VariableDeclaration declaration,
			final DeclarationInformation declarationInformation, final IProgramVar var) {
