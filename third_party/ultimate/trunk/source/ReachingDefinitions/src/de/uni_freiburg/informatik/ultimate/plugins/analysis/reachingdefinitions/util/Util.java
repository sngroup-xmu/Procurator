...
public class Util {
	...
	public static <T> String prettyPrintIterable(final Iterable<T> remaining, final ElemToString<T> converter) {
	...
	public static String repeat(int c, final String r) {
	...
	public static <T> ElemToString<T> createHashCodePrinter() {
		return elem -> String.valueOf(elem.hashCode());
	}

	public interface ElemToString<E> {
		String toString(E elem);
	}
