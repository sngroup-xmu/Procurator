...
public class ReachDefTracePredecessorGenerator extends RCFGEdgeVisitor {
	...
	public ReachDefTracePredecessorGenerator(final IAnnotationProvider<ReachDefStatementAnnotation> provider) {
		this(provider, null);
	}
	 ...
	 * @return
	 */
	public List<ReachDefStatementAnnotation> process(final CodeBlock predecessor) {
		rtr = new ArrayList<>();
		visit(predecessor);
		return rtr;
	}
	...
	private ReachDefStatementAnnotation getAnnotation(final StatementSequence stmtSeq) {
		if (mKey == null) {
