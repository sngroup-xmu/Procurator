...
public class ReachDefStatementAnnotation extends ReachDefBaseAnnotation {
	...
	public void removeAllDefs(final ScopedBoogieVar variable) {
	...
	public boolean addDef(final ScopedBoogieVar variable, final Statement stmt, final String key) {
	...
	public boolean addUse(final ScopedBoogieVar variable, final Statement stmt, final String key) {
	...
	public Collection<IndexedStatement> getDef(final ScopedBoogieVar variableName) {
	 ...
	 */
	public boolean unionDef(final ReachDefStatementAnnotation other) {
		if (other.mDefs == null) {
			return false;
		}
