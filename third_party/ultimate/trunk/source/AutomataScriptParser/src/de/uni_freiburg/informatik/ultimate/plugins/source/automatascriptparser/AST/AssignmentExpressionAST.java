...
public class AssignmentExpressionAST extends AtsASTNode {
	...
	public void setOperator(final AssignmentOperatorAST operator) {
		moperator = operator;
	}

	public AssignmentExpressionAST(final ILocation loc, final VariableExpressionAST var,
			final AssignmentOperatorAST operator, final AtsASTNode value) {
		super(loc);
