...
public class AutomataTestFileAST extends AtsASTNode {
	...
	public AutomataTestFileAST(final ILocation loc, final AtsASTNode stmtList, final AutomataDefinitionsAST autDefs) {
		super(loc);
	...
	public void setAutomataDefinitions(final AutomataDefinitionsAST mautomataDefinitions) {
