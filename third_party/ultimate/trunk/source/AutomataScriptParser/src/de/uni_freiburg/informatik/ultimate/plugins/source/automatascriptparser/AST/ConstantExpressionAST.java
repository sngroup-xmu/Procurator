...
public class ConstantExpressionAST extends AtsASTNode {
	...
	public ConstantExpressionAST(final ILocation loc, final Integer val) {
		super(loc);
		setType(Integer.class);
		value = val;
	}

	public ConstantExpressionAST(final ILocation loc, final String val) {
		super(loc);
		setType(String.class);
		value = val;
	}

	public ConstantExpressionAST(final ILocation loc, final boolean val) {
		super(loc);
