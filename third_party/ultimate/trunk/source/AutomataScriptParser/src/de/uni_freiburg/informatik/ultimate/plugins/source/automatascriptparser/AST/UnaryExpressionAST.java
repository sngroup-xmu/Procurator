...
public class UnaryExpressionAST extends AtsASTNode {
	...
	public UnaryExpressionAST(final ILocation loc) {
		super(loc);
		mReturnType = Integer.class;
		mExpectingType = mReturnType;
	}

	public UnaryExpressionAST(final ILocation loc, final VariableExpressionAST expr) {
		super(loc);
		mReturnType = Integer.class;
		mExpectingType = mReturnType;
	...
	public void setOperator(final UnaryOperatorAST operator) {
		moperator = operator;
	}
