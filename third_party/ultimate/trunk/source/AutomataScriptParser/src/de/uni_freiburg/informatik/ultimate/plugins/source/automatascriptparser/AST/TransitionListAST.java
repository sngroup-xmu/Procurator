...
/**
 * Is used to hold transitions for nestedword automata (internal-, call-, and return-transitions) and for Petri nets.
 *
 *
...
public class TransitionListAST extends AtsASTNode {
	...
	private void addTransition(final String fromState, final String label, final String toState) {
		final Pair<String, String> stateSymbolPair = new Pair<>(fromState, label);
	...
	@Deprecated
	/**
	 * 20180125 Matthias: Deprecated, implement analogously to convertToEpsilonTransitions()
	 */
