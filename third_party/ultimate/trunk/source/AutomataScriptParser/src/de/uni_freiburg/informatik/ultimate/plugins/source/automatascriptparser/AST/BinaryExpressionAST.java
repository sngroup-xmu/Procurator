...
public class BinaryExpressionAST extends AtsASTNode {
	...
	public BinaryExpressionAST(final ILocation loc) {
		super(loc);
	 ...
	 *
	 */
	private void setBothTypesTo(final Class<?> type) {
		mReturnType = type;
		mExpectingType = type;
	}

	public BinaryExpressionAST(final ILocation loc, final AtsASTNode leftChild, final AtsASTNode rightChild) {
		super(loc);
		setBothTypesTo(Integer.class);
	...
	public void setOperator(final BinaryOperatorAST op) {
		moperator = op;
