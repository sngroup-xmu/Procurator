...
public class VariableDeclarationAST extends AtsASTNode {
	...
	public VariableDeclarationAST(final ILocation loc, final String identifier) {
		super(loc);
	...
	public void addVariable(final String identifier) {
		midentifiers.add(identifier);
	}

	public void addVariables(final List<String> identifiers) {
