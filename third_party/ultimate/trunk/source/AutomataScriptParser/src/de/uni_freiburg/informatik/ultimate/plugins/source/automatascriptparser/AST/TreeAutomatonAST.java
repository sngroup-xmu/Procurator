...
public class TreeAutomatonAST extends AutomatonAST {
	...
	public TreeAutomatonAST(final ILocation loc, final String id) {
		super(loc, id);
	}

	public void setAlphabet(final List<String> entryList) {
		mAlphabet = entryList;
	}

	public void setStates(final List<String> identifierList) {
		mStates = identifierList;
	}

	public void setInitialStates(final List<String> identifierList) {
		mInitialStates = identifierList;
	}

	public void setFinalStates(final List<String> identifierList) {
		mFinalStates = identifierList;
	}

	public void setTransitions(final List<TreeAutomatonTransitionAST> transitions) {
