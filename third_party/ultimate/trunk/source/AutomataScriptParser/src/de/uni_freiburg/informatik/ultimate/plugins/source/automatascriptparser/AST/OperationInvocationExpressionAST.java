...
public class OperationInvocationExpressionAST extends AtsASTNode {
	...
	public OperationInvocationExpressionAST(final ILocation loc, final String opName, final AtsASTNode e2) {
		super(loc);
	...
	public void setArgsAsString(final String margsAsString) {
