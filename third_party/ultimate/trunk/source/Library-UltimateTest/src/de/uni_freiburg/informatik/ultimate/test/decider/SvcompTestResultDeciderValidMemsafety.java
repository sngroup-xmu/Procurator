 ...
 */
public class SvcompTestResultDeciderValidMemsafety extends SafetyCheckTestResultDecider {
	 ...
	 *            for JUnit.
	 */
	public SvcompTestResultDeciderValidMemsafety(final UltimateRunDefinition ultimateRunDefinition,
	...
	public IExpectedResultFinder<SafetyCheckerOverallResult> constructExpectedResultFinder() {
		final NestedMap2<String, String, SafetyCheckerOverallResult> map =
				TestUtil.constructPropertyMapSvcompSafety(TestUtil.SVCOMP_PROP_VALIDMEMSAFETY);
