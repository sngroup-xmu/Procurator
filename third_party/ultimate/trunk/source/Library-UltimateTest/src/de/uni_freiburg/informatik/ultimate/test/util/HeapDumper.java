...
public class HeapDumper {
	...
	/**
	 * Call this method from your application whenever you want to dump a heap snapshot into a file.
	 *
	 * @param fileName
	...
	private static String prepareFilename(final String filename) {
		final File f = new File(
				filename + de.uni_freiburg.informatik.ultimate.util.CoreUtil.getCurrentDateTimeAsString() + ".hprof");
