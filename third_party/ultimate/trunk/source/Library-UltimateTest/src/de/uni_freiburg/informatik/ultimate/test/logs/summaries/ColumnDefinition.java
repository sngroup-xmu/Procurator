...
public class ColumnDefinition {
	...
	public ColumnDefinition(final String csvColumnName, final String latexTableTitle,
			final ConversionContext humanReadable, final Aggregate howToAggregateFromSingleRun,
			final Aggregate howToAggregateForLatexTableRow) {
