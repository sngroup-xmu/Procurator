 ...
 *
 * The target says that this annotation can be used to annotate methods The retention policy RUNTIME says that we want
 * to read this annotation at runtime with reflections.
 *
 * @author dietsch
 *
 */
