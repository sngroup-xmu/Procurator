...
/**
 * Use keywords in first line to decide correctness of termcomp 2017 benchmarks. Maybe we can write a good superclass
 * for both.
 *
...
public class TermcompTestResultDecider extends TerminationAnalysisTestResultDecider {
	...
	public TermcompTestResultDecider(final UltimateRunDefinition ultimateRunDefinition,
	...
	public IExpectedResultFinder<TerminationAnalysisOverallResult> constructExpectedResultFinder() {
		return new KeywordBasedExpectedResultFinder<>(Collections.emptyMap(), Collections.emptyMap(),
