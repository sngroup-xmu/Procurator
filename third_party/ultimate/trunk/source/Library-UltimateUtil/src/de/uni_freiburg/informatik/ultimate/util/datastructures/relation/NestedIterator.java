...
/**
 * Iterate over two kinds of iterators in a nested manner. For each element of the inner iterator we have a function
 * that gives us the next outer iterator. The resulting element is composed of the inner and the outer element via a
 * given function.
 *
...
public class NestedIterator<IE, OE, RE> implements Iterator<RE> {
	...
	public NestedIterator(final Iterator<IE> innerIterator, final Function<IE, Iterator<OE>> nextOuterIteratorProvider,
