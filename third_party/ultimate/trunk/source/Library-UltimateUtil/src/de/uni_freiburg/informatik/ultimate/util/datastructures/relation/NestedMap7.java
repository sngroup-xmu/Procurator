...
public class NestedMap7<K1, K2, K3, K4, K5, K6, K7, V> {
	 ...
	 */
	public V get(final K1 key1, final K2 key2, final K3 key3, final K4 key4, final K5 key5, final K6 key6,
			final K7 key7) {
	 ...
	 * @param value
	 *            Value to store
	 * @return The previous value associated with key, or <tt>null</tt> if there was no mapping for key. See
	 *         {@link Map#put(Object, Object)}.
	 */
	public V put(final K1 key1, final K2 key2, final K3 key3, final K4 key4, final K5 key5, final K6 key6,
			final K7 key7, final V value) {
	...
	public Stream<V> values() {
		return mK1ToK2ToK3ToK4ToK5ToK6ToK7V.values().stream().flatMap(NestedMap6::values);
	}
}
