...
public class NestedMap5<K1, K2, K3, K4, K5, V> {
	 ...
	 */
	public V get(final K1 key1, final K2 key2, final K3 key3, final K4 key4, final K5 key5) {
	 ...
	 */
	public V put(final K1 key1, final K2 key2, final K3 key3, final K4 key4, final K5 key5, final V value) {
	...
	public Stream<V> values() {
		return mK1ToK2ToK3ToK4ToK5V.values().stream().flatMap(NestedMap4::values);
	}
}
