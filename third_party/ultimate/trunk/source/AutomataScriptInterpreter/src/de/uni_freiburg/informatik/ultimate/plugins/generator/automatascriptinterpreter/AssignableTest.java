...
public class AssignableTest {
	/**
	 * A map from primitive types to reference types. e.g. (int -> Integer)
	 */
	...
	public static void initPrimitiveTypes() {
		...
		/*
		 * In automata script test files, currently only two primitive types are in use, namely int and boolean.
		 */
	...
	/**
	 * Performs an assignable test on two types. Can also handle primitive types.
	 *
	 * @param left
	 *            the type of the operand on the left-side of the assignment
	 * @param right
	 *            the type of the operand on the right-side of the assignment
	 * @return true if and only if the right operand is equal to or a sub-type of the left operand, otherwise false.
	 */
