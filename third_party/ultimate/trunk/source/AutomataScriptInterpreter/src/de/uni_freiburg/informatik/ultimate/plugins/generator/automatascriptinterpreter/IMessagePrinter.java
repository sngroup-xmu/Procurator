...
interface IMessagePrinter {
	/**
	 * Reports the given string to the logger and to Ultimate as a GenericResult.
	 *
	 * @param sev
	 *            the Severity
	 * @param longDescr
	 ...
	 *            short description
	 */
	void printMessage(Severity severityForResult, LoggerSeverity severityForLogger, String longDescr, String shortDescr,
			AtsASTNode node);
}
