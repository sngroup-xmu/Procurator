...
public class LoggingScriptForMainTrackBenchmarks extends LoggingScriptForNonIncrementalBenchmarks {
	...
	public static final String SOURCE_AUTOMIZER = "|" + System.lineSeparator()
			...
			+ "applying Ultimate Automizer to benchmarks [4] from the SV-COMP 2024 [5,6]." + System.lineSeparator()
			+ "This script may not contain all SMT commands that Ultimate Automizer" + System.lineSeparator()
			+ "issued. In order to meet the restrictions for SMT-COMP benchmarks " + System.lineSeparator()
			+ "we dropped the commands for getting values (resp. models), "	+ System.lineSeparator()
			+ "unsatisfiable cores, and interpolants." + System.lineSeparator()
			+ "" + System.lineSeparator()
			+ "2024-04-13, Matthias Heizmann (heizmann@informatik.uni-freiburg.de)" + System.lineSeparator()
			+ "" + System.lineSeparator()
			+ "[1] https://ultimate.informatik.uni-freiburg.de/automizer/" + System.lineSeparator()
			+ "[2] Matthias Heizmann, Max Barth, Daniel Dietsch, Leonard Fichtner," + System.lineSeparator()
			+ "     Jochen Hoenicke, Dominik Klumpp, Mehdi Naouar, Tanja Schindler," + System.lineSeparator()
			+ "     Frank Schüssele, Andreas Podelski: Ultimate Automizer and the" + System.lineSeparator()
			+ "     CommuHash Normal Form (Competition Contribution). TACAS 2023" + System.lineSeparator()
			+ "[3] Matthias Heizmann, Jochen Hoenicke, Andreas Podelski: Software Model" + System.lineSeparator()
			+ "     Checking for People Who Love Automata. CAV 2013" + System.lineSeparator()
			+ "[4] https://github.com/sosy-lab/sv-benchmarks" + System.lineSeparator()
			+ "[5] Dirk Beyer: State of the Art in Software Verification and" + System.lineSeparator()
			+ "     Witness Validation: SV-COMP 2024.  TACAS 2024" + System.lineSeparator()
			+ "[6] https://sv-comp.sosy-lab.org/2024/" + System.lineSeparator() + "|";
	// @formatter:on
	...
	private List<ArrayList<ISmtCommand<?>>>
		...
		final ArrayList<ISmtCommand<?>> result = new ArrayList<>(buildPreamble(logic, sat, getSourceInfo()));
		result.addAll(tmp);
