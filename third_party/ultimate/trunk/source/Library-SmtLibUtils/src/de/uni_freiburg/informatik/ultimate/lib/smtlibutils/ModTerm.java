...
/**
 * Represents mod operator from the SMT-LIB theory of integers.
 *
...
public class ModTerm implements ITermProvider {
	...
	public Term toTerm(final Script script) {
		return SmtUtils.mod(script, mDivident, mDivisor);
	}

	public static ModTerm of(final Term term) {
		...
		return new ModTerm(appTerm.getParameters()[0], appTerm.getParameters()[1]);
	}
}
