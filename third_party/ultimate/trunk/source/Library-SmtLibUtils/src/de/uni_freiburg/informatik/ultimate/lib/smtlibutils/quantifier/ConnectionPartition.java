...
/**
 * Partition set of terms into equivalence classes. We call two terms connected if both share a common NonTheorySymbols.
 * we define two terms to be equivalent (resp. this partition) if they are in the transitive closure of the connection
 * relation.
 */
