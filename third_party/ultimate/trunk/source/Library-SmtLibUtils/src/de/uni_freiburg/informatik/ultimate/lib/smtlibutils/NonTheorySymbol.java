...
/**
 * Wrapper for non-theory SMT symbols. A non-theory symbol is either a TermVariable, a constant or a FunctionSymbol. We
 * need this class because there is no common superclass for these three classes.
 *
...
public abstract class NonTheorySymbol<SYMBOL> {
	...
	private NonTheorySymbol(final SYMBOL symbol) {
		mSymbol = symbol;
	}
	...
	public static Set<NonTheorySymbol<?>> extractNonTheorySymbols(final Term term) {
	...
	public static class Variable extends NonTheorySymbol<TermVariable> {
		public Variable(final TermVariable tv) {
			super(tv);
		}
	}

	public static class Constant extends NonTheorySymbol<ApplicationTerm> {
		public Constant(final ApplicationTerm constant) {
			super(constant);
	...
	public static class Function extends NonTheorySymbol<FunctionSymbol> {
		public Function(final FunctionSymbol functionSymbol) {
