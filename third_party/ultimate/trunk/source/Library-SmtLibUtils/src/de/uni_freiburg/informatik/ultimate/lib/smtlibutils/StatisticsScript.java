...
/**
 * {@link WrapperScript} that collects data about the usage of the script.
 *
...
public class StatisticsScript extends WrapperScript {
	...
	public StatisticsScript(final Script wrappedScript) {
		super(wrappedScript);
	}

	public int getNumberOfCheckSatCommands() {
		return mNumberOfCheckSatCommands;
	}

	public long getCheckSatTime() {
		return mCheckSatTime;
	}
	...
	public LBool checkSat() throws SMTLIBException {
		...
		mCheckSatTime += (System.nanoTime() - startTime);
		return result;
	}
