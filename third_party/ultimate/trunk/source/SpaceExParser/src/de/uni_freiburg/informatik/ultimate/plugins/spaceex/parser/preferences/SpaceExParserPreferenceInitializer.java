...
public class SpaceExParserPreferenceInitializer extends UltimatePreferenceInitializer {
	...
	public static final String LABEL_LOAD_CONFIG_FILE_OF_SPACEEX_MODEL =
			"Load config file of corresponding SpaceEx model";
	...
	protected BaseUltimatePreferenceItem[] initDefaultPreferences() {
		...
		rtr.add(new UltimatePreferenceItem<>(LABEL_LOAD_CONFIG_FILE_OF_SPACEEX_MODEL,
				DEFAULT_LOAD_CONFIG_FILE_OF_SPACEEX_MODEL, PreferenceType.Boolean));

		rtr.add(new UltimatePreferenceItem<>(LABEL_SPACEEX_CONFIG_FILE, "", PreferenceType.File));

		rtr.add(new UltimatePreferenceItem<>(LABEL_CONFIG_FILE_EXPLANATION, null, PreferenceType.Label));
