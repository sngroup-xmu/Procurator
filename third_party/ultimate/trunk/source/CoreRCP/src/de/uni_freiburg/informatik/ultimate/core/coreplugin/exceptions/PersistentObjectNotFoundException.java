...
public class PersistentObjectNotFoundException extends DataAccessException {
	 ...
	 * @param msg
	 */
	public PersistentObjectNotFoundException(final String msg) {
		super(msg);
	}
	 ...
	 * @param cause
	 */
	public PersistentObjectNotFoundException(final String msg, final Throwable cause) {
		super(msg, cause);
	}
	 ...
	 * @param e
	 */
	public PersistentObjectNotFoundException(final Throwable e) {
