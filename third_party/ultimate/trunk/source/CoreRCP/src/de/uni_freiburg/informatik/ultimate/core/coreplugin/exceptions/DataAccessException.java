...
/**
 * DataAccessException Root of the Exception Hierarchy for Data Access. Catching this kind of Exception allows the user
 * to react t data access failure without knowing the particular reason (wrong usage, unavailable data access service
 * etc)
 *
