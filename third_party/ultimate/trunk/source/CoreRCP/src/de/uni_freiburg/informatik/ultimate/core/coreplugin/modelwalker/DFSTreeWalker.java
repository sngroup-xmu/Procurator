...
public class DFSTreeWalker extends BaseWalker {
	...
	public DFSTreeWalker(final ILogger logger) {
		super(logger);
	}

	@Override
	protected void runObserver(final IElement element, final IUnmanagedObserver v) throws Throwable {
		...
		if (v.process(tobeproccessed) && (element instanceof IWalkable)) {
