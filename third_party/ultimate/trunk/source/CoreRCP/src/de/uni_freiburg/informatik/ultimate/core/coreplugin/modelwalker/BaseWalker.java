...
public abstract class BaseWalker implements IWalker {
	...
	protected BaseWalker(final ILogger logger) {
		mObservers = new LinkedList<>();
		mLogger = logger;
	}

	@Override
	public boolean addObserver(final IObserver v) {
	 ...
	 */
	@Override
	public void run(final IElement inode) throws Throwable {
		if (inode != null) {
	...
	private void runObserver(final IElement root, final IObserver observer) throws Throwable {
