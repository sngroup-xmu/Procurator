...
public class PreferenceInitializer extends UltimatePreferenceInitializer {
	...
	protected UltimatePreferenceItem<?>[] initDefaultPreferences() {
		return new UltimatePreferenceItem<?>[] {
				new UltimatePreferenceItem<>(LABEL_PROCEDUREID, "", PreferenceType.String),
				new UltimatePreferenceItem<>(LABEL_ALLFUNCTIONS, VALUE_ALLFUNCTIONS_DEFAULT, PreferenceType.Boolean),
				new UltimatePreferenceItem<>(LABEL_STRUCTURETYPE, "", PreferenceType.String),
				new UltimatePreferenceItem<>(LABEL_TRIMWRAP, VALUE_TRIMWRAP_DEFAULT, PreferenceType.Boolean),
				new UltimatePreferenceItem<>(LABEL_LEAVEPROCEDURES, VALUE_LEAVEPROCEDURES, PreferenceType.Boolean), };
	}
}
