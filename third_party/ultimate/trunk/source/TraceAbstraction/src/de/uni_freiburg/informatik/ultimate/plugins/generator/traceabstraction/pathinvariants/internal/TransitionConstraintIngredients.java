...
/**
 * Represents a transition between two program points with given invariant patterns.
 *
 * If all InvariantTransitionPredicates of a program are fulfilled by an assignment on variables within the invariant
 * pattern, a valid invariant map can be generated by inserting that particular assignment into the invariant map.
 *
 * @param <IPT>
...
public class TransitionConstraintIngredients<IPT> {
	...
	/**
	 * Creates a invariant transition predicate from two given invariant patterns and a connecting
	 ...
	 */
	public TransitionConstraintIngredients(final IPT invStart, final IPT invEnd, final IcfgLocation sourceLocation,
			final IcfgLocation targetLocation, final Set<IProgramVar> varsForSourcePattern,
			final Set<IProgramVar> varsForTargetPattern, final UnmodifiableTransFormula transition) {
