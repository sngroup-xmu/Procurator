...
public abstract class ModifiableMultigraphEdge<V extends IModifiableExplicitEdgesMultigraph<V, E, VL, EL, VisualizationNode>, E extends IModifiableMultigraphEdge<V, E, VL, EL, VisualizationNode>, VL, EL>
	 ...
	 */
	protected ModifiableMultigraphEdge(final V source, final V target) {
	 ...
	 *            A payload or null.
	 */
	protected ModifiableMultigraphEdge(final V source, final V target, final IPayload payload) {
	...
	@SuppressWarnings("unchecked")
	@Override
	public void redirectTarget(final V target) {
		if (target != null) {
			disconnectTarget();
			setTarget(target);
	...
	@SuppressWarnings("unchecked")
	@Override
	public void redirectSource(final V source) {
		if (source != null) {
			disconnectSource();
			setSource(source);
