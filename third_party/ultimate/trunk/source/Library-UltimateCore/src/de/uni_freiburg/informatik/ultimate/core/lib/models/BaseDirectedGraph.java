...
public abstract class BaseDirectedGraph<T extends IDirectedGraph<T, VisualizationNode>> extends BasePayloadContainer
	 ...
	 */
	protected BaseDirectedGraph(final IPayload payload) {
		this(null, payload);
	 ...
	 */
	protected BaseDirectedGraph(final T parent) {
		this(parent, null);
	}
	...
	protected BaseDirectedGraph(final T parent, final IPayload payload) {
		super(payload);
