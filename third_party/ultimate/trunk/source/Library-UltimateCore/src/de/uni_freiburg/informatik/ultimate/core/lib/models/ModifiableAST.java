...
public class ModifiableAST<T extends IModifiableAST<T, VisualizationNode>> extends BaseAST<T>
	 ...
	 */
	protected ModifiableAST(final IPayload payload) {
		this(null, payload);
	}
	 ...
	 * @param parent
	 */
	protected ModifiableAST(final T parent) {
		this(parent, null);
	}
	 ...
	 */
	protected ModifiableAST(final T parent, final IPayload payload) {
	...
	@Override
	public void setIncomingNode(final T parent) {
		mParent = parent;
	}

	@SuppressWarnings("unchecked")
	@Override
	public void redirectParent(final T parent) {
		mParent.removeOutgoing((T) this);
		mParent = parent;
		if ((parent != null) && !parent.getOutgoingNodes().contains(this)) {
