...
public abstract class ModifiableDirectedGraph<T extends IModifiableDirectedGraph<T, VisualizationNode>>
	 ...
	 */
	protected ModifiableDirectedGraph(final IPayload payload) {
		this(null, payload);
	 ...
	 */
	protected ModifiableDirectedGraph(final T parent) {
		this(parent, null);
	}
	 ...
	 *            A given payload or null
	 */
	protected ModifiableDirectedGraph(final T parent, final IPayload payload) {
		super(parent, payload);
	}

	@SuppressWarnings("unchecked")
	@Override
	public boolean connectIncoming(final T predecessor) {
	...
	@SuppressWarnings("unchecked")
	@Override
	public boolean disconnectIncoming(final T predecessor) {
	...
	@SuppressWarnings("unchecked")
	@Override
	public boolean connectOutgoing(final T successor) {
	...
	@SuppressWarnings("unchecked")
	@Override
	public boolean disconnectOutgoing(final T successor) {
	...
	@Override
	public boolean addOutgoing(final T outgoing) {
		if (outgoing == this) {
			assert false;
		}
		if (outgoing != null) {
	...
	@Override
	public boolean addOutgoing(final int index, final T outgoing) {
	...
	@Override
	public boolean addAllOutgoing(final Collection<? extends T> c) {
		boolean rtr = false;
	...
	@Override
	public boolean addAllOutgoing(final int index, final Collection<? extends T> c) {
	...
	@Override
	public T removeOutgoing(final int index) {
		return mOutgoingNodes.remove(index);
	}

	@Override
	public boolean removeOutgoing(final T o) {
		return mOutgoingNodes.remove(o);
	}

	@Override
	public boolean removeAllOutgoing(final Collection<? extends T> c) {
		boolean rtr = false;
		for (final T o : c) {
	...
	@Override
	public boolean addIncoming(final T incoming) {
		if (incoming == this) {
			assert false;
		}
		if (incoming != null) {
	...
	@Override
	public boolean addIncoming(final int index, final T incoming) {
	...
	@Override
	public boolean addAllIncoming(final Collection<? extends T> c) {
		boolean rtr = false;
		for (final T e : c) {
			rtr |= addIncoming(e);
		}
	...
	@Override
	public boolean addAllIncoming(final int index, final Collection<? extends T> c) {
	...
	@Override
	public T removeIncoming(final int index) {
		return mIncomingNodes.remove(index);
	}

	@Override
	public boolean removeIncoming(final T o) {
		return mIncomingNodes.remove(o);
	}

	@Override
	public boolean removeAllIncoming(final Collection<? extends T> c) {
		boolean rtr = false;
		for (final T o : c) {
