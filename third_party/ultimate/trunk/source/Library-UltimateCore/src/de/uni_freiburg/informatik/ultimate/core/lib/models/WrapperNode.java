...
public class WrapperNode extends ModifiableAST<WrapperNode> {
	...
	public WrapperNode(final WrapperNode parent, final Object backing) {
		this(parent, backing, null);
	}

	public WrapperNode(final WrapperNode parent, final Object backing, final IPayload payload) {
