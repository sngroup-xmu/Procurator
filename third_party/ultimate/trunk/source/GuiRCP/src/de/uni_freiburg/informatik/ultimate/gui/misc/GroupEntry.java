...
public class GroupEntry extends TreeViewEntry {
	...
	public GroupEntry(final String entryName, final GroupEntry parent) {
	...
	public boolean removeEntry(final TreeViewEntry entry) {
		return mEntries.remove(entry);
	}

	public boolean addEntry(final TreeViewEntry entry) {
