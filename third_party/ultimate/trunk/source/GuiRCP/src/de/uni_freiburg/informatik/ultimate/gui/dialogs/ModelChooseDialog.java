...
public class ModelChooseDialog extends Dialog {
	 ...
	 * @param style
	 */
	public ModelChooseDialog(final Shell parent, final int style, final List<String> items, final String title) {
		super(parent, style);
		this.items = items;
		dialogName = title;
	 ...
	 * @param parent
	 */
	public ModelChooseDialog(final Shell parent, final List<String> items, final String title) {
	...
	protected void createContents() {
		...
		// //TODO Check why SWTselect is called 2 times for a single selection and how we could handle mutliple
		// selections
