...
public class ParserChooseDialog extends Dialog {
	 ...
	 * @param style
	 */
	public ParserChooseDialog(final Shell parent, final int style, final Collection<ISource> parsers) {
		super(parent, style);
	 ...
	 * @param parent
	 */
	public ParserChooseDialog(final Shell parent, final Collection<ISource> parsers) {
