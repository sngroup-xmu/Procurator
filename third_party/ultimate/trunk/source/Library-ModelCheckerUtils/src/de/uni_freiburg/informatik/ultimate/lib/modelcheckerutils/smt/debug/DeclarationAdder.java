...
/**
 * {@link DeclarationAdder} is a {@link TermTransformer} that adds the declarations of a term as
 * <code>(declare-fun ...)</code> to a {@link PrintWriter}. Each declaration gets its own line.
 *
...
public final class DeclarationAdder extends TermTransformer {
	 ...
	 *
	 * @param pw
	 *            The print writer to which the declarations are appended. The writer has to be initialized. We do not
	 *            close the writer.
	 */
