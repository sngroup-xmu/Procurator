...
/**
 * {@link InputTermDumper} is a {@link TimerTask} that can be used to dump a term together with its assertion stack,
 * theory and definitions.
 *
 * For each dump, this class will create a file in the temp directory of your system named
 * <prefix><somerandomsymbols>.smt2.gz which can be decompressed by using gunzip -d <filename>.
 *
 ...
 * </code>
 *
 * Do not forget to call <code>t.cancel()</code> if you finish the original task and no file should be dumped.
 *
...
public class InputTermDumper extends TimerTask {
	 ...
	 * @param assertions
	 *            is the current assertion stack. This may be null if you do not want to print the assertion stack. Get
	 *            it from {@link Script#getAssertions()}.
