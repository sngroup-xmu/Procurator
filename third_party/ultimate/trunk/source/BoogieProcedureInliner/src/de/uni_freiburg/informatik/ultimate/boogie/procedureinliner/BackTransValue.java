...
/**
 * Value for backtranslation mappings. See documentation of getters, for more information.
 *
...
public class BackTransValue {
	...
	public BackTransValue(final String inlineEntryProcId, final Deque<CallStatement> origCallStack,
			final BoogieASTNode origNode) {
