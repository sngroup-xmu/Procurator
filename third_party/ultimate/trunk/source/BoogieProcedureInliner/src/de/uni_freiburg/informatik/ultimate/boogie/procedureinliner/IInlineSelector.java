...
public interface IInlineSelector {
	 ...
	 *
	 * @param callGraph
	 *            Mapping from all procedure identifiers to the nodes of the call graph.
	 * @param programIsConcurrent
	 *            Program contains a fork statement
	 */
	void setInlineFlags(Map<String, CallGraphNode> callGraph, boolean programIsConcurrent);
