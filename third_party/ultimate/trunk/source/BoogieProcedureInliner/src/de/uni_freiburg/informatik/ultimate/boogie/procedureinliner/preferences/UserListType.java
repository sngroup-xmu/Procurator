 ...
 *
 * Basically, these are some set operations (like union, intersection and so on). There are 3 sets: - ALL: All
 * Procedures from the program - PREF: Procedures selected by the other preferences - LIST: Procedures from the user
 * list
 *
...
public enum UserListType {
	...
	UserListType(final String displayName) {
