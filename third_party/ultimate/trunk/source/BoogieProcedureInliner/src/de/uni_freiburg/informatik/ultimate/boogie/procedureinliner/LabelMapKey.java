...
/**
 * Key for the map from old to new label identifiers, used while creating an inline version of a Boogie procedure. A key
 * can also represent a return statement, because they have to be mapped to gotos to a new label.
 *
...
public class LabelMapKey {
	 ...
	 *
	 * @param labelId
	 *            Original identifier of the label.
	 * @param procedureId
	 *            Identifier of the original procedure, containing the label.
	 */
	public LabelMapKey(final String labelId, final String procedureId) {
	 ...
	 *
	 * @param labelId
	 *            Original identifier of the label. {@code null} for the generated return label.
	 * @param procedureId
	 *            Identifier of the original procedure, containing the label.
	 * @param callNumber
	 *            Number of calls to the procedure with identifier {@code procedureId} before the current call.
	 */
	public LabelMapKey(final String labelId, final String procedureId, final int callNumber) {
		mLabelId = labelId;
	...
	@Override
	public int hashCode() {
		return Objects.hash(mCallNumber, mLabelId, mProcedureId);
	}
