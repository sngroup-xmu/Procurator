...
/**
 * Wrapper class for IdentifierExpression to be used, when equals() and hashCode() are needed. Warning: The wrapper
 * relies only on the identifier. Two wrapped IdentifierExpressions are equal, iff they have the same name/identifier.
 * Their types and payloads aren't taken into account.
 *
 * This class forbids null values for IdentfierExpressions and their identifier attribute. Simply use null instead of a
 * wrapper instance, containing null.
 *
...
public class IdExprWrapper {
	 ...
	 *
	 * @param idExpr
	 *            IdentifierExpression, must not be null and must have an identifier that isn't null.
	 */
	public IdExprWrapper(final IdentifierExpression idExpr) {
	...
	/**
	 * Checks equality. Warning: Relies only on the identifier. Two wrapped IdentifierExpressions are equal, iff they
	 * have the same name/identifier. Their types and payloads aren't taken into account
	 *
	 * @param obj
	 *            Object
