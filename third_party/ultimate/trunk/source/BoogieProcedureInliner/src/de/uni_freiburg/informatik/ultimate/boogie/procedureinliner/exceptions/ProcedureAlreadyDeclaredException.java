...
/**
 * Indicates that a Boogie procedure was declared more than one time. This shouldn't occur, since the Boogie parser
 * should already complain about it.
 *
...
public class ProcedureAlreadyDeclaredException extends CancelToolchainException {
	...
	public ProcedureAlreadyDeclaredException(final Procedure procedure) {
