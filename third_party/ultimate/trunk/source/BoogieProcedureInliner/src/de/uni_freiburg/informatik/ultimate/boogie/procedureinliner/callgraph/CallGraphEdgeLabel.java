...
/**
 * Information about the type of the call (recursive, call forall, ...). The flag -- whether to inline a call or not --
 * is stored here too.
 *
...
public class CallGraphEdgeLabel {
	 ...
	 *
	 * @param calleeProcedureId
	 *            Identifier of the called procedure.
	 * @param edgeTpye
	 *            Type of the call.
	 */
	public CallGraphEdgeLabel(final String calleeProcedureId, final EdgeType edgeTpye) {
	...
	public void setInlineFlag(final boolean inlineFlag) {
