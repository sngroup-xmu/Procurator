...
/**
 * Indicates that a Boogie procedure had multiple implementations. This is allowed by the Boogie working draft "This is
 * Boogie 2", but not supported by the inliner.
 *
...
public class MultipleImplementationsException extends CancelToolchainException {
	...
	public MultipleImplementationsException(final Procedure procedure) {
		super("Multiple implementations aren't supported: " + procedure.getIdentifier(), procedure.getLocation());
	}

	@Override
	protected AbstractResult createResult(final String pluginId) {
