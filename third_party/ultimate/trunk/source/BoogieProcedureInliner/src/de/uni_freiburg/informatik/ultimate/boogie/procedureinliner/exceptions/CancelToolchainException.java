...
/**
 * This exception indicates, that the toolchain should be canceled. Use
 * {@link #logErrorAndCancelToolchain(IUltimateServiceProvider, String)} to do so.
 *
...
public abstract class CancelToolchainException extends Exception {
	 ...
	 *
	 * @param message
	 *            Message to be logged to the logger.
	 * @param location
	 *            Location inside the boogie program, where the exception arose. Use null, if the location is unknown.
	 */
	public CancelToolchainException(final String message, final ILocation location) {
		super(message);
		mLocation = location;
	}
	...
	public void logErrorAndCancelToolchain(final IUltimateServiceProvider services, final String pluginId) {
