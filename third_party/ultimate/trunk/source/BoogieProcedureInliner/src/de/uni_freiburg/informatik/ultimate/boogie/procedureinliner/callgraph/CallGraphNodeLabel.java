...
public enum CallGraphNodeLabel {
	...
	/**
	 * The call graph contains a path from an entry or re-entry procedure to this procedure and only the last edge of
	 * that path isn't marked for inlining.
	 * <p>
	 ...
	 * <p>
	 * This is the case, if there is <b>no</b> path from an entry procedure to this procedure, ending with an edge, not
	 * marked for inlining.<br>
