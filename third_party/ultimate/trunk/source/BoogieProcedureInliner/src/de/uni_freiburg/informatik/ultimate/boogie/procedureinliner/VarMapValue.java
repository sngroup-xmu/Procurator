...
public class VarMapValue {
	 ...
	 * @param declInfo
	 *            New DeclarationInformation of the variable.
	 */
	public VarMapValue(final String varId, final DeclarationInformation declInfo) {
		mVarId = varId;
		mDeclInfo = declInfo;
	}
	...
	@Override
	public int hashCode() {
		return Objects.hash(mDeclInfo, mVarId);
	}
