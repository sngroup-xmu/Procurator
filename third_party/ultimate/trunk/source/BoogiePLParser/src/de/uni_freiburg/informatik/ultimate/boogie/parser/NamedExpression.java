...
/**
 * Temporary class to represent a pair of a named and an expression. This is used temporarily for StructConstructor
 * expressions.
 *
...
public class NamedExpression {
	...
	public NamedExpression(final String name, final Expression expr) {
		mName = name;
		mExpr = expr;
	}
