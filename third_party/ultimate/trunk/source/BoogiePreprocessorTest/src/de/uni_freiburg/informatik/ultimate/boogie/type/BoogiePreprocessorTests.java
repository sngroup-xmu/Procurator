...
public class BoogiePreprocessorTests {
	...
	public void testTypes() {
		...
		final BoogieType msetType = BoogieType.createArrayType(0,
				new BoogieType[] { BoogieType.createPlaceholderType(0) }, BoogieType.TYPE_INT);
		...
		BoogieType testType = BoogieType.createConstructedType(multiSet, BoogieType.TYPE_INT);
		System.err.println("Test2: " + testType + " = " + testType.getUnderlyingType());

		final BoogieType heapType = BoogieType.createArrayType(1,
				new BoogieType[] { BoogieType.TYPE_INT,
						BoogieType.createConstructedType(field, BoogieType.createPlaceholderType(0)) },
		...
		final BoogieType nestedType = BoogieType.createArrayType(1,
				new BoogieType[] { BoogieType.createPlaceholderType(1),
						BoogieType.createConstructedType(field, BoogieType.createPlaceholderType(0)) },
				BoogieType.createPlaceholderType(0));
		...
		final BoogieFunctionSignature cm = new BoogieFunctionSignature(0, new String[] { "heap", "this" },
				new BoogieType[] { heapType, BoogieType.TYPE_INT }, null, BoogieType.TYPE_BOOL);
