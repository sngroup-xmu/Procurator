...
public final class BuchiIntersect<LETTER, STATE> extends BinaryNwaOperation<LETTER, STATE, IStateFactory<STATE>> {
	...
	public boolean checkResult(final IStateFactory<STATE> stateFactory) throws AutomataLibraryException {
		...
		/*
		 * final INestedWordAutomaton<LETTER, STATE> resultDD = (new BuchiIntersectDD<LETTER, STATE>(mServices,
		 * mFstOperand, mSndOperand)).getResult(); correct &= (resultDD.size() <= mResult.size()); assert correct;
		 */
