...
public class TypeParameters {
	...
	public TypeParameters(final String[] typeParams) {
		this(typeParams, false);
	}

	public TypeParameters(final String[] typeParams, final boolean preserveOrder) {
	...
	public BoogieType findType(final String name, final int increment, final boolean markUsed) {
