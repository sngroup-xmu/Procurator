...
public class ContextPath {
	...
	static ContextPathNode[] getCollantExampleSubResult() {
		return new ContextPathNode[] { new ContextPathNode(FormulaType.AG, "T"),
				new ContextPathNode(FormulaType.Or, "TL"),
				new ContextPathAlphaNode("TLL",
						new UnaryExpression(LocationProvider.getLocation(), UnaryExpression.Operator.LOGICNEG,
								new IdentifierExpression(LocationProvider.getLocation(), "warn"))),
				new ContextPathNode(FormulaType.AW, "TLR"),
				new ContextPathAlphaNode("TLRL", new IdentifierExpression(LocationProvider.getLocation(), "warn")),
				new ContextPathNode(FormulaType.And, "TLRR"),
				new ContextPathAlphaNode("TLRLL",
						new UnaryExpression(LocationProvider.getLocation(), UnaryExpression.Operator.LOGICNEG,
								new IdentifierExpression(LocationProvider.getLocation(), "warn"))),
				new ContextPathNode(FormulaType.AG, "TLRRR"),
				new ContextPathAlphaNode("TLRRRL", new IdentifierExpression(LocationProvider.getLocation(), "mad")) };
	}

	static ContextPathNode[] getExampleSubResult() {
		return new ContextPathNode[] { new ContextPathNode(FormulaType.AG, "T"),
				new ContextPathNode(FormulaType.Or, "TL"),
				new ContextPathAlphaNode("TLL", new BooleanLiteral(LocationProvider.getLocation(), true)),
				new ContextPathNode(FormulaType.AW, "TLR"),
				new ContextPathAlphaNode("TLRL", new BooleanLiteral(LocationProvider.getLocation(), false)),
				new ContextPathAlphaNode("TLRR", new BooleanLiteral(LocationProvider.getLocation(), false)) };
	}

	static ContextPathNode[] getExampleSubResult2() {
		return new ContextPathNode[] { new ContextPathNode(FormulaType.AG, "T"),
				new ContextPathAlphaNode("TL", new BooleanLiteral(LocationProvider.getLocation(), true)) };
	}

	static ContextPathNode[] getAGNotFoo() {
		return new ContextPathNode[] { new ContextPathNode(FormulaType.AG, "T"),
				new ContextPathAlphaNode("TL",
						new UnaryExpression(LocationProvider.getLocation(), UnaryExpression.Operator.LOGICNEG,
								new IdentifierExpression(LocationProvider.getLocation(), "foo"))) };
	}
}
