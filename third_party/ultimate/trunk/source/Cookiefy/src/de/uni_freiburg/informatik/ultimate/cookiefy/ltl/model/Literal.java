...
public class Literal extends Formula {
	...
	public Literal(final String name, final LiteralType literalType) {
		mName = name;
	...
	@Override
	public void acceptPreOrder(final Visitor visitor) {
		visitor.visit(this);
	}

	@Override
	public void acceptInOrder(final Visitor visitor) {
		visitor.visit(this);
	}

	@Override
	public void acceptPostOrder(final Visitor visitor) {
		visitor.visit(this);
	}
