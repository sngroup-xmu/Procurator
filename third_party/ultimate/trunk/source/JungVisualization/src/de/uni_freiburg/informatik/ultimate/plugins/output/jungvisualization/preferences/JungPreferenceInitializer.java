...
public class JungPreferenceInitializer extends UltimatePreferenceInitializer {
	...
	protected UltimatePreferenceItem<?>[] initDefaultPreferences() {
		return new UltimatePreferenceItem<?>[] {
				new UltimatePreferenceItem<>(JungPreferenceValues.LABEL_PATH, JungPreferenceValues.VALUE_PATH_DEFAULT,
						PreferenceType.Directory),
				new UltimatePreferenceItem<>(JungPreferenceValues.LABEL_ANNOTATED_EDGES,
						JungPreferenceValues.VALUE_ANNOTATED_EDGES_DEFAULT, PreferenceType.Combo, EdgeLabels.values()),
				new UltimatePreferenceItem<>(JungPreferenceValues.LABEL_ANNOTATED_NODES,
						JungPreferenceValues.VALUE_ANNOTATED_NODES_DEFAULT, PreferenceType.Boolean),
				new UltimatePreferenceItem<>(JungPreferenceValues.LABEL_LAYOUT,
						JungPreferenceValues.VALUE_LAYOUT_DEFAULT, PreferenceType.Combo,
						new String[] { "FRLayout", "FRLayout2", "ISOMLayout", "KKLayout", "TreeLayout" }),
				new UltimatePreferenceItem<>(JungPreferenceValues.LABEL_COLOR_BACKGROUND,
						StringConverter.asString(JungPreferenceValues.VALUE_COLOR_BACKGROUND_DEFAULT),
						PreferenceType.Color),
				new UltimatePreferenceItem<>(JungPreferenceValues.LABEL_COLOR_NODE,
						StringConverter.asString(JungPreferenceValues.VALUE_COLOR_NODE_DEFAULT), PreferenceType.Color),
				new UltimatePreferenceItem<>(JungPreferenceValues.LABEL_COLOR_NODE_PICKED,
						StringConverter.asString(JungPreferenceValues.VALUE_COLOR_NODE_PICKED_DEFAULT),
						PreferenceType.Color),
				new UltimatePreferenceItem<>(JungPreferenceValues.LABEL_SHAPE_NODE,
						JungPreferenceValues.VALUE_SHAPE_NODE_DEFAULT, PreferenceType.Combo,
						new String[] { "RoundRectangle", "Rectangle", "Ellipse" }),
				new UltimatePreferenceItem<>(JungPreferenceValues.LABEL_WHICH_MODEL, ModelQuery.LAST,
