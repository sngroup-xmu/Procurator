...
/**
 * Implements ActionListener and overrides the actionPerformed(ActionEvent) method, which manages the logic for the JV
 * context menu.
 *
...
public class ContextMenuActions implements ActionListener {
	...
	public ContextMenuActions(final JungEditorInput editorInput) {
