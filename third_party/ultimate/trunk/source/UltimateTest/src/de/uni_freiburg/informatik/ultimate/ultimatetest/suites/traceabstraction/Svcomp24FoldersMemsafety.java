 ...
 *
 */
public class Svcomp24FoldersMemsafety extends AbstractTraceAbstractionTestSuite {
...
//	private static final int FILES_PER_DIR_LIMIT = Integer.MAX_VALUE;
	...
	private static final String PROPERTY = TestUtil.SVCOMP_PROP_VALIDMEMSAFETY;
	...
	private static final SvcompFolderSubset[] BENCHMARKS = {
			...
			new SvcompFolderSubset("examples/svcomp/array-memsafety/", PROPERTY, null, FILE_OFFSET,  FILES_PER_DIR_LIMIT),
			new SvcompFolderSubset("examples/svcomp/array-examples/", PROPERTY, null, FILE_OFFSET,  FILES_PER_DIR_LIMIT),
			new SvcompFolderSubset("examples/svcomp/array-memsafety-realloc/", PROPERTY, null, FILE_OFFSET,  FILES_PER_DIR_LIMIT),
			new SvcompFolderSubset("examples/svcomp/termination-15/", PROPERTY, null, FILE_OFFSET,  FILES_PER_DIR_LIMIT),
			new SvcompFolderSubset("examples/svcomp/termination-crafted/", PROPERTY, null, FILE_OFFSET,  FILES_PER_DIR_LIMIT),
			new SvcompFolderSubset("examples/svcomp/termination-dietlibc/", PROPERTY, null, FILE_OFFSET,  FILES_PER_DIR_LIMIT),
			new SvcompFolderSubset("examples/svcomp/termination-memory-alloca/", PROPERTY, null, FILE_OFFSET,  FILES_PER_DIR_LIMIT),
			...
			new SvcompFolderSubset("examples/svcomp/memsafety-ext/", PROPERTY, null, FILE_OFFSET,  FILES_PER_DIR_LIMIT),
			new SvcompFolderSubset("examples/svcomp/memsafety-ext2/", PROPERTY, null, FILE_OFFSET,  FILES_PER_DIR_LIMIT),
			new SvcompFolderSubset("examples/svcomp/list-ext-properties/", PROPERTY, null, FILE_OFFSET,  FILES_PER_DIR_LIMIT),
			new SvcompFolderSubset("examples/svcomp/memory-alloca/", PROPERTY, null, FILE_OFFSET,  FILES_PER_DIR_LIMIT),
			new SvcompFolderSubset("examples/svcomp/ldv-memsafety/", PROPERTY, null, FILE_OFFSET,  FILES_PER_DIR_LIMIT),
			new SvcompFolderSubset("examples/svcomp/ldv-memsafety-bitfields/", PROPERTY, null, FILE_OFFSET,  FILES_PER_DIR_LIMIT),
			new SvcompFolderSubset("examples/svcomp/termination-memory-linkedlists/", PROPERTY, null, FILE_OFFSET,  FILES_PER_DIR_LIMIT),
			new SvcompFolderSubset("examples/svcomp/termination-recursive-malloc/", PROPERTY, null, FILE_OFFSET,  FILES_PER_DIR_LIMIT),
			new SvcompFolderSubset("examples/svcomp/Juliet_Test/", PROPERTY, null, FILE_OFFSET,  FILES_PER_DIR_LIMIT),
			new SvcompFolderSubset("examples/svcomp/memsafety-broom/", PROPERTY, null, FILE_OFFSET,  FILES_PER_DIR_LIMIT),
			...
			new SvcompFolderSubset("examples/svcomp/memsafety-ext3/", PROPERTY, null, FILE_OFFSET,  FILES_PER_DIR_LIMIT),
			new SvcompFolderSubset("examples/svcomp/pthread-memsafety/", PROPERTY, null, FILE_OFFSET,  FILES_PER_DIR_LIMIT),
			new SvcompFolderSubset("examples/svcomp/memsafety-bftpd/", PROPERTY, null, FILE_OFFSET,  FILES_PER_DIR_LIMIT),
			...
			new SvcompFolderSubset("examples/svcomp/coreutils-v8.31/", PROPERTY, null, FILE_OFFSET,  FILES_PER_DIR_LIMIT),
			...
			new SvcompFolderSubset("examples/svcomp/openbsd-6.2/", PROPERTY, null, FILE_OFFSET,  FILES_PER_DIR_LIMIT),
			new SvcompFolderSubset("examples/svcomp/sqlite/", PROPERTY, null, FILE_OFFSET,  FILES_PER_DIR_LIMIT),
	...
	private static final Pair[] SETTINGS = {
			new Pair<>("default/automizer/svcomp-DerefFreeMemtrack-32bit-Automizer_Default.epf", "default/automizer/svcomp-DerefFreeMemtrack-64bit-Automizer_Default.epf"),
			new Pair<>("default/automizer/svcomp-DerefFreeMemtrack-32bit-Automizer_Bitvector.epf", "default/automizer/svcomp-DerefFreeMemtrack-64bit-Automizer_Bitvector.epf"),
	};
