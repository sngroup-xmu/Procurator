...
public class VariableAssignmentLabelProvider implements ITableLabelProvider {
	...
	public String getColumnText(final Object element, final int columnIndex) {
		/*
		 * The variable assignment view has two columns. The first column shows the variable name. The second column
		 * shows the value that is assigned to this variable.
		 */
