...
/**
 * Externalized Strings which are used in the checker, basically for the preferences.
 *
...
public interface CCheckerDescriptor {
	 ...
	 */
	String CE_ID = "de.uni_freiburg.informatik.ultimate.cdt." + "codan.CounterExampleResult";

	/**
	 * The Problem-Identifier for found Invariants.
	 */
	String IN_ID = "de.uni_freiburg.informatik.ultimate.cdt." + "codan.InvariantResult";

	/**
	 * The Problem-Identifier for unproveable results.
	 */
	String UN_ID = "de.uni_freiburg.informatik.ultimate.cdt." + "codan.UnproveableResult";

	/**
	 * The Problem-Identifier for positive results;
	 */
	String POS_ID = "de.uni_freiburg.informatik.ultimate.cdt." + "codan.PositiveResult";

	/**
	 * The Problem-Identifier for syntax error results;
	 */
	String SYNERR_ID = "de.uni_freiburg.informatik.ultimate.cdt." + "codan.SyntaxErrorResult";

	/**
	 * The Problem-Identifier for time outs;
	 */
	String TIMEOUT_ID = "de.uni_freiburg.informatik.ultimate.cdt." + "codan.TimeoutResult";

	/**
	 * The Problem-Identifier for the generic info result;
	 */
	String GENERIC_INFO_RESULT_ID = "de.uni_freiburg.informatik.ultimate.cdt." + "codan.GenericInfoResult";

	/**
	 * The Problem-Identifier for the generic warning result;
	 */
	String GENERIC_WARNING_RESULT_ID = "de.uni_freiburg.informatik.ultimate.cdt." + "codan.GenericWarningResult";

	/**
	 * The Problem-Identifier for the generic error result;
	 */
	String GENERIC_ERROR_RESULT_ID = "de.uni_freiburg.informatik.ultimate.cdt." + "codan.GenericErrorResult";

	/**
	 * Key for the Selection of Toolchains.
	 */
	String MAP_KEY = "TOOLCHAIN_SELECTION";
	/**
	 * Label Text for the Selection of Toolchains.
	 */
	String MAP_LABEL = "Please select one of the predefined toolchains";
}
