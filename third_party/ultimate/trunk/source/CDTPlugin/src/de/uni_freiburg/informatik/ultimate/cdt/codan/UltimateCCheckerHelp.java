...
public class UltimateCCheckerHelp extends AbstractCodanProblemDetailsProvider {
	...
	@Override
	public boolean isApplicable(final String id) {
	...
	public String getStyledProblemDescription() {
		/*
		 * This method provides Information which is displayed in the ProblemDetailsView (Codan), further step would be
		 * to present a new view or a new approach how to visualize Ultimate-Results.
		 */
