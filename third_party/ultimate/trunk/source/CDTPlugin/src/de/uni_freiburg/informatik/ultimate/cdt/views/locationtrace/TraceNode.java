...
/**
 * We need this class, because it is necessary that every Object in the Location-Trace is unique.
 *
...
public class TraceNode {
	 ...
	 */
	public TraceNode(final ILocation loc, final int index, final int oIndex) {
		location = loc;
		this.index = index;
