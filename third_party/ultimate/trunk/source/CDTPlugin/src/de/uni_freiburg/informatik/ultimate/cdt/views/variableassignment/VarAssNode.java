...
public class VarAssNode {
	 ...
	 * @param value
	 */
	public VarAssNode(final String name, final String value) {
		this.name = name;
		this.value = value;
	}
	 ...
	 *            the children to set
	 */
	public void setChildren(final List<VarAssNode> children) {
	 ...
	 *            the parent to set
	 */
	public void setParent(final VarAssNode parent) {
		this.parent = parent;
	}
