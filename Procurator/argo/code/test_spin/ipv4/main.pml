...
global_headers host1_hdr_send;
global_headers host1_hdr_recv;
proctype host1() {
  do
  :: atomic {
...
global_headers host2_hdr_send;
global_headers host2_hdr_recv;
...
global_headers host3_hdr_send;
global_headers host3_hdr_recv;
proctype host3() {
  do
  :: atomic {
...
//ltl reachability { []( (host1_hdr_send.ipv4.dstAddr == 167772674) -> (<>p) )}
//ltl reachability { []( (host1@label_send_done && host1_hdr_send.ipv4.dstAddr == 167772674) -> (<>p) )}
