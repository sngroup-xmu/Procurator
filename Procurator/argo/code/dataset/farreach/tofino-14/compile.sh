...
./configure --prefix=$SDE_INSTALL --with-tofino P4_NAME=netbufferv4 P4_PATH=${SWITCH_ROOTPATH}/farreach/tofino/netbufferv4.p4  enable_thrift=yes  P4_VERSION=p4-14
make
make install
