...
bind_layers(UDP, Paxos, dport=0x8889)
bind_layers(UDP, Paxos, dport=0x888a)
...
if __name__=='__main__':
    ...
    parser.add_argument('-t', '--type', help='Paxos type', type=int, default=2)
