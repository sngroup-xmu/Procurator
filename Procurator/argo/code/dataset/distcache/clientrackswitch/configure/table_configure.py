...
class TableConfigure:
    ...
    def configure_eg_port_forward_tbl(self):
        for tmpoptype in [GETREQ,]:
            ...
            self.controller.table_add("eg_port_forward_tbl","update_netcache_getreq_to_getreq_spine",matchspec0)
    ### MAIN ###
    def runTest(self):
        ################################
        ...
        print("Configuring poweroftwochoice_tbl")
        self.configure_poweroftwochoice_tbl()
        # server -> client
