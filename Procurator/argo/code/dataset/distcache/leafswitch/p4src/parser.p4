...
parser netcacheParser(packet_in packet,
	...
	state parse_stat {
		...
		//transition accept;
		////transition parse_debug; // GETRES, PUTRES, DELRES, GETRES_LATEST_SEQ_INSWITCH_CASE1, GETRES_DELETED_SEQ_INSWITCH_CASE1, PUTREQ_SEQ_INSWITCH_CASE1, DELREQ_SEQ_INSWITCH_CASE1
	}
	...
	// checksum calculation (destate phase)
}

control netcacheDeparser(packet_out packet, in headers hdr) {
    apply {
