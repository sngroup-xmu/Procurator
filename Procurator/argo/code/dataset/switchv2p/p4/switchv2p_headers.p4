...
typedef bit<3> switch_type_t;
const switch_type_t	TOR = 0;
const switch_type_t	GW_TOR = 1;
const switch_type_t	SPINE = 2;
const switch_type_t	GW_SPINE = 3;
const switch_type_t	CORE = 4;
