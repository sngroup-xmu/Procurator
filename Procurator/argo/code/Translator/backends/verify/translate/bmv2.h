...
public:
	...
	cstring getCondition(std::vector<cstring>);
	cstring getParas();
};
...
// table_set_default
class TableSetDefault : public TableAdd{
public:
...
public:
	...
	bool hasTableSetDefaultCmd(cstring table);
	TableSetDefault* getTableSetCmd(cstring table);
};
